...
class ProveedoresController extends BaseController{
    ...
    public function getProveedoreventual(){
                  ...
                  if (Input::get('tipoempresa')==='P.N') {
                    if(intval(Input::get('sw'))===0){
                      $validaciones = [
                          ...
                          'celular'=>'numeric',
                          'tipo_servicio_pn'=>'required|select',
                          'tipo_cuenta'=>'required|select',
                          'entidad_bancaria'=>'required|select',
                          'numero_cuenta'=>'required',
                          'certificacion_proveedor' => 'required'
                      ...
                      $mensajes = [
                          ...
                          'ciudad.select'=>'Debe seleccionar una ciudad valida',
                          'tipo_servicio_pn.select'=>'Debe seleccionar un tipo de servicio',
                          'tipo_cuenta.select'=>'Debe seleccionar un tipo de cuenta',
                          'entidad_bancaria.select'=>'Debe seleccionar un banco',
                          'tipo_servicio_pn.required'=>'El campo número de cuenta es obligatorio',
                          'certificacion_proveedor.required'=>'Adjunta el certificado bancario del proveedor'
                      ];
                    }else{
                      $validaciones = [
                          'nit'=>'required|numeric|unique:proveedores',
                          ...
                          'celular'=>'numeric',
                          'tipo_servicio_pn'=>'required|select',
                          'tipo_cuentat'=>'required|select',
                          'entidad_bancariat'=>'required|select',
                          'numero_cuentat'=>'required',
                          'numero_documentot'=>'required',
                          'razonsocialt'=>'required',
                          'certificacion_tercero'=>'required',
                          'poder_tercero'=>'required',
                      ...
                      $mensajes = [
                          ...
                          'ciudad.select'=>'Debe seleccionar una ciudad valida',
                          'tipo_servicio_pn.select'=>'Debe seleccionar un tipo de servicio',
                          'tipo_cuentat.select'=>'Debe seleccionar un tipo de cuenta de TERCERO',
                          'entidad_bancariat.select'=>'Debe seleccionar un banco del TERCERO',
                          'numero_cuentat.required'=>'El campo número de cuenta de TERCERO es obligatorio',

                          'numero_documentot.required'=>'Debe ingresar el número de documento del TERCERO',
                          'razonsocialt.required'=>'El campo razon social de TERCERO es obligatorio',
                          'certificacion_tercero.required'=>'Adjunta el certificado bancario del tercero',
                          'poder_tercero.required'=>'Adjunta el poder para pago a tercero',
                      ];
                    }
                      ...
                      if ($validador->fails()){
                          ...
                          if(intval(Input::get('sw'))===1){
                            $proveedor->tipo_cuenta_t = Input::get('tipo_cuentat');
                            $proveedor->entidad_bancaria_t = Input::get('entidad_bancariat');
                            $proveedor->numero_cuenta_t = Input::get('numero_cuentat');
                            $proveedor->estado_tercero = 1;
                            $proveedor->razonsocial_t = Input::get('razonsocialt');
                            $proveedor->nit_t = Input::get('numero_documentot');

                            if(Input::hasFile('certificacion_tercero')){
                              $file = Input::file('certificacion_tercero');
                              ...
                              $file->move($ubicacion_servicios, $proveedor->nit_t.'_'.$name_img);
                              $proveedor->certificacion_bancaria_t = $proveedor->nit_t.'_'.$name_img;
                            }

                            if(Input::hasFile('poder_tercero')){
                              $file = Input::file('poder_tercero');
                              $name_img = str_replace(' ', '', $file->getClientOriginalName());

                              $ubicacion_servicios = 'biblioteca_imagenes/proveedores/documentos/poderes/';
                              $file->move($ubicacion_servicios, $proveedor->nit_t.$proveedor->razonsocial_t.'_'.$name_img);
                              $proveedor->poder_t = $proveedor->nit_t.$proveedor->razonsocial_t.'_'.$name_img;
                            }

                          }else{
                            $proveedor->tipo_cuenta = Input::get('tipo_cuenta');
                            $proveedor->entidad_bancaria = Input::get('entidad_bancaria');
                            $proveedor->numero_cuenta = Input::get('numero_cuenta');
                            ...
                            if(Input::hasFile('certificacion_proveedor')){
                              ...
                              $ubicacion_servicios = 'biblioteca_imagenes/proveedores/documentos/certificacion/';
                              $file->move($ubicacion_servicios, $proveedor->nit.'_'.$name_img);
                              $proveedor->certificacion_bancaria = $proveedor->nit.'_'.$name_img;
                            }
                          }
                    ...
                    if(intval(Input::get('sw'))===0){
                      ...
                      $mensajes = [
                          ...
                          'tipo_servicio.select'=>'Debe seleccionar un tipo de servicio',
                          'tipo_cuentat.select'=>'Debe seleccionar un tipo de cuenta de TERCERO',
                          'entidad_bancariat.select'=>'Debe seleccionar un banco de TERCERO',
                          'numero_cuentat.required'=>'El campo número de cuenta de TERCERO es obligatorio',
                          'numero_documentot.required'=>'Debe ingresar el número de documento del TERCERO',
                          'razonsocialt.required'=>'El campo razon social de TERCERO es obligatorio',
                          'certificacion_tercero.required'=>'Adjunta el certificado bancario del tercero',
      ...
      public function getConductores($id){
          ...
          if (!Sentry::check()){
              ...
              $departamentos = DB::table('departamento')->get();
              $conductores = DB::table('conductores')->where('proveedores_id',$id)->orderBy('bloqueado_total')->orderBy('bloqueado')->get();
      ...
      public function postBuscarconductor(){
          ...
          if (!Sentry::check()){
            ...
            if(Request::ajax()){
              ...
              $consulta = "select * from conductores where cc = ".$cedula." order by id desc limit 1";
          ...
          if (!Sentry::check())
          {
              ...
              if(Request::ajax()){
                  ...
                  if ($validador->fails())
                  {
                      ...
                      ->where('cc',Input::get('cc'))
                      ->first();

                      if($query!=null){

                        $conductorUpdate = DB::table('conductores')
                        ->where('cc',Input::get('cc'))
                        ->update([
                          'bloqueado' => 1,
                          'bloqueado_total' => 1
                      ...
                      $conductor->fecha_nacimiento = Input::get('fecha_nacimiento');
      ...
      public function getVehiculos($id){
          ...
          if (!Sentry::check()){
              ...
              $vehiculos = DB::table('vehiculos')->where('proveedores_id',$id)->orderBy('bloqueado_total')->orderBy('bloqueado')->get();
      ...
      public function postBuscarvehiculo(){
          ...
          if (!Sentry::check()){
            ...
            if(Request::ajax()){
              ...
              $consulta = "select * from vehiculos where placa = '".$placa."' order by id desc limit 1";
              $ultimo = DB::select($consulta);
              ...
              if(Request::ajax()){
                  ...
                  if (Input::get('tipo_transporte')==='PRIVADO') {
                      ...
                      if ($validador->fails())
                      {
                          ...
                          ->where('placa',Input::get('placa'))
                          ->first();

                          if($query!=null){

                            $updatePlacas = DB::table('vehiculos')
                            ->where('placa',Input::get('placa'))
                            ->update([
                              'placa' => Input::get('placa').'-',
                              'bloqueado' => 1
      ...
      public function postSubirimagenes(){
          if (!Sentry::check())
          {
              ...
              if (Request::ajax()) {
                  $imagenes = DB::table('img_vehiculos')->where('vehiculos_id',312)->count();
                  if($imagenes<4){
                      $validaciones = [
                          'foto' => 'mimes:jpeg,bmp,png'
                      ];
      ...
      public function getSeguridadsocialciudades(){
          ...
          return View::make('proveedores.seguridadsocial_ciudades',$array);
        }
      }
            ...
            if(Request::ajax()){
              ...
              if (intval(Input::get('proveedor_id'))===0) {
                ...
                foreach ($conductores as $conductor) {
                  ...
                  $ss = "select seguridad_social.fecha_inicial, seguridad_social.fecha_final from seguridad_social where conductor_id = ".$conductor->id_conductor." and '".$date."' between fecha_inicial and fecha_final ";
                  $ss = DB::select($ss);

                  if($ss!=null){
                    $conductores_array[$i] = $conductor;
                  }else{
      ...
      //buscar 2
      public function postBuscarconductoresciudad(){
        ...
        if (!Sentry::check()){
            ...
            if(Request::ajax()){
              ...
              $sw = 0;
              //BÚSQUEDA POR PROVEEDOR, CIUDAD Y ESTADO
              if (intval(Input::get('proveedor_id'))===0) {

                $date = date('Y-m-d');

                $consulta = "select conductores.nombre_completo, conductores.id as id_conductor, conductores.seguridad_social_pdf, proveedores.razonsocial, seguridad_social.fecha_final, seguridad_social.id as id_ss from proveedores left join conductores on conductores.proveedores_id = proveedores.id left join seguridad_social on seguridad_social.conductor_id = conductores.id where proveedores.inactivo is null and proveedores.inactivo_total is null and conductores.bloqueado is null and conductores.bloqueado_total is null";

                if(intval(Input::get('ciudad'))===1){
                  $consulta .=" and proveedores.localidad in('BARRANQUILLA','PROVISIONAL') ";
                }else if (intval(Input::get('ciudad'))===2) {
                  $consulta .=" and proveedores.localidad in('BOGOTA','PROVISIONAL') ";
                }

                //ESTADO BLOQUEADO
                if(intval(Input::get('estado'))===1){
                  $sw=1;

                //ESTADO DESBLOQUEADO
                }else if (intval(Input::get('estado'))===2) {
                  $consulta .=" and '".$date."' between seguridad_social.fecha_inicial and seguridad_social.fecha_final ";
                }

                if(intval(Input::get('mes'))!=0){
                  $consulta .=" and seguridad_social.mes = ".Input::get('mes')."";
                }

                $conductores = DB::select($consulta." GROUP BY conductores.nombre_completo ORDER BY seguridad_social.id asc");
                ...
                foreach ($conductores as $conductor) {
                  ...
                  if($ss!=null){
                    foreach ($ss as $nombre) {
                        $conductores_array[$i] = $nombre;
                    }
                  }else{
                    $conductores_array[$i] = 0;
                  }
                ...
                $consulta = "select conductores.nombre_completo, conductores.id as id_conductor, conductores.seguridad_social_pdf, proveedores.razonsocial, seguridad_social.fecha_final from proveedores left join conductores on conductores.proveedores_id = proveedores.id left join seguridad_social on seguridad_social.conductor_id = conductores.id where inactivo is null and inactivo_total is null and conductores.proveedores_id = ".Input::get('proveedor_id')." and conductores.bloqueado_total is null and conductores.bloqueado is null";
                ...
                $conductores = DB::select($consulta." GROUP BY conductores.nombre_completo ORDER BY seguridad_social.fecha_final desc");
                ...
                foreach ($conductores as $conductor) {
                  ...
                  $ss = "select seguridad_social.fecha_final from seguridad_social where conductor_id = ".$conductor->id_conductor." and '".$date."' between fecha_inicial and fecha_final";
                  $ss = DB::select($ss);
      ...
      public function postMostrarproveedores(){
        ...
        if(Request::ajax()){
          ...
          if($ciudad_id==1){
            $proveedor = Proveedor::BARRANQUILLA()
              ->whereNull('inactivo')
              ->whereNull('inactivo_total')
              ->orderBy('razonsocial', 'asc')
              ->get();
          }else if($ciudad_id==2){
            $proveedor = Proveedor::BOGOTA()
              ->whereNull('inactivo')
              ->whereNull('inactivo_total')
              ->orderBy('razonsocial', 'asc')
              ->get();
      ...
      public function postSeguridadsocials(){
        ...
        if (!Sentry::check())
        {
            ...
            if(Request::ajax()){
              ...
              ->select('seguridad_social.*', 'users.first_name','users.last_name')
              ->leftJoin('users', 'users.id', '=', 'seguridad_social.creado_por')
              ->where('ano',date('Y'))
              //->where('fecha_inicial', '<=', date('Y-m-d'))
              ...
              $sw = "select pago, fecha_inicial, fecha_final from seguridad_social where conductor_id = ".Input::get('conductor_id')." and '".$date."' between fecha_inicial and fecha_final ";
              $sw = DB::select($sw);
              if($sw){
                $sw=1;
              }else{
      ...
      public function postBuscarmesseguridad(){
        ...
        if (!Sentry::check()){
            ...
            if(Request::ajax()){
              ...
              $seguridad_social = "select pago, fecha_inicial, fecha_final, numero_ingreso from seguridad_social where conductor_id = ".Input::get('id')." and '".$date."' between fecha_inicial and fecha_final ";
              $seguridad_social = DB::select($seguridad_social);

              if($seguridad_social!=null){

                foreach ($seguridad_social as $seg) {
                  $ingreso = $seg->numero_ingreso;
                  $fecha_inicial = $seg->fecha_inicial;
                  $fecha_final = $seg->fecha_final;
                }
        ...
        if (!Sentry::check()){
            ...
            if(Request::ajax()){
              ...
              if ($numero_repetido!=null) {
                ...
                $values = explode('-', Input::get('fecha_inicial'));

                $seguridad_social = new Seguridadsocial;
                $seguridad_social->ano = $values[0];
                $seguridad_social->mes = $values[1];
                $seguridad_social->fecha_inicial = Input::get('fecha_inicial');
                $seguridad_social->fecha_final = Input::get('fecha_final');
    ...
    //NUEVO
    public function postFotosconductores(){

      $option = Input::get('option');

      $query = Conductor::whereHas('proveedor', function($q)
      {
          $q->whereNull('inactivo_total')->where('localidad','BOGOTA');
      })->Seguridadsocialmes();
    ...
    //LISTADO DE FOTOS DE PERFIL CONDUCTORES
    public function getListadofotosconductores(){
          ...
          if (!Sentry::check()){
            ...
            })->noarchivado()->whereNull('bloqueado')->whereNull('bloqueado_total')->orderBy('nombre_completo')->get();

            return View::make('proveedores.listado_fotos',[
                'conductores'=>$conductores,
                'permisos'=>$permisos
            ]);
          }
      }
    //FIN LISTADO DE FOTOS DE PERFIL CONDUCTORES

    //LISTADO DE FECHAS DE VENCIMIENTO
    public function getListadovencimientoconductores(){
          ...
          if (!Sentry::check()){
            ...
            return View::make('proveedores.listado_vencimiento_conductores2',[
                'conductores'=>$conductores,
                'permisos'=>$permisos
            ]);
          }
      }
    //FIN LISTADO DE FECHAS DE VENCIMIENTO CONDUCTORES

    //LISTADO DE FECHAS DE VENCIMIENTO
    public function getListadovencimientovehiculos(){
          ...
          if (!Sentry::check()){
            ...
            return View::make('proveedores.listado_vencimiento_vehiculos2',[
                'vehiculos'=>$vehiculos,
                'permisos'=>$permisos
            ]);
          }
      }
    //FIN LISTADO DE FECHAS DE VENCIMIENTO vehiculos

      public function getGestiondecuentas(){
        ...
        if (!Sentry::check()){
          ...
          return View::make('proveedores.gestion_cuentas')
          ->with([
            'proveedores' => $proveedores,
            'permisos' => $permisos
          ]);
    ...
    //MOSTRAR LA INFORMACIÓN BANCARIA DEL PROVEEDOR
    ...
    //EDITAR DATOS BANCARIOS DEL PROVEEDOR
    public function postGuardarcambios(){
      ...
      if(Request::ajax()){
        ...
        //SI VIENE PRESIONADA LA OPCIÓN DE TERCERO
        if(Input::get('estado_t')==1){

          //CAMBIO DE ESTADO DE PAGO
            if($proveedor->estado_tercero!=Input::get('estado_t')){
              $cambios = $cambios.'Se selecciono la opción de PAGO a TERCERO: <b>'.Input::get('razonsocial_t').' | '.Input::get('nit_t').'</b><br>';
            }

            //CAMBIO DE NOMBRE EN TERCERO
            if(strtoupper($proveedor->razonsocial_t!=strtoupper(Input::get('razonsocial_t'))) && $proveedor->razonsocial_t!=null){
              $cambios = $cambios.'Se cambio la RAZON SOCIAL del tercero, de <b>'.strtoupper($proveedor->razonsocial_t).'</b> a <b>'.Input::get('razonsocial_t').'</b><br>';
            }else if (strtoupper($proveedor->razonsocial_t!=strtoupper(Input::get('razonsocial_t'))) && $proveedor->razonsocial_t==null) {
              $cambios = $cambios.'Se ingreso la RAZON SOCIAL del tercero: <b>'.strtoupper(Input::get('razonsocial_t')).'</b><br>';
            }

            //CAMBIO DE NIT EN TERCERO
            if(strtoupper($proveedor->nit_t!=strtoupper(Input::get('nit_t'))) && $proveedor->nit_t!=null){
              $cambios = $cambios.'Se cambio el NIT del tercero, de <b>'.strtoupper($proveedor->nit_t).'</b> a <b>'.Input::get('nit_t').'</b><br>';
            }else if(strtoupper($proveedor->nit_t!=strtoupper(Input::get('nit_t'))) && $proveedor->nit_t==null){
              $cambios = $cambios.'Se ingreso el NIT del tercero: <b>'.strtoupper(Input::get('nit_t')).'</b><br>';
            }

            //CAMBIO DE TIPO DE CUENTA EN TERCERO
            if(strtoupper($proveedor->tipo_cuenta_t!=strtoupper(Input::get('tipo_cuenta_t'))) && $proveedor->tipo_cuenta_t!=null){
              $cambios = $cambios.'Se cambio el TIPO DE CUENTA del tercero, de <b>'.strtoupper($proveedor->tipo_cuenta_t).'</b> a <b>'.Input::get('tipo_cuenta_t').'</b><br>';
            }else if(strtoupper($proveedor->tipo_cuenta_t!=strtoupper(Input::get('tipo_cuenta_t'))) && $proveedor->tipo_cuenta_t==null){
              $cambios = $cambios.'Se ingreso el TIPO DE CUENTA del tercero: <b>'.strtoupper(Input::get('tipo_cuenta_t')).'</b><br>';
            }

            //CAMBIO DE ENTIDAD BANCARIA EN TERCERO
            if(strtoupper($proveedor->entidad_bancaria_t!=strtoupper(Input::get('entidad_bancaria_t'))) && $proveedor->entidad_bancaria_t!=null){
              $cambios = $cambios.'Se cambio la ENTIDAD BANCARIA del tercero, de <b>'.strtoupper($proveedor->entidad_bancaria_t).'</b> a <b>'.Input::get('entidad_bancaria_t').'</b><br>';
            }else if(strtoupper($proveedor->entidad_bancaria_t!=strtoupper(Input::get('entidad_bancaria_t'))) && $proveedor->entidad_bancaria_t==null){
              $cambios = $cambios.'Se ingreso la ENTIDAD BANCARIA del tercero: <b>'.strtoupper(Input::get('entidad_bancaria_t')).'</b><br>';
            }

            //CAMBIO DE ENTIDAD BANCARIA EN TERCERO
            if(strtoupper($proveedor->numero_cuenta_t!=strtoupper(Input::get('numero_cuenta_t'))) && $proveedor->numero_cuenta_t!=null){
              $cambios = $cambios.'Se cambio NUMERO DE CUENTA del tercero, de <b>'.strtoupper($proveedor->numero_cuenta_t).'</b> a <b>'.Input::get('numero_cuenta_t').'</b><br>';
            }else if(strtoupper($proveedor->numero_cuenta_t!=strtoupper(Input::get('numero_cuenta_t'))) && $proveedor->numero_cuenta_t==null){
              $cambios = $cambios.'Se ingreso el NUMERO DE CUENTA del tercero: <b>'.strtoupper(Input::get('numero_cuenta_t')).'</b><br>';
            }
            ...
            if($proveedor->historial_cambios==null){
              ...
              if($cambios!=null){
                $proveedor->historial_cambios = json_encode([$array]);
              }
              ...
              if($cambios!=null){
                $objArray = json_decode($proveedor->historial_cambios);
                array_push($objArray, $array);
                $proveedor->historial_cambios = json_encode($objArray);
              }

            }
            //FIN HISTORIAL DE CAMBIOS

          $proveedor->razonsocial_t = Input::get('razonsocial_t');
          $proveedor->nit_t = Input::get('nit_t');
          $proveedor->entidad_bancaria_t = Input::get('entidad_bancaria_t');
          $proveedor->numero_cuenta_t = Input::get('numero_cuenta_t');
          $proveedor->tipo_cuenta_t = Input::get('tipo_cuenta_t');
          $proveedor->estado_tercero = 1;

          //CERTIFICACIÓN BANCARIA TERCERO
          if(Input::hasFile('certificacion_tercero')){
            $file = Input::file('certificacion_tercero');
            $name_img = str_replace(' ', '', $file->getClientOriginalName());

            $ubicacion_servicios = 'biblioteca_imagenes/proveedores/documentos/certificacion/';
            $file->move($ubicacion_servicios, Input::get('nit_t').'_'.$name_img);
            $proveedor->certificacion_bancaria_t = Input::get('nit_t').'_'.$name_img;
          }

          //PODER PARA PAGO AL TERCERO
          if(Input::hasFile('poder_tercero')){
            $file = Input::file('poder_tercero');
            $name_img = str_replace(' ', '', $file->getClientOriginalName());

            $ubicacion_servicios = 'biblioteca_imagenes/proveedores/documentos/poderes/';
            $file->move($ubicacion_servicios, Input::get('nit_t').Input::get('razonsocial_t').'_'.$name_img);
            $proveedor->poder_t = Input::get('nit_t').Input::get('razonsocial_t').'_'.$name_img;
          }
          ...
          //FIN GUARDADO DE TERCERO

        }else if(Input::get('estado_t')==0){

          //CAMBIO DE ESTADO DE PAGO
          if($proveedor->estado_tercero!=Input::get('estado_t')){
            $cambios = $cambios.'Se selecciono la opción de PAGO a PROVEEDOR: <b>'.$proveedor->razonsocial.' | '.$proveedor->nit.'</b><br>';
          }

          //CAMBIO DE TIPO DE CUENTA EN PROVEEDOR
          if(strtoupper($proveedor->tipo_cuenta!=strtoupper(Input::get('tipo_cuenta'))) && $proveedor->tipo_cuenta!=null){
            $cambios = $cambios.'Se cambio el tipo de cuenta del proveedor, de <b>'.strtoupper($proveedor->tipo_cuenta).'</b> a <b>'.Input::get('tipo_cuenta').'</b><br>';
          }else if(strtoupper($proveedor->tipo_cuenta!=strtoupper(Input::get('tipo_cuenta'))) && $proveedor->tipo_cuenta==null){
            $cambios = $cambios.'Se ingreso el tipo de cuenta del proveedor: <b>'.strtoupper(Input::get('tipo_cuenta')).'</b><br>';
          }

          //CAMBIO DE ENTIDAD BANCARIA EN PROVEEDOR
          if(strtoupper($proveedor->entidad_bancaria!=strtoupper(Input::get('entidad_bancaria'))) && $proveedor->entidad_bancaria!=null){
            $cambios = $cambios.'Se cambio la entidad bancaria del proveedor, de <b>'.strtoupper($proveedor->entidad_bancaria).'</b> a <b>'.Input::get('entidad_bancaria').'</b><br>';
          }else if(strtoupper($proveedor->entidad_bancaria!=strtoupper(Input::get('entidad_bancaria'))) && $proveedor->entidad_bancaria==null){
            $cambios = $cambios.'Se ingreso la entidad bancaria del proveedor: <b>'.strtoupper(Input::get('entidad_bancaria')).'</b><br>';
          }

          //CAMBIO DE ENTIDAD BANCARIA EN PROVEEDOR
          if(strtoupper($proveedor->numero_cuenta!=strtoupper(Input::get('numero_cuenta'))) && $proveedor->numero_cuenta!=null){
            $cambios = $cambios.'Se cambio número de cuenta del proveedor, de <b>'.strtoupper($proveedor->numero_cuenta).'</b> a <b>'.Input::get('numero_cuenta').'</b><br>';
          }else if(strtoupper($proveedor->numero_cuenta!=strtoupper(Input::get('numero_cuenta'))) && $proveedor->numero_cuenta==null){
            $cambios = $cambios.'Se ingreso el número de cuenta del proveedor: <b>'.strtoupper(Input::get('numero_cuenta')).'</b><br>';
          }
          ...
          $proveedor->numero_cuenta = Input::get('numero_cuenta');
          $proveedor->tipo_cuenta = Input::get('tipo_cuenta');
          $proveedor->estado_tercero = 0;

          //CERTIFICACIÓN BANCARIA PROVEEDOR
          if(Input::hasFile('certificacion_proveedor')){
            $file2 = Input::file('certificacion_proveedor');
            $name_img2 = str_replace(' ', '', $file2->getClientOriginalName());

            $ubicacion_servicios = 'biblioteca_imagenes/proveedores/documentos/certificacion/';
            $file2->move($ubicacion_servicios, $proveedor->nit.'_'.$name_img2);
            $proveedor->certificacion_bancaria = $proveedor->nit.'_'.$name_img2;
          }
    ...
    public function getHistorial($id){
        ...
        if (!Sentry::check()){
          ...
          return View::make('proveedores.historial')
            ->with([
                'id'=>$id,
                'proveedor'=>$proveedor,
            ]);
    ...
    public function postBuscar(){
      ...
      if (Request::ajax()){
        ...
        $conductor_id = Input::get('proveedores');
        $id_rol = Sentry::getUser()->id_rol;
        ...
        $proveedor_id = Input::get('proveedores');
        $banco = Input::get('banco');
        $tipo = Input::get('tipo_cuentab');

        if ($proveedor_id===null) {
          $proveedor_id = 0;
        }

        $estado_proveedor = Input::get('estado_proveedor');

        if($estado_proveedor==='PAGO'){
          $estado_proveedor = 0;
        }else if($estado_proveedor==='PAGO A PROVEEDOR'){
          $estado_proveedor = 1;
        }else{
          $estado_proveedor = 2;
        }

        $consulta = "select razonsocial, id, nit, entidad_bancaria, tipo_cuenta, numero_cuenta, razonsocial_t, nit_t, entidad_bancaria_t, numero_cuenta_t, tipo_cuenta_t, certificacion_bancaria, certificacion_bancaria_t, poder_t, estado_tercero from proveedores where inactivo_total is null and inactivo is null";

        if($proveedor_id!='0'){
          $consulta .= " and id = ".$proveedor_id." ";
        }


        if($estado_proveedor===0){ //TODOS

          if($banco!='BANCO'){
            $consulta .=" and entidad_bancaria = '".$banco."' ";
          }

          if($tipo!='TIPO DE CUENTA'){
            $consulta .=" and tipo_cuenta = '".$tipo."' ";
          }

        }else if($estado_proveedor===1){ //SI ESTA SELECCIONADA LA OPCIÓN DE PAGO A PROVEEDOR

          $consulta .=" and estado_tercero = 0 ";
          ...
          //SI ESTA SELECCIONADA LA OPCIÓN DE PAGO A TERCERO
          $consulta .=" and estado_tercero = 1 ";
          //SI SE SELECCIONA EL FILTRO DE BANCO, SE BUSCAN EN LOS DATOS DEL TERCERO.
          if($banco!='BANCO'){
            $consulta .=" and entidad_bancaria_t = '".$banco."' ";
          }
          //SI SE SELECCIONA EL FILTRO TIPO DE CUENTA, SE BUSCAN EN LOS DATOS DEL TERCERO.
          if($tipo!='TIPO DE CUENTA'){
            $consulta .=" and tipo_cuenta_t = '".$tipo."' ";
          }
        }

        $proveedores = DB::select(DB::raw($consulta." order by razonsocial asc"));
    ...
    public function getDocumentacionvehiculos(){
      ...
      if (!Sentry::check()){
        ...
        //VERIFICAR CONSULTA EN ORWHERE (VEHICULOS BLOQUEADOS)
        $vehiculos = DB::table('vehiculos')
        ->select('vehiculos.*', 'proveedores.razonsocial')
        ->leftJoin('proveedores', 'proveedores.id', '=', 'vehiculos.proveedores_id')
        ->WhereNotNull('vehiculos.tarjeta_operacion_pdf')
        ->orWhereNotNull('vehiculos.soat_pdf')
        ->orWhereNotNull('vehiculos.tecnomecanica_pdf')
        ->orWhereNotNull('vehiculos.preventivo_pdf')
        ->orWhereNotNull('vehiculos.poliza_contractual_pdf')
        ->orWhereNotNull('vehiculos.poliza_extracontractual_pdf')
        ->whereNull('vehiculos.bloqueado')
        ->whereNull('vehiculos.bloqueado_total')
        ->get();

        return View::make('proveedores.documentacion.vista1')
    ...
    public function getDocumentacionconductores(){
      ...
      if (!Sentry::check()){
        ...
        //VERIFICAR CONSULTA EN ORWHERE (CONDUCTORES BLOQUEADOS)
        $conductores = DB::table('conductores')
        ->select('conductores.*', 'proveedores.razonsocial')
        ->leftJoin('proveedores', 'proveedores.id', '=', 'conductores.proveedores_id')
        //->where('conductores.fecha_licencia_vigencia','<', $fecha_actual)
        //->orWhereNotNull('conductores.licencia_conduccion_pdf')
        ->whereNotNull('conductores.licencia_conduccion_pdf')
        //->orwhereNotNull('conductores.seguridad_social_pdf')
        ->whereNull('conductores.bloqueado')
        ->whereNull('conductores.bloqueado_total')
        ->get();

        return View::make('proveedores.documentacion.vista2')
        ->with('permisos',$permisos)
        ->with('conductores',$conductores);
      }
    }

    public function postActualizardocumento(){
      ...
      if (!Sentry::check()){
        ...
        if(Request::ajax()){
          ...
          $option = Input::get('option');
          $valor_tarjeta = Input::get('valor_tarjeta');

          $vehiculo = Vehiculo::find($id);

          //COLOCAR CÓDIGO DE ELIMINACIÓN DEL ARCHIVO DEL SERVER

          $ubicacion = 'biblioteca_imagenes/prov_nuevos/gestiondocumental/vehiculos/';

          if(intval($option)===1){
            $vehiculo->fecha_vigencia_operacion = $fecha;
            $vehiculo->tarjeta_operacion = $valor_tarjeta;
            $nombre_imagen = $vehiculo->tarjeta_operacion_pdf;
            $vehiculo->tarjeta_operacion_pdf = null;
          }else if(intval($option)===2){
            $vehiculo->fecha_vigencia_soat = $fecha;
            $nombre_imagen = $vehiculo->soat_pdf;
            $vehiculo->soat_pdf = null;
          }else if(intval($option)===3){
            $vehiculo->fecha_vigencia_tecnomecanica = $fecha;
            $nombre_imagen = $vehiculo->tecnomecanica_pdf;
            $vehiculo->tecnomecanica_pdf = null;
          }else if(intval($option)===4){
            $vehiculo->mantenimiento_preventivo = $fecha;
            $nombre_imagen = $vehiculo->preventivo_pdf;
            $vehiculo->preventivo_pdf = null;
          }else if(intval($option)===5){
            $vehiculo->poliza_contractual = $fecha;
            $nombre_imagen = $vehiculo->poliza_contractual_pdf;
            $vehiculo->poliza_contractual_pdf = null;
          }else if(intval($option)===6){
            $vehiculo->poliza_extracontractual = $fecha;
            $nombre_imagen = $vehiculo->poliza_extracontractual_pdf;
            $vehiculo->poliza_extracontractual_pdf = null;
          }
    ...
    public function postEliminardocumento(){
      ...
      if (!Sentry::check()){
        ...
        if(Request::ajax()){
          ...
          if(intval($option)===1){
            ...
            $nombre_imagen = $vehiculo->poliza_extracontractual_pdf;
            $vehiculo->poliza_extracontractual_pdf = null;
            $nombre = 'POLIZA EXTRA CONTRACTUAL';
          }
          ...
          if($vehiculo->save()){
            ...
            $email = Proveedor::where('id',$vehiculo->proveedores_id)->pluck('email');
            if($email){
              $data = [
                  'motivo' => $motivo,
                  'nombre' => $nombre
    ...
    //ACTUALIZACIÓN DE LA FECHA DE LICENCIA DE CONDUCCIÓN
    public function postActualizardocumentoc(){
      ...
      if (!Sentry::check()){
        ...
        if(Request::ajax()){
          ...
          $placa = Input::get('placa');
          $fecha = Input::get('fecha');
          $expedida = Input::get('expedida');
          $option = Input::get('option');

          $conductor = Conductor::find($id);

          //COLOCAR CÓDIGO DE ELIMINACIÓN DEL ARCHIVO DEL SERVER
          $ubicacion = 'biblioteca_imagenes/prov_nuevos/gestiondocumental/conductores/';

          $nombre_imagen = $conductor->licencia_conduccion_pdf;

          $conductor->licencia_conduccion_pdf = null;
          $conductor->fecha_licencia_expedicion = $expedida;
          $conductor->fecha_licencia_vigencia = $fecha;
          $conductor->save();
    ...
    //ACTUALIZACIÓN DE FECHAS, SEGURIDAD SOCIAL.
    public function postActualizardocumentoss(){
      ...
      if (!Sentry::check()){
        ...
        if(Request::ajax()){
          ...
          $existente = DB::table('seguridad_social')
          ->where('numero_ingreso',$numero_planilla)
          ->first();
          ...
          if($existente!=null){
            ...
            $values = explode('-', $fecha_inicial);

            $ss = new Seguridadsocial();
            $ss->fecha_inicial = $fecha_inicial;
            $ss->fecha_final = $fecha_final;
            $ss->numero_ingreso = $numero_planilla;
            $ss->pago = 1;
            $ss->ano = $values[0];
            $ss->mes = $values[1];
            ...
            $nombre_imagen = $conductor->seguridad_social_pdf;

            $conductor->seguridad_social_pdf = null;
            $conductor->save();
    ...
    public function postEliminardocumentoc(){
      ...
      if (!Sentry::check()){
        ...
        if(Request::ajax()){
          ...
          if(intval($option)===1){
            ...
            /*COLOCAR CÓDIGO PARA INGRESAR LA FECHA ACTUALIZADA EN LA TABLA DE SEGURIDAD SOCIAL*/
            $nombre_imagen = $conductor->seguridad_social_pdf;
            $conductor->seguridad_social_pdf = null;
            $nombre = 'SEURIDAD SOCIAL';
          }
          ...
          if($conductor->save()){
            ...
            /*ENVÍO DE CORREO AL PROVEEDOR*/
            $email = Proveedor::where('id',$conductor->proveedores_id)->pluck('email');
            if($email){
              $data = [
                  'motivo' => $motivo,
                  'nombre' => $nombre
    ...
    public function getUsuarios(){
      ...
      if (!Sentry::check()){
        ...
        $proveedores = Proveedor::afiliadosinternos()
        ->select('proveedores.*', 'users.first_name', 'users.last_name', 'users.username', 'users.last_login', 'users.id as id_usuario')
        ...
        return View::make('proveedores.usuarios')
        ->with([
            'departamentos' => $departamentos,
            'proveedores' => $proveedores,
            'permisos' => $permisos
    ...
    public function postCrearusuario(){
      ...
      if (!Sentry::check()){
        ...
        if (Request::ajax()) {
          ...
          //$consulta = "select * from users where username is not null and usuario_portal = 0 order by id desc limit 1";
          //$ultimo = DB::select($consulta);
    ...
    public function postBloquearusuario(){
    ...
    public function postBloqueousoconductorv2(){
      ...
      if (Request::ajax()) {
        ...
        if ($conductor->bloqueado==1) {
          ...
          $conductor->motivo_bloqueo_uso = 'INACTIVO';
          $conductor->bloqueado = 1;
        }
    ...
    public function postDesbloqueousoconductorv2(){
    ...
    public function postBloqueototalconductorv2(){
      ...
      if (Request::ajax()) {
        ...
        if ($conductor->bloqueado_total==1) {
          ...
          $conductor->motivo_bloqueo_total = 'INACTIVO';
          $conductor->bloqueado_total = 1;
        }
    ...
    public function postDesbloqueototalconductorv2(){
    ...
    //VEHICULOS
    public function postBloqueousovehiculov2(){
      ...
      if (Request::ajax()) {
        ...
        if ($vehiculo->bloqueado==1) {
          ...
          $vehiculo->motivo_bloqueo_uso = 'INACTIVO';
          $vehiculo->bloqueado = 1;
        }
    ...
    public function postDesbloqueousovehiculov2(){
    ...
    public function postBloqueototalvehiculov2(){
      ...
      if (Request::ajax()) {
        ...
        if ($vehiculo->bloqueado_total==1) {
          ...
          $vehiculo->motivo_bloqueo_total = 'INACTIVO';
          $vehiculo->bloqueado_total = 1;
        }
    ...
    public function postDesbloqueototalvehiculov2(){
    ...
    public function postBloqueomantenimiento(){
      ...
      if (Request::ajax()) {
        ...
        $vehiculo->motivo_bloqueo_mantenimiento = $detalles;
        $vehiculo->bloqueado_mantenimiento = 1;

        if ($vehiculo->save()) {

          //Email de Aviso a Operaciones
          $data = [
          ...
          $cc = ['mantenimiento@aotour.com.co','aotourdeveloper@gmail.com'];

          Mail::send('emails.bloqueo_mantenimiento', $data, function($message) use ($email, $cc){
          ...
          //Email de Aviso a Proveedor

          $emailProveedor = DB::table('proveedores')
          ->where('id',$vehiculo->proveedores_id)
          ->pluck('email');

          if(isset($emailProveedor)){
            ...
            Mail::send('emails.bloqueo_mantenimiento_proveedor', $data, function($message) use ($emailProveedor){
                $message->from('no-reply@aotour.com.co', 'AUTONET');
                $message->to($emailProveedor)->subject('Notificaciones Aotour');
                $message->cc('aotourdeveloper@gmail.com');
            });
          ...
          //Envío de mensaje WhatsApp al Proveedor
          $numeroProveedor = DB::table('proveedores')
          ->where('id',$vehiculo->proveedores_id)
          ->pluck('celular');

          if(isset($numeroProveedor)){
          ...
          //Envío de mensaje WhatsApp al Conductor
    ...
    public function postDesbloqueomantenimiento(){
      ...
      if (Request::ajax()) {
        ...
        //$vehiculo->motivo_bloqueo_mantenimiento = $detalles;
        $vehiculo->bloqueado_mantenimiento = null;
        ...
        if ($vehiculo->save()) {
          ...
          $data = [
            'usuario' => Sentry::getUser()->first_name.' '.Sentry::getUser()->last_name,
            'motivo' => $vehiculo->motivo_bloqueo_mantenimiento,
            'placa' => $vehiculo->placa
          ];
          ...
          Mail::send('emails.desbloqueo_mantenimiento', $data, function($message) use ($email, $cc){
              $message->from('no-reply@aotour.com.co', 'AUTONET');
              $message->to($email)->subject('Notificaciones Aotour');
              $message->cc($cc);
          });
          ...
          if(isset($emailProveedor)){
            ...
            Mail::send('emails.desbloqueo_mantenimiento_proveedor', $data, function($message) use ($emailProveedor){
                $message->from('no-reply@aotour.com.co', 'AUTONET');
                $message->to($emailProveedor)->subject('Notificaciones Aotour');
                $message->cc('aotourdeveloper@gmail.com');
            });
