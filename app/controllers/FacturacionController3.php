    ...
    public function postVernovedadapp(){
        ...
        if (!Sentry::check()){
            ...
            if(Request::ajax()){
                ...
                $novedades_app = Novedadapp::where('servicio_id', Input::get('servicio_id'))->where('estado',1)->get();
    ...
    public function postBuscar(){
        ...
        if (!Sentry::check())
        {
            ...
            $consulta = "select servicios.*, novedades_reconfirmacion.id_reconfirmacion, ".
                ...
                "(select id from novedades_app where servicio_id = servicios.id and estado = 1 limit 1) as novedades_app, facturacion.revisado, facturacion.liquidado, facturacion.numero_planilla, facturacion.facturado, facturacion.cod_centro_costo, ".
    ...
    public function postBuscarliquidacion(){
        ...
        if (!Sentry::check()){
            ...
            $consulta = "select facturacion.liquidacion_id, servicios.id, servicios.fecha_servicio, servicios.pasajeros, servicios.recoger_en, ".
                "servicios.dejar_en, servicios.hora_servicio, servicios.expediente, ".
                "centrosdecosto.razonsocial, ".
            ...
            if(($count_servicios_totales-$count_servicios_sin_revisar)!= 0){
                ...
                Excel::create('Listado', function($excel){
                    ...
                    $excel->sheet('Servicios', function($sheet){
                        ...
                        //STRING CONSULTA
                        $consulta = "select servicios.id, servicios.fecha_servicio, servicios.hora_servicio, servicios.ciudad, servicios.solicitado_por, facturacion.numero_planilla, servicios.pasajeros, servicios.cantidad, servicios.ruta ,".
                        ...
                        if(intval($centrodecosto)===349 or intval($centrodecosto)===311){
        ...
        if (!Sentry::check()){
            ...
            if(Request::ajax()){
                ...
                if ($ordenes_facturacion>0) {
                    ...
                    $identificacion = "13832081"; //Número de identificación del cliente
                    $descripcion = "Servicio de Transporte AOTOUR - Prueba Samuel"; //Descrición de la factura
                    $val = 1000000; //Valor bruto de la factura
    ...
    public function getOrdenesfacturacion(){
        ...
        if (!Sentry::check()){
            ...
            $ordenes_facturacion = DB::table('ordenes_facturacion')
                ...
                ->select('ordenes_facturacion.id', 'ordenes_facturacion.created_at', 'ordenes_facturacion.consecutivo','ordenes_facturacion.ciudad', 'centrosdecosto.credito',
            ...
            if (Request::ajax()) {
                ...
                if ($proceso===0) {
                    ...
                    if ($proveedor==='null') {
                        ...
                        $consulta .= "and proveedor in (".$proveedor.") ";
                        $pagos = DB::select($consulta);
                    }
                ...
                #PAGOS A PAGAR
                    ...
                    $consulta = "select pagos.id, proveedores.razonsocial, proveedores.tipo_afiliado, pagos.fecha_registro, pagos.fecha_pago, pagos.fecha_preparacion, pagos.fecha_pago_real, ".
                        ...
                        "left join proveedores on pagos.proveedor = proveedores.id ".
                        "left join users on pagos.usuario = users.id ".
                        "where pagos.autorizado = 1 and pagos.fecha_pago BETWEEN '".$fecha_inicial."' AND '".$fecha_final."'  ";
