  ...
  public function getIndex(){
    ...
    if (!Sentry::check()){
        ...
        $query = DB::table('servicios')
            ...
            //->whereIn('servicios.localidad',[1,0])
      ...
      if (!Sentry::check()){
          ...
          if (Request::ajax()){
              ...
              $consulta = "select servicios.id, servicios.fecha_orden, servicios.fecha_servicio, servicios.solicitado_por, servicios.programado_app, ".
                  ...
                  "where servicios.fecha_servicio between '".$fecha_inicial."' AND '".$fecha_final."' and users.localidad in (1,3) and centrosdecosto.localidad  in ('barranquilla','provisional')";
              ...
              if ($validador->fails()){
                  ...
                  for($i=0; $i<$cantidadArrays; $i++){
                      ...
                      if($ordenes_facturacion!=null or $liquidacion!=null){
                          ...
                          //$servicio->estado_km = intval(Input::get('kilometraje'));
                          ...
                          if($servicio->proveedor_id!=45 and $servicio->proveedor_id!=336){
                            if ($kilometrajeArray[$i]==='SI') {
                              ...
                              $post['text'] = "Sr(a) ".$name_first[0].", se le ha programado un servicio ".$mens." para el dia ".$servicio->fecha_servicio.", a las ".$servicio->hora_servicio.". Por favor, revise su APP!";
                              $post['from'] = "msg";
                              $user ="Aotour";
                              $password = 'Tour20+';
                              $ch = curl_init();
                          ...
                          if ($kilometrajeArray[$i]==='SI') {
                            ...
                            $c_servicio = new Cservicio();
                            $c_servicio->id_servicio = $servicio->id;
                            $c_servicio->kilometros = 0;
                            $c_servicio->save();
