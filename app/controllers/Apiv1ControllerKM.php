...
class Apiv1Controller extends BaseController{
    ...
    public function getConsultarconductor()
    {
    ...
    public function postReporteslimpieza(){
      ...
      $formulario->barras_de_sujecion = 1;
      $formulario->eleva_vidrios = 1;
      $formulario->manijas = 1;
      $formulario->palanca_de_cambios = 1;
      $formulario->cinturones_de_seguridad = 1;
      $formulario->seguro_de_puertas = 1;
      $formulario->descansa_brazos = 1;
      $formulario->cabeceras = 1;
      $formulario->asientos = 1;
      $formulario->timon = 1;
      $formulario->pisos_del_vehiculo = 1;
      $formulario->tapetes = 1;
      $formulario->paredes = 1;
      $formulario->superficies_externas = 1;
      $formulario->tapabocas = 1;
      $formulario->bayetas_de_tela = 1;
      $formulario->alcohol = 1;
      $formulario->mezcla_de_agua_y_detergente = 1;
      $formulario->mezcla_de_agua_con_sodio = 1;
      $formulario->desinfectante_en_aerosol = 1;
      $formulario->desinfectantes_liquidos = 1;
      $formulario->termonebulizacion = 1;
    ...
    public function postIniciarservicio2()
    {
      ...
      if ($servicio->recorrido_gps===null) {
        ...
        if($servicio->recoger_pasajero!=null and $servicio->estado_servicio_app===1){
    ...
    public function postFinalizarservicio2()
    {
      ...
      $json_recoger_pasajero = json_decode($servicio->recoger_pasajero_location);
      $timestamp_recoger_pasajero = $json_recoger_pasajero->timestamp;
      $timestamp_recoger_pasajero = explode(' ', $timestamp_recoger_pasajero);
      $hora_recogida_pasajero = '18:40:59'; //$timestamp_recoger_pasajero[1];
      ...
      if ($servicio->save()) {
        ...
        //Recortar imagen
        //$img->trim()->crop(500, 500, 0)->rotate(-90)->trim('black', ['left'])->save($filepath);
        //$hora_recogida_pasajero = '15:00:00';
        $servicio_kilometraje = Cservicio::where('id_servicio',$id)->first();
        $servicio_kilometraje->s_finalizado = date('Y-m-d H:i:s');
        $servicio_kilometraje->save();
        //$hora_finalizacion = $servicio_kilometraje->s_finalizado;
        //$hora_finalizacion = $servicio_kilometraje->s_finaliazdo[1]; //Hora de finalización
        $fin = explode(' ', $servicio_kilometraje->s_finalizado); //Fecha de finalización
        $hora_finalizacion = $fin[1];
        
        $hora_finalizacion = '10:30:00'; //hora de finalización del servicio (PARA HACER PRUEBAS)
        $hora_recogida_pasajero = '07:50:00'; //HORA DE INICIO DE KILOMETRAJE (PRUEBAS)

        $horaInicio = new DateTime($hora_recogida_pasajero); 
        $horaTermino = new DateTime($hora_finalizacion);
        //$horaTermino = '19:00';hora_finalizacion
        ...
        $km = $servicio_kilometraje->kilometros;
        ...
        if($hora_recogida_pasajero<='06:00:00' and $hora_finalizacion>='08:00:00'){
          $extra = 200*120;
          $msj = 'Hora pico 6 1';
        }else if($hora_recogida_pasajero<='06:00:00' and $hora_finalizacion<'08:00:00'){
          $start = new DateTime('06:00:00');
          $end = new DateTime($hora_finalizacion);
          ...
          $msj = 'Hora pico 6 2';
        }else if($hora_recogida_pasajero>'06:00:00' and $hora_recogida_pasajero<'08:00:00' and $hora_finalizacion<'08:00:00' and $hora_finalizacion>'06:00:00'){
          $start = new DateTime($hora_recogida_pasajero);
          $end = new DateTime($hora_finalizacion);
          ...
          $msj = 'Hora pico 6 3';
        }else if($hora_recogida_pasajero>'06:00:00' and $hora_recogida_pasajero<'08:00:00' and $hora_finalizacion>='08:00:00'){
          $start = new DateTime($hora_recogida_pasajero);
        ...
        $mensaje2 = null;
        if($hora_recogida_pasajero<='12:00:00' and $hora_finalizacion>='14:00:00'){
          $extra2 = 200*120;
          $mensaje2 = 'Hora pico 12 1';
        }else if($hora_recogida_pasajero<='12:00:00' and $hora_finalizacion<'14:00:00' and $hora_finalizacion>'12:00:00'){
          ...
          $mensaje2 = 'Hora pico 12 2';
        }else if($hora_recogida_pasajero>'12:00:00' and $hora_recogida_pasajero<'14:00:00' and $hora_finalizacion<'14:00:00' and $hora_finalizacion>'12:00:00'){
          $start = new DateTime($hora_recogida_pasajero);
          $end = new DateTime($hora_finalizacion);
          ...
          $mensaje2 = 'Hora pico 12 3';
        }else if($hora_recogida_pasajero>'12:00:00' and $hora_recogida_pasajero<'14:00:00' and $hora_finalizacion>='14:00:00'){
          $start = new DateTime($hora_recogida_pasajero);
          ...
          $mensaje2 = 'Hora pico 12 4';
        }else{
          $mensaje2 = 'NO Hora pico 12';
        }
        //FIN CONTROLES HORA PICO 12:00 - 14:00

        //INICIO CONTROLES HORA PICO 17:00 - 19:00
        $mensaje3 = null;
        if($hora_recogida_pasajero<='17:00:00' and $hora_finalizacion>='19:00:00'){
          $extra3 = 200*120;
          $mensaje3 = 'Hora pico 17 1';
        }else if($hora_recogida_pasajero<='17:00:00' and $hora_finalizacion<'19:00:00' and $hora_finalizacion>'17:00:00'){
          ...
          $mensaje3 = 'Hora pico 17 2';
        }else if($hora_recogida_pasajero>'17:00:00' and $hora_recogida_pasajero<'19:00:00' and $hora_finalizacion<'19:00:00' and $hora_finalizacion>'17:00:00'){
          $start = new DateTime($hora_recogida_pasajero);
          $end = new DateTime($hora_finalizacion);
          ...
          $mensaje3 = 'Hora pico 17 3';
        }else if($hora_recogida_pasajero>'17:00:00' and $hora_recogida_pasajero<'19:00:00' and $hora_finalizacion>='19:00:00'){
          $start = new DateTime($hora_recogida_pasajero);
          ...
          $mensaje3 = 'Hora pico 17 4';
        }else{
          $mensaje3 = 'NO Hora pico 17';
        }
        //FIN CONTROLES HORA PICO 17:30 - 19:30        

        /*CÁLCULO DE LA TARIFA*/
        $sele = $servicio_kilometraje->tipo_servicio;
        if($sele==='LOCAL'){
          $busqueda = DB::table('centrosdecosto')
          ->where('id',$servicio->centrodecosto_id)
          ->pluck('valor_metro');
        }else if($sele==='MUNICIPAL'){
          $busqueda = DB::table('centrosdecosto')
          ->where('id',$servicio->centrodecosto_id)
          ->pluck('valor_metro_m');
        }else if($sele==='DEPARTAMENTAL'){
          $busqueda = DB::table('centrosdecosto')
          ->where('id',$servicio->centrodecosto_id)
          ->pluck('valor_metro_d');
        }
        $valor_tarifa = $km*$busqueda;//VERIFICAR VALOR INT O FLOAT

        //CALCULAR RECARGOS POR DOMINGOS Y FESTIVOS
        /* SI LA FECHA DE INICIO Y FINALIZACIÓN ES LA MISMA*/
        $extra_noche = null;
        if($timestamp_recoger_pasajero[0]===$fin){
        $extra_noche = 0;
          //INICIO CONTROLES HORA PICO 17:30 - 19:30
          if($hora_recogida_pasajero<='20:00:00' and $hora_finalizacion>='23:59:00'){ //SI EL SERVICIO ES EJECUTADO EN TODOS LOS MINUTOS DE RECARGO NOCTURNO PARTE 1
            $extra_noche = $valor_tarifa*0.20;
          }else if($hora_recogida_pasajero<='20:00:00' and $hora_finalizacion<'23:59:00'){
            $extra_noche = $valor_tarifa*0.20;
          }else if('20:00:00'<= $hora_recogida_pasajero and '23:59:00'<=$hora_finalizacion){
            $extra_noche = $valor_tarifa*0.20;
          }else if('20:00:00'>= $hora_recogida_pasajero and '23:59:00'<=$hora_finalizacion){
            $extra_noche = $valor_tarifa*0.20;
          }else if($hora_finalizacion<'23:59:00' and $hora_recogida_pasajero>'20:00:00'){
            $extra_noche = $valor_tarifa*0.20;
          }
          //FIN CONTROLES HORA PICO 17:30 - 19:30
        }else{// SI EL SERVICIO ES EJECUTADO EN LA MADRUGADA

          if($hora_finalizacion<='05:00:00'){ //SI EL SERVICIO ES EJECUTADO EN TODOS LOS MINUTOS DE RECARGO NOCTURNO PARTE 1
            $extra_noche = $valor_tarifa*0.20;
          }else{
            $extra_noche = 0;
          }
...
/*
            Mail::send('emails.data_servicio_facturacion', [
              ...
              'contenido' => $servicio_kilometraje,
              'kilometros' => round($servicio_kilometraje->kilometros, 1),
              'tiempo' => $intervalo,
...
/*
        ...
        */
        ...
        return Response::json([
          'respuesta'=>true,
          //'1_fecha_inicio' => $timestamp_recoger_pasajero[0],
          //'2_fecha_fin' => $fin[0],
          //'3_extra_noche' => $extra_noche,
          //'time' => $intervalo,
          'km' => round($servicio_kilometraje->kilometros, 1),
          //'timestamp_recoger_pasajero' => $hora_recogida_pasajero,
          //'dat' => $hora_finalizacion,
          //'min'=> $minutos,
          //'valor_tarifa' => $valor_full,
          'valor_tarifa_+_base' => (intval($valor_tarifa).'000')+9000,
          //'test' => $test,
          'hours' => $horas,
          'minutes' => $minutos,
          'seconds' => $segundos,
          ...
          'extra2' => $extra2,
          'extra3' => $extra3,
          'Mensaje' => 'SERVICIO POR KILOMETRAJE '.$sele.', el Valor por metro es: '.$busqueda
