                ...
                if($liquidacion!=null or $ordenes_facturacion!=null){
                    ...
                    foreach ($pasajeros[$i] as $item){
                        ...
                        /*if($pasajeroid!=null){   
                            ...
                            $programacion_rutaqr->id_usuario=$pasajeroid->cedula;
                            $programacion_rutaqr->vehiculo=$vehiculoplacaArray[$i];
                            ...
                            if($rnid!=null){
                                ...
                                $programacion_rutaqr->id_rutaqr=strtoupper(strtolower($detalleArray[$i]));//$rutaIdArray[$i];
                            }
...
*/
                        ...
                        //}else{*/
                            ...
                            $programacion_rutaqr->fullname = $fullname;
                            $programacion_rutaqr->address = $address;
                            $programacion_rutaqr->locality = $locality;
                            $programacion_rutaqr->neighborhood = $neighborhood;
                            $programacion_rutaqr->save();
                       // }                    
                    }
                }
