...
return 'testing';
  ...
  Route::get('descargarqr', function(){
    ...
    $username = Sentry::getUser()->username;
    $data = DB::table('pasajeros')->where('correo',$username)->first();
    //$cliente = DB::table('pasajeros')->where('correo',$username)->pluck('centrodecosto_id');
    $centro = DB::table('centrosdecosto')->where('id',$data->centrodecosto_id)->pluck('razonsocial');
...
*/
  ...
  Route::controller('serviciosejecutivos', 'ServiciosejecutivosController'); //Administrador de Centro de Costo
  ...
  Route::controller('transporteescolar', 'EscolarController');//escolar
  Route::controller('inventario', 'InventarioController');//Inventario
  Route::controller('siigo', 'SiigoController');//Siigo
  Route::controller('transportederuta', 'TransportederutaController');//QR
  Route::controller('tareas', 'TareasController');//QR
  ...
  Route::group(['prefix' => 'api', 'before' => 'oauth'], function(){
      Route::controller('v3','Apiv3Controller');
  });

  Route::group(['prefix' => 'api', 'before' => 'oauth'], function(){
      Route::controller('v4','Apiv4Controller');
  });

  Route::group(['prefix' => 'api', 'before' => 'oauth'], function(){
      Route::controller('v5','Apiv5Controller');
  });

  Route::group(['prefix' => 'api', 'before' => 'oauth'], function(){
      Route::controller('upnet','ApiupnetController');
  });
