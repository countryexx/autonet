                          ...
                          @if(isset($permisos->bogota->transportes->ver))
                              ...
                              ?>
                                ...
                                <a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bold" aria-hidden="true"></i>OGOTÁ 
                                    ...
                                    @if($sin_programar>0)
                                      <div class="badge_menu_head fontbulger servicios_mobile_badge">{{$sin_programar}}
                                      </div>
                                    @else
                                      <div class="badge_menu_head servicios_mobile_badge">{{$sin_programar}}
                                      </div>
                                    @endif                                     
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="dropdown-submenu">
                                      ...
                                      <ul class="dropdown-menu">
                                        <li><a href="{{url('transportesbog')}}">Servicios <i class="fa fa-car" aria-hidden="true"></i></a></li>        
                                          ...
                                          <li><a href="{{url('transportesbog/serviciosporprogramar')}}">Servicios Excel  <i class="fa fa-calendar" aria-hidden="true"></i></a></li>
                                ...
                                @if($permisos->administrativo->proveedores->ver==='on')
                                    <li class="dropdown-submenu">
                                      ...
                                      <ul class="dropdown-menu">
                                          ...
                                          @if(Sentry::getUser()->id===2 or Sentry::getUser()->id===4086)
