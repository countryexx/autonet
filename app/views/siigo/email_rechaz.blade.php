			...
			<tr>
				<td>
					<table width="100%">
						<tr>
							<td>
								<p class="names">Maria Fernanda Puche Donado</p>
								<p class="asunto">Cotización N° 3430</p>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								<img src="{{url('img/rechaz.png')}}" alt="" width="600" style="max-width: 100%;">
							</td>
						</tr>

						<tr>
							<td style="text-align: center; padding: 15px 20px; color: #ffffff">
								<img class="footer-logo" src="{{url('img/footer-logo-black.png')}}" alt="" width="600" style="max-width: 100%;">
							</td>
						</tr>
