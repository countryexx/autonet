	...
	<center class="wrapper">
		...
		<table class="main" width="100%">
			...
			<!-- BANNER IMAGE -->
				<tr>
					<td>
						<a href=""><img src="{{url('img/head.png')}}" alt="" width="600" style="max-width: 100%;"></a>
					</td>
				</tr>
			...
			<tr>
				<td>
					<table width="100%">
						<tr>
							<td>
								<p class="names">Sr(a) ARIEL ARTERA</p>
							</td>
						</tr>
						...
						<tr>
							<td>
								<table width="100%">
									<tr>
										<td>
											<img src="{{url('img/Image202.png')}}" width="100%">
										</td>
									</tr>
								</table>
							</td>
