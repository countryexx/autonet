                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:center">Cotización N° 1234</p>
                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" align="center" width="640">
                          <p style="text-align: left; color: white; font-size: 18px; font-family: sans-serif; margin-top: 18px">Agradecemos tu interés en utilizar nuestros servicios.<br>Adjunto encontrarás la cotización solicitada el .</p>
                          <table style="width: 100%" >
                            <thead>
                              <tr>
                                <th style="color: white; background-color: green; padding: 5px; width: 45%; text-align: center;">
                                  <a target="_blank" href="{{url('cotizaciones/aceptarcotizacion/1234'" style="background: green; float: left; border: 0 solid green; color: white; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">Aceptar Cotización <i class="fa fa-check" aria-hidden="true"></i></a>
                                </th>
                                ...
                                <th style="color: white; background-color: red; padding: 5px; width: 45%; text-align: center;">
                                  <a target="_blank" href="{{url('cotizaciones/rechazarcotizacion/1234'" style="background-color: red; float: right; border: 0 solid red; color: white; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">Rechazar Cotización <i class="fa fa-times" aria-hidden="true"></i></a>
                                </th>
                              </tr>
                            </thead>
