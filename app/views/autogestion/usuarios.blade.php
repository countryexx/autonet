...
<div class="col-xs-12">
    ...
    <div class="col-lg-12">
      <div class="row">
        ...
        <div class="estado_servicio_app" style="background: gray; color: white; margin: 2px 0px; font-size: 15px; padding: 3px 5px; width: 310px; border-radius: 2px;">LISTADO DE PASAJEROS | {{Sentry::getUser()->empresa}}</div>
      
        <div class="col-lg-2 col-md-3 col-sm-2" style="margin-bottom: 5px;">
          <div class="row">
            <label>Filtrar por estado de usuario</label>
            ...
            <tr data-id="{{$usuario->id}}" class="@if(intval($usuario->estado)===1){{'success'}}@elseif(intval($usuario->estado)===2){{'danger'}}@endif">
              ...
              <td>
                ...
                <div class="form-floating">
                  <select data-id="{{$usuario->id}}" nombres="{{$usuario->nombres}}" class="form-control estado" id="floatingSelect" aria-label="Floating label select example">
                    <option @if($usuario->estado==1){{'selected'}}@endif value="1">Activo</option>
                    <option @if($usuario->estado==2){{'selected'}}@endif value="2">Inactivo</option>
                  </select>
                </div>
              ...
              <!--<td>
                <center>
                  <a title="No Programar" class="btn btn-danger btn-list-table editar"><i class="fa fa-times" aria-hidden="true"></i></a>
                  <a title="Programar"class="btn btn-success btn-list-table editar"><i class="fa fa-check" aria-hidden="true"></i></a>
                  <div class="estado_servicio_app" style="background: orange; color: white; margin: 2px 0px; font-size: 9px; padding: 3px 5px; width: 90px; border-radius: 2px;">PROGRAMADO</div>
                </center>
              </td>-->
