...
<head>
    <meta charset="UTF-8">
    <title>Autonet | Programar de Salidas</title>
...
<div class="col-xs-12">
    ...
    <div class="col-lg-12">
      <div class="row">
        <div class="estado_servicio_app" style="background: gray; color: white; margin: 2px 0px; font-size: 15px; padding: 3px 5px; width: 210px; border-radius: 2px;">SOLICITAR RUTAS DE SALIDA</div>

        <h3 class="h_titulo"></h3>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-xs-2">
        <label class="obligatorio cedula" for="programa">Selecciona la fecha de las rutas</label>
        <div class="input-group date datetime_fecha">
          <input name="fecha_inicial" id="fecha" style="width: 100%;" type='text' class="form-control input-font" value="">
    ...
    <label>Seleccionar a todos los pasajeros</label>
    <input style="font-size: 40px" type="checkbox" id="cbox1" class="select_all" value="second_checkbox">
      <table id="example" class="table table-bordered hover" cellspacing="0" width="100%">
          ...
          @foreach($usuarios as $usuario)
            <tr data-id="{{$usuario->id}}">
              ...
              <td>{{$usuario->horario_entrada}}</td>
              <td>{{$usuario->horario_salida}}</td>
              ...
              <td>
                <center><input data-id="{{$usuario->id}}" data-hora="{{$usuario->horario_salida}}" type="checkbox" id="cbox1" class="services" value="first_checkbox"></center>
              </td>
            </tr>
            <?php $o=$o+1; ?>
          @endforeach
    ...
    @endif
    <button id="buscar" class="btn btn-primary btn-icon enviar_solicitud">
                    Enviar Solicitud<i class="fa fa-send icon-btn"></i>
                </button>
</div>
...
<script type="text/javascript">
    ...
    $('.enviar_solicitud').click(function() {
        ...
        if(dt!='' && fecha!=''){
                      ...
                      action: function(){
                        ...
                        $.ajax({
                          ...
                          if(data.response==true){                       
                            ...
                            $.confirm({
                                title: 'Realizado',
                                content: 'Solicitud enviada con éxito!<br><br>Serás redirigido al listado de solicitudes...',
                                buttons: {
                                    confirm: {
                                        text: 'Ok',
                                        btnClass: 'btn-success',
                                        ...
                                        action: function(){
                                          ...
                                          location.href = "salidassolicitadas";
          ...
          if(dt=='') {
            txt += '¡No has seleccionado ningún pasajero!<br>';
          }

          if(fecha=='') {
            txt += '¡No has seleccionado la fecha!<br>';
          }
          $.confirm({
              title: 'Atención',
              content: txt,
