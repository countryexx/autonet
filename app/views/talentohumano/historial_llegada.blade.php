...
<html>
  <head>
    ...
    <title>Autonet | Historial de llegada</title>
  ...
  <body>
    ...
    <div class="col-lg-12">
        ...
        <h3 class="h_titulo">HISTORIAL DE LLEGADA </h3>       
        <form class="form-inline" id="form_buscar" action="{{url('control/pdfbaq')}}" method="get">
            ...
            <div class="col-lg-12" style="margin-bottom: 5px">
                <div class="row">
                  ...
                  <button data-option="0" id="buscar" class="btn btn-default btn-icon">Buscar<i class="fa fa-search icon-btn"></i></button>
