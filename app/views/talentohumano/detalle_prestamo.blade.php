      					...
      					<div class="panel-body">
                            <table style="margin-bottom:15px" class="table table-bordered hover">
                                <tbody>
                                    <tr>
                                      ...
                                      <td>
                                        <?php                                         
                                          echo '$ '.number_format($prestamo->valor);
                                        ?>
                                      </td>
                                    </tr>
                                        <tr>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            @if($prestamo->estado_prestamo==0)
                                              <span style="color: red"><b>SIN PAGO</b></span>
                                            @elseif($prestamo->estado_prestamo==2)
                                    ...
                                    <tr>
                                      @if(isset($prestamo->detalles))
                                        <?php $json = json_decode($prestamo->detalles); 
                                        $cont = 1;
                                        $total = 0;
                                        $conta = count($json);
                                        ?>
                                          ...
                                          <table class="table table-bordered table-hover" id="exampledetallessinpago">
                                              ...
                                              <tbody>
                                                @foreach($json as $data)
                                                  <tr>
                                                    <td><?php echo $cont ?></td>
                                                    <td><?php echo '$ '.number_format($data->valor_actual); ?></td>
                                                    <td><?php echo '$ '.number_format($data->valor_abono); ?></td>
                                                    @if($conta==$cont)
                                                      <td style="background: orange"><?php echo '$ '.number_format($data->valor_restante); ?></td>
                                                    @else
                                                      <td><?php echo '$ '.number_format($data->valor_restante); ?></td>
                                                    @endif
