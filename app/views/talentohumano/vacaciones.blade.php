...
<div id="container">
  <h1>&bull; Registro de Vacaciones &bull;</h1>
  
  <form id="formulario">
    <div class="row">      
        
          <div class="col-lg-6">
            <label for="name" class="obligatorio">Fecha Inicial</label>      
            <div class='input-group date' id='datetimepicker1'>
                <input name="fecha_inicial" id="fecha_inicial" style="text-align: center;" type='text' class="form-control input-font" value="{{date('Y-m-d')}}">
          ...
          <div class="col-lg-6">
            <label for="email" class="obligatorio">Fecha de Finalización</label>
            <div class='input-group date' id='datetimepicker2'>
                <input name="fecha_final" id="fecha_final" style="text-align: center;" type='text' class="form-control input-font" value="{{date('Y-m-d')}}">
                <span class="input-group-addon">
                    <span class="fa fa-calendar">
                    </span>
                </span>
    ...
    <div class="row">
      <div class="col-lg-12">
        <label for="observaciones" class="obligatorio"> Observaciones</label>
        <input type="text" placeholder="INGRESAR LAS OBSERVACIONES" name="observaciones" id="observaciones">          
      </div>
    </div>    
    
    <div class="submit">
      @if($permisos->talentohumano->vacaciones->crear==='on')
        <input type="submit" value="Guardar" id="guardarv" />
      @else
        <input type="submit" disabled value="Guardar" id="guardarv" />
      @endif
    </div>
  </form><!-- // End form -->
</div><!-- // End #container -->
