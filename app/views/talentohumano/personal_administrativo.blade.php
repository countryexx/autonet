...
@supports(object-fit: cover){
  ...
  <body>
    ...
    <div class="col-lg-10">
     ...
     <div class="col-lg-12">
          <h3 class="h_titulo">PERSONAL ADMINISTRATIVO</h3>
          <br>
          ...
          @else
          <h1 style="text-align: center;">No hay empleados administrativos creados.</h1>
          @endif
          
          <!-- FIN VISTA DE TODOS LOS EMPLEADOS -->


          <!-- VISTA DE EMPLEADOS BARRANQUILLA -->
          @if($empleadosbaq)            
          ...
          @else
            NO HAY EMPLEADOS DE BAQ CREADOS
          @endif

          <!-- FIN VISTA DE EMPLEADOS BARRANQUILLA -->
          

          <!-- VISTA DE EMPLEADOS BOGOTA -->
          @if($empleadosbog)
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                ...
                <input type="file" class="form-control hoja hidden" name="hoja_de_vida" id="hoja_de_vida" accept="application/pdf">
                          ...
                          <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-12 col-xs-12">
                                    ...
                                    <select class="form-control input-font" name="tipo_personal" id="tipo_personal">
                                        ...
                                        <option >ADMINISTRATIVO</option> 
                                        <option disabled>OPERATIVO</option>    
