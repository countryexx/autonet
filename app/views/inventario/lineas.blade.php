...
<html>
  <head>
    ...
    <title>Autonet | Líneas Corporativas</title>
  ...
  <body>
    ...
    <div class="col-lg-12">
        ...
        <h3 class="h_titulo">LISTADO DE LÍNEAS CORPORATIVAS</h3>       
            ...
            <tbody>
                ...
                @foreach($lineas as $linea)
                  <tr>
                    ...
                    ?>
                    <td>{{$o}}</td>
                    <td><span style="font-size: 16px">{{$linea->lineas}} - <b style="color: <?php echo $color; ?>;">{{$linea->tipo_plan}}</b></span></td>
                    <td>
                      <?php 

                      $usuario = explode(',', $linea->usuario);
                      ...
                      foreach ($users as $user) {
                         $name .= $user->nombres.' '.$user->apellidos.'<br>';
                         $sw++;
                       } 
                       //echo $sw;
                    ...
                    <td>
                      ...
                      <a target="_blank" href="{{url('inventario/address/'.$linea->id)}}" id="notificar" class="detalles_centro btn btn-list-table btn-primary ">Ver Historial</a>

                    </td>
                    <td>
                      Creado el {{$linea->created_at}}
                    </td>
                  </tr>
                  <?php $o++; ?>
                @endforeach
