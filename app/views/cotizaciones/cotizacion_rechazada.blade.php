...
<body style="box-sizing:border-box;margin:0;padding:0;width:100%;-webkit-font-smoothing:antialiased;word-break:break-word;">
  ...
  <table class="wrapper" bgcolor="#EEEEEE" cellpadding="15" cellspacing="0" role="presentation" width="100%">
    <tr>
      <td>
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="770" style="background-color: #454545">
          <tr>
            <td>
                      ...
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:center"></p>
                            ...
                            <center>
                            <div style="padding: 1px 0px 1px 0px; background-color: #272929; color: white; width: 50%">
                      ...
                      <tr>
                        <td class="col" align="center" width="640">
                          ...
                          <table class="servicio">
                          	<tr>
                          		<td>
                          			<center><br><b style="color: #DC4405; font-size: 30px; font-family: 'Sansation', sans-serif;">¡Ha sido rechazada!</b></center>
                          		</td>
                          	</tr>
                          	<!--<tr>
                          		<td>
                          	...
                          	<tr>
                          		<td>
                          			<center><p style="font-size: 20px; font-family: 'Sansation', sans-serif; color: white;">Esperamos contar contigo en otra oportunidad.</p></center>
                          		</td>
                          	</tr>

                          	<tr>
                          		<td>
                          			<center><img class="align-sm-center" width="220" style="width: 520px; margin-bottom: 20px;" src="{{url('img/logo-rechazo.png')}}"></center>
                          		</td>
                          	</tr>
