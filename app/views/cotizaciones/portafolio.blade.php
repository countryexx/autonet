...
<body style="box-sizing:border-box;margin:0;padding:0;width:100%;-webkit-font-smoothing:antialiased;word-break:break-word;">
  ...
  <table class="wrapper" bgcolor="#EEEEEE" cellpadding="15" cellspacing="0" role="presentation" width="100%">
    <tr>
      <td>
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="770" style="background-color: #f47321">
          <tr>
            <td>

              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-bottom: 1px solid;">
                <tr>
                  <td>
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      
                      <center>
                      <img class="align-sm-center" style="width: 100%;" src="{{url('img/header.png')}}">
                      </center>
                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:center"></p>
                            
                            <center>
                            <p style="font-family: 'Sansation', sans-serif; font-size: 40px; color: white; font-weight: bold;">¡GRACIAS POR LEERNOS!</p>

                              <!--<p style="font-family: 'Sansation', sans-serif; font-size: 40px; font-weight: bold; color: white;">María Fernanda Cabal</p>-->

                              <p style="font-family: 'Sansation', sans-serif; font-size: 25px; color: white;">Somos AOTOUR una empresa de transporte que ofrece soluciones rápidas de movilidad. Vive con nosotros una experiencia única de transporte, tecnología y seguridad.</p>

                              <div style="padding-bottom: 0.1px; padding-top: 0.1px; background-color: #454545; color: white; width: 55%; border-radius: 20px;">
                                <p style="font-family: 'Sansation', sans-serif; font-size: 18px; font-weight: bold;">Adjuntamos nuestro protafolio de servicios.</p>
                              </div>
              ...
              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 20px; padding-bottom: 15px;">
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" align="center" width="640">
                          
                          <table class="servicio">
                          	<tr>
                          		<td>
                          			<center><br><b style="color: white; font-size: 25px; font-family: 'Sansation', sans-serif;">Cómo contactarnos?</b></center>
                          		</td>
                          	</tr>
                          	<tr>
                          		<td>
                          			<center><p style="font-size: 25px; font-family: 'Sansation', sans-serif; color: white;">Contáctanos para conocer más sobre la experiencia AOTOUR. Estas son las personas que te pueden asesorar.</p></center>
                          		</td>
                          	</tr>
                                      ...
                                      <td style="padding: 0 20px;">
                                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                          <tr>
                                            ...
                                            <td>
                                              <div align="center" class="alignment"><img alt="Person" src="{{url('img/im/npa.png')}}" style="height: 170px; border: 0; max-width: 190.5px; width: 170px;" title="Person" /></div>
                                            </td>
                                            <td>
                                              <p style="color: white; font-family: 'Sansation', sans-serif; font-size: 20px; font-weight: bold;">Barranquilla<br>Jhonnys Ojeda<br>comercial@aotour.com.co<br>Cel. +57 304 607 5607</p>
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
                          	...
                          	<tr>
                          		<td>
                          			<center><hr style="color: white; border: 1px solid white; margin-top: 30px;"></center>
                          		</td>
                          	</tr>
                          </table>
                            ...
                            <tr>
                              <td style="padding: 0 20px;">
                                <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                  <tr>
                                    <td width="50%">
                                      <center><p style="color: white; font-family: 'Sansation', sans-serif; font-size: 20px; font-weight: bold;">Tienes Preguntas?</p></center>
                                    </td>
                                    <td width="50%">
                                      <center><p style="color: white; font-family: 'Sansation', sans-serif; font-size: 20px; font-weight: bold;">Solicita una reunión por Zoom</p></center>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                                        ...
                                        <tr>
                                          <td style="padding: 0 20px;">
                                            <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                              <tr>
                                                <td width="33%">
                                                  <center><img height="40px" src="{{url('img/im/facebook2x.png')}}"></center>
                                                </td>
                                                <td width="20%">
                                                  <center><img height="40px" src="{{url('img/im/twita.png')}}"></center>
                                                </td>
                                                <td width="40%">
                                                  <center><img height="40px" src="{{url('img/im/linkedin2x.png')}}"></center>
                                                </td>
                                              </tr>
                                            </table>
                                          </td>
        ...
        <table class="container" align="center" bgcolor="#eeeee" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              <!--<p style="color: #f47321; text-decoration: underline; text-align: center; margin-bottom: 10px;">Por favor responder este correo para autorizar el servicio</p>-->
            </td>
          </tr>
        </table>
      </td>
