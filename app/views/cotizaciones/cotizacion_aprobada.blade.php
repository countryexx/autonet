                      ...
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:center"></p>
                            ...
                            <center>
                            <div style="padding: 1px 0px 1px 0px; background-color: #DC4405; color: white; width: 50%">
                              <p style="font-family: 'Sansation', sans-serif; font-size: 30px;">Respuesta Cotización</p>
                            </div>

                              <p style="font-family: 'Sansation', sans-serif; font-size: 40px; font-weight: bold; color: white;">María Fernanda Cabal</p>

                              <p style="font-family: 'Sansation', sans-serif; font-size: 30px; color: white;">Cotización N° 3430</p>
                      ...
                      <tr>
                        <td class="col" align="center" width="640">
                          ...
                          <table class="servicio">
                          	<tr>
                          		<td>
                          			<center><br><b style="color: white; font-size: 30px; font-family: 'Sansation', sans-serif;">Ha sido aceptada!</b></center>
                          		</td>
                          	</tr>
                          	<tr>
                          		<td>
                          			<center><p style="font-size: 20px; font-family: 'Sansation', sans-serif; color: white;">¡Gracias por elegirnos! Nos encargaremos que tu experiencia con nosotros sea extraordinaria.</p></center>
                          		</td>
                          	</tr>
                          	<tr>
                          		<td>
                          			<center><p style="font-size: 20px; font-family: 'Sansation', sans-serif; color: white;">Estamos felices de que formes parte de <b>AOTOUR.</b></b></p></center>
                          		</td>
                          	</tr>

                          	<tr>
                          		<td>
                          			<center><img class="align-sm-center" width="220" style="width: 520px; margin-bottom: 20px;" src="{{url('img/logo-tablet.png')}}"></center>
                          		</td>
                          	</tr>

                          	<tr>
                          		<td>
                          			<center><p style="font-size: 16px; font-family: 'Sansation', sans-serif; color: white;"><b style="color: white; font-family: 'Sansation', sans-serif;">LÍNEA FIJA NACIONAL:</b> (605 358 2555) - <b style="color: white; font-family: 'Sansation', sans-serif;">LÍNEA MÓVIL NACIONAL:</b> (+57) 314 780 6060.</b></p></center>
                          		</td>
                          	</tr>
                          </table>
