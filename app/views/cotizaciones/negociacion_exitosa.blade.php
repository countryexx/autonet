        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="770">
          <tr>
            <td>
                      ...
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          ...
                          <div style="text-align: center">
                            <img class="align-sm-center" width="220" style="width: 620px; margin-bottom: 20px; margin-top: 100px" src="{{url('img/logo-ao.png')}}">
                          </div>
                        </td>
                      </tr>
                    </table>
              ...
              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 30px; padding-bottom: 15px;">
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" align="center" width="640">
                          ...
                          <table style="border: 1px solid white;" class="servicio">
                          	<tr>
                          		<td>
                          			<center><br><br><b style="color: #DC4405; font-size: 70px; font-family: 'Sansation', sans-serif;">¡Bienvenido!</b></center>
                          		</td>
                          	</tr>
                          	<tr>
                          		<td>
                          			<center><p style="font-size: 20px; font-family: 'Sansation', sans-serif;">Reciban un cordial saludo de parte del equipo de <b>AOTOUR SAS.</b></p></center>
                          		</td>
                          	</tr>
                          	<tr>
                          		<td>
                          			<center><p style="font-size: 20px; font-family: 'Sansation', sans-serif;">Gracias por confirmar en nuestro trabajo, nos encargaremos de que vivas una experiencia de transporte a otro nivel.</b></p></center>
                          		</td>
                          	</tr>

                          	<tr>
                          		<td>
                          			<center><img class="align-sm-center" width="220" style="width: 620px; margin-bottom: 20px;" src="{{url('img/person.png')}}"></center>
                          		</td>
                          	</tr>

                          	<tr>
                          		<td>
                          			<center><p style="font-size: 16px; font-family: 'Sansation', sans-serif;"><b style="color: #DC4405; font-family: 'Sansation', sans-serif;">LÍNEA FIJA NACIONAL:</b> (605 358 2555) - <b style="color: #DC4405; font-family: 'Sansation', sans-serif;">LÍNEA MÓVIL NACIONAL:</b> (+57) 314 780 6060.</b></p></center>
                          		</td>
                          	</tr>
                          </table>
