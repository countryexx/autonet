        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jumbotron" style="padding-left: 18px; padding-right: 18px; background-color: #f47321">
                    <center> <h3 style="color: white; text-align: justify;">¡Gracias por calificar nuestro servicio!</h3>
                    <p style="color: white; text-align: justify;">Para nosotros es importante tus comentarios para seguir mejorando nuestra experiencia y siempre quieras volver.</p>                  
                </div></center>
            </div>
