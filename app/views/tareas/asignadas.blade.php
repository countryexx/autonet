...
<html>
  <head>
    ...
    <title>Autonet | Tareas Asignadas</title>
  ...
  <body>
    ...
    <div class="row" style="margin-left: 3px">
      <h1 class="h3 text-left mt-3 mb-4 pb-3" style="margin-left: 16px">Tareas Asignadas a Otros Usuarios</h1>
      <div class="col-lg-1">
                ...
                <div class="card" id="list1" style="border-radius: .75rem; background-color: #eff1f2;">
                  <div class="card-body py-4 px-4 px-md-5">
                    ...
                    <p class="h3 text-center mt-3 mb-4 pb-3 text-primary">
                      ...
                      <u>Asignar a otro usuario<br><i class="fa fa-plus add_task" aria-hidden="true"></i></u>
                    </p>
                      ...
                      <tbody>
                        ...
                        @foreach($actividades as $actividad)
                          <tr>
                            ...
                            <th>
                              <center><b>{{$actividad->fecha}}</b></center>
                          </th>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id='modal_asignar' data-backdrop="false" >
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-3">
                  ...
                  <input class="form-control input-font detalle_text" id="nombre_tarea" style="text-transform: uppercase;" placeholder="Nombre de la Tarea" autocomplete="off" id="nombre_tarea">
          ...
          if(data.respuesta==true){
            ...
            for(i in data.shared){
              ...
              $tablecuentas2.row.add([
                icons+cont+'<br><b>'+data.shared[i].fecha+'</b>',
