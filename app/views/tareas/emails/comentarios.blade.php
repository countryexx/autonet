                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;"><b>{{$usuario}}</b> ha comentado la tarea <b>{{$nombre_tarea}}</b>. </span>

                                <br><br>
                                <span style="font-size: 15px; float: left;" slot="start"><b id="valor">Comentario: </b> {{$comenta}}</span>

                                <br><br>

                                <a href="{{url('tareas/task/'.$id)}}">Ver tarea</a>
