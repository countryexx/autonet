                ...
                <tr>
                  <td style="padding: 0 20px;">
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      ...
                      <img class="align-sm-right" style="width: 50px; height: 70; margin-top: 15px; margin-bottom: 25px; float: right;" src="{{url('img/task.png')}}">
                      <br><br>
                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;"><b>SAMUEL GONZALEZ MENDOZA</b> te ha añadido como participante en su tarea <b>SUBIDA DE RUTAS</b>. </span>

                                <!-- Desde Hasta -->

                                <br><br>

                                <a href="{{url('')}}">Ver tarea</a>
