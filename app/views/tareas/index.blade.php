...
<html>
  <head>
    ...
    <title>Autonet | Tareas Diarias</title>
                ...
                <div class="card" id="list1" style="border-radius: .75rem; background-color: #eff1f2;">
                  <div class="card-body py-4 px-4 px-md-5">
                    ...
                    <p class="h3 text-center mt-3 mb-4 pb-3 text-primary">
                      ...
                      <u>Mis Tareas <i class="fa fa-plus tarea_hoy" aria-hidden="true"></i></u>
                    </p>

                    <!--<center>
                      <span style="margin-top: 20px; margin-left: 20px; font-size: 22px; text-align: center" class="h3 text-center mt-3 mb-4 pb-3">Asignar a otro usuario <i class="fa fa-plus add_task" aria-hidden="true"></i></span>
                    </center>-->

                    <!--<button style="margin-bottom: 7px; margin-left: 15px" type="button;" class="btn btn-default btn-icon auth">AUTH<i class="fa fa-plus icon-btn"></i>
                    </button>-->
                      ...
                      <tbody>
                        ...
                        @foreach($actividades as $actividad)
                          <tr>
                            ...
                            <th> <center><b>{{$actividad->fecha}}</b></center> </th>
                            <th>
              ...
              <div class="col">
                <div class="card" id="list1" style="border-radius: .75rem; background-color: #eff1f2;">
                  <div class="card-body py-4 px-4 px-md-5">
                    ...
                    <table id="example_table2" class="table table-bordered hover tabla" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <td class="h3 text-left mt-3 mb-4 pb-3" style="text-align: center;">#</td>
                          <td class="h3 text-left mt-3 mb-4 pb-3" style="text-align: center;">Fecha</td>
                          <td class="h3 text-left mt-3 mb-4 pb-3" style="text-align: center;">Nombre</td>
                          <td class="h3 text-left mt-3 mb-4 pb-3" style="text-align: center;">Opciones</td>
                          <td class="h3 text-left mt-3 mb-4 pb-3" style="text-align: center;">Estados</td>
                        </tr>
                      </thead>
                      <tbody>
                        <?php $o = 1; ?>
                        @foreach($shared as $actividad)
                          <tr>
                            <th>
                              <center>
                                <b>{{$o}} </b>
...
<!--
    <div class="row">
      <div class="col-lg-4">
        <div>
          <span style="margin-top: 20px; font-size: 22px; text-align: center">Asignación de Tareas <i class="fa fa-plus add_task" aria-hidden="true"></i></span>

          <br><br><button style="margin-bottom: 7px; " type="button;" class="btn btn-default btn-icon" data-toggle="modal" data-target=".mymodal">
            AGREGAR<i class="fa fa-plus icon-btn"></i>
        </button>


          <hr>
          <span style="margin-top: 20px; font-size: 22px;">Mis Tareas de Hoy</span>
          <br><br>
          <ul id="myUL">
            @foreach($actividades as $actividad)
                ...
                ?>
                  ...
                  @if($actividad->implicados!=null)
                    <?php
                      ...
                      for ($i=0; $i < count(json_decode($actividad->implicados)); $i++) {
                        $variable .= DB::table('empleados')->where('id',json_decode($actividad->implicados)[$i])->pluck('nombres'). ' '.DB::table('empleados')->where('id',json_decode($actividad->implicados)[$i])->pluck('apellidos'). ' | ';
                        //echo json_decode($actividad->implicados[$i]);
                      }

                    ?>

                    <button title="{{ $variable }}" data-option="1" id="compartido_con" class="btn btn-default dropdown-toggle btn-icon compartido_con" data-toggle="dropdown" style="float: right;">{{ count(json_decode($actividad->implicados)) }}<i class="fa fa-bars icon-btn"></i></button>

                    <ul class="dropdown-menu dropdown-menu-right">
                      <li>
                        <a href="">Compartir Tarea <i class="fa fa-share" aria-hidden="true"></i></a>
                      </li>
                      <li>
                        <a class="bloqueo_vehiculos" href="#" data-toggle="modal" data-target="#open_modal_bloqueo_vehiculos" data-vehiculo-id="">Adjuntar Soporte <i class="fa fa-paperclip" aria-hidden="true"></i></a>
                      </li>
                      <li>
                        <a href="{{url('tareas/task/'.$actividad->id)}}">Ver Tarea <i class="fa fa-comment" aria-hidden="true"></i></a>
                      </li>
                      <li><a data-vehiculo-id="" href="#" class="archivar">Cerrar Tarea <i class="fa fa-check" aria-hidden="true"></i></a></li>
                    </ul>

                  @endif

                  <i style="color: <?php echo $color?>; float: right; margin-right: 25px" class="fa fa-paperclip {{$clase}}" aria-hidden="true"></i> 
        ...
        <div class="container">
          ...
          <div class="calendar-base">
            ...
            <div class="months">
              ...
              <span class="month-hover">Abr</span>
            ...
            <div class="num-dates">
              ...
              <div class="first-week"><span class="grey">26 27 28 </span>01 02 03 04</div>
              
              <div class="second-week">05 06 07 08 09 10 11</div>
              
              <div class="second-week">12 13 14 15 16 17 18</div>
              <div class="second-week">19 20 21 22 23 24 25</div>
              <div class="second-week">05 06 07 08 09 10 11</div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id='modal_tarea_hoy' data-backdrop="false">
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" style="text-align: center;" id="name"><b id="title" class="parpadea h4 text-center mt-3 mb-4 pb-3">Nueva Tarea <i class="fa fa-plus" aria-hidden="true"></i></b></h4>
            </div>
            <div class="modal-body">
              <center>

                <div class="row" style="width: 90%">
                  <input class="form-control input-font detalle_text h4 text-left mt-3 mb-4 pb-3" placeholder="Ingresa el nombre" id="nombre_actividad" autocomplete="off"></input>
                ...
                <div class="row" style="width: 50%; margin-top: 12px;">
                ...
                <div class="row" style="width: 90%; margin-top: 12px;">
                  ...
                  <a style="width: 80%;" data-dismiss="modal" class="btn btn-danger h4 text-center mt-3 mb-4 pb-3">CERRAR <i class="fa fa-times" aria-hidden="true"></i></a>
            ...
            <div class="modal-footer">
              <center>
                <span class="h5 text-center mt-3 mb-4 pb-3" style="color: red"><b>Nota:</b> Si necesitas adjuntar algún soporte, lo puedes hacer en la vista individual de la tarea.</span>
              </center>
            </div>
        </div>
      </div>
      ...
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-8 col-lg-push-2">
                    ...
                    <select style="width: 50%; padding: 10%" data-option="1" name="proveedores" id="participantes3" class="form-control input-font selectpicker" multiple data-live-search="true" >
                      @foreach($users as $user)
                        <option value="{{$user->id}}">{{$user->nombres. ' '.$user->apellidos}}</option>
                      @endforeach
                    </select>
            ...
            <div class="modal-footer">
              ...
              <center>
                <a id="guardar_share" style="margin-right: 6px; margin-left: 20px" class="btn btn-primary btn-icon h6 text-center mt-3 mb-4 pb-3">COMPARTIR<i class="fa fa-share icon-btn"></i></a>
              </center>
    ...
    <script type="text/javascript">
      ...
      $('.buscar_fecha').click(function(){
        ...
        $.ajax({
          url: 'tareas/filtrardia',
          method: 'post',
          data: {fecha: fecha, fecha2: fecha2, opcion: opcion}
        }).done(function(data){
          ...
          if(data.respuesta==true){
            ...
            for(i in data.shared){
              ...
              botones += '<a href="https://app.aotour.com.co/autonet/tareas/task/'+data.shared[i].id+'" target="_blank" style="padding: 6px 8px 6px 8px; display: inline-block; margin-right: 5px" type="button" class="btn btn-default btn-list-table" aria-haspopup="true" title="Ver Tarea" aria-expanded="true"><i class="fa fa-eye ver_tarea" aria-hidden="true" style="font-size: 16px;"></i></a>';
              ...
              if(data.shared[i].estado!=1){
                ...
                botones += '<a data-id="'+data.shared[i].id+'" style="padding: 6px 8px 6px 8px; display: inline-block" type="button" class="btn btn-info btn-list-table activar_tarea" title="Reactivar Tarea" aria-haspopup="true" aria-expanded="true"><i class="fa fa-repeat" aria-hidden="true" style="font-size: 16px;"></i></a>';
              ...
              $tablecuentas2.row.add([
                '<center><b>'+cont+' <b>'+icons+'</center>',
                '<center><b>'+data.shared[i].fecha+'</b></center>',
              ...
              fecha_anterior = data.shared[i].fecha;
                  ...
                  confirm: {
                      ...
                      action: function(){
                        ...
                        $.ajax({
                          ...
                          method: 'post',
                          data: {nombre: nombre, users: users, descripcionTarea: descripcionTarea, cantidad: 1}
                        }).done(function(data){
    ...
    $('#example_table2').on('click', '.activar_tarea', function(event) {
    ...
    $('#example_table2').on('click', '.cerrar_tarea', function(event) {
