...
<head>
    <meta charset="UTF-8">
    <title>Autonet | Reportes Mensuales</title>
...
<div >
  ...
  @if(1>0)
  <div class="app-content" style="width: 100%; margin-bottom: 100px">
    <div class="app-content-header" >
      <div class="row" style="margin-bottom: 20px">
        <div class="col-lg-2">
          <div class="product-cell status-cell" style="margin-top: 15px; margin-left: 10px">
            <span style="width: 175px; background: #f47321; font-size: 15 px" class="status inactive" id="seen">Reportes Mensuales</span>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="product-cell status-cell" style="margin-top: 15px; margin-left: 10px;">
    ...
    <div class="app-content-actions" style="margin-top: -120px;">
      ...
      <div class="app-content-actions-wrapper" style="height: 100%">
        <div class="filter-button-wrapper" style="height: 100%">
          ...
          <!--<div class="filter-menu menus">
              <label style="color: white">Ciudad</label>
              <select style="float: right; width: 50%" id="city">
                <option>Seleccionar</option>
                <option>Bogotá</option>
                <option>Barranquilla</option>
              </select>
              <br>
              <label style="color: white" class="ano hidden">Año</label>
              <select class="ano hidden" style="float: right; width: 50%" id="anos">
                <option @if($ano==2022){{'selected'}}@endif>2022</option>
                <option @if($ano==2023){{'selected'}}@endif>2023</option>
                <option @if($ano==2024){{'selected'}}@endif>2024</option>
                <option @if($ano==2025){{'selected'}}@endif>2025</option>
              ...
              <br>
              <label style="color: white" class="mes hidden">Mes</label>
              <select class="mes hidden" style="float: right; width: 50%" id="meses">
              ...
              <div class="filter-menu-buttons">
                <button class="filter-button apply" style="width: 100%">
                  Aplicar
                </button>
              </div>
            </div>-->
    ...
    <div class="products-area-wrapper tableView" style="margin-bottom: 100px">
      <div class="products-header">
        <div class="product-cell image">Mes Reportado</div>
        <div class="product-cell category">Costo Total</div>
          <div class="product-cell sales">Enviado por</div>

        <div class="product-cell stock">Ciudad</div>
        <div class="product-cell price">Ver</div>
      </div>
      @foreach($reportes as $reporte)
        <div class="products-row" style="border: 1px solid #DAD9D9;">

            <div class="product-cell image">
              <span style="color: black">{{$reporte->mes}}</span>
            </div>
          <div class="product-cell category"><span class="cell-label">Category:</span><span style="color: black">$ {{number_format($reporte->costo_total)}}</span></div>

          <!--<div class="product-cell category"><span class="cell-label">Category:</span><span style="color: black">$ {{number_format($reporte->costos_no_transportado)}}</span></div>-->

          <div class="product-cell sales"><span class="cell-label">Sales:</span><span style="color: black">{{$reporte->first_name.' '.$reporte->last_name}}</span></div>
          <div class="product-cell stock"><span class="cell-label">Stock:</span><span style="color: black">
            @if($reporte->cliente==287)
              {{'BOGOTÁ'}}
            @else
              {{'BARRANQUILLA'}}
            @endif
          ...
          <div class="product-cell price"><span class="cell-label">Price:</span><span style="color: black"></span>
              ...
              <a target="_blank" href="{{url('reportes/dash/'.$reporte->id)}}" type="submit" class="btn btn-primary btn-icon input-font">Ver Reporte<i class="fa fa-share icon-btn"></i></a>
      ...
      $.ajax({
        ...
        if(data.respuesta=='sesion_caducada'){
          ...
          for(var i in data.reportes) {
            ...
            if(data.reportes[i].cliente==287){
              var ciudad = 'BOGOTÁ';
            }else{
            ...
            htmlCode +='<div class="products-row" style="border: 1px solid #DAD9D9;">'+
                '<div class="product-cell image">'+
                  '<span style="color: black">'+data.reportes[i].mes+'</span>'+
                '</div>'+
              '<div class="product-cell category"><span class="cell-label">Category:</span><span style="color: black">$ '+number_format(data.reportes[i].costo_total)+'</span></div>'+
              //'<div class="product-cell category"><span class="cell-label">Category:</span><span style="color: black">$ '+number_format(data.reportes[i].costos_no_transportado)+'</span></div>'+
              ...
              '<div class="product-cell stock"><span class="cell-label">Stock:</span><span style="color: black">'+ciudad+'</span></div>'+
              ...
              '<div class="product-cell price"><span class="cell-label">Price:</span><span style="color: black"></span>'+
                '<form class="form-inline" id="form_buscar" action="https://app.aotour.com.co/autonet/portalusu/exportarlistadonovedades" method="post">'+
                  ...
                  '<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 hidden">'+
                      ...
                      '</div>'+
                  '</div>'+
                  '<a target="_blank" href="https://app.aotour.com.co/autonet/reportes/dash/'+data.reportes[i].id+'" type="submit" class="btn btn-primary btn-icon input-font">Ver Reporte<i class="fa fa-share icon-btn"></i></a>'+
                '</form>'+
              '</div>'+
            '</div>';
