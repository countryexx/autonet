  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
              ...
              <div role="tabpanel" class="edicion tab-pane fade in active" id="programacion_tab">
                  <div class="row" style="margin-top: 15px">
                      <div class="col-xs-12">
                          ...
                          <div class="col-xs-3">
                              <label for="email_solicitante">Email para el link GPS</label>
                              <input id="email_solicitante" name="email_solicitante" type="text" class="form-control input-font">
                          </div>  
                          <div class="col-xs-4">
                              <label for="site">SITE</label>
                              <input id="site" name="site" type="text" class="form-control input-font" disabled="true">
                          </div>                          
                      </div>
                  </div>
              </div>
                      ...
                      <div class="col-xs-12">
                          ...
                          <div class="col-xs-12 unico">
                              <div class="row">
                                  ...
                                  <div class="col-xs-3">
                                      <label class="obligatorio" for="notificacion">Enviar Email a los pasajeros</label>
                                  ...
                                  <div class="col-xs-12">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-xs-2">
                                              ...
                                              <input type="text" class="form-control input-font" id="destino" name="destino">
                                          </div>
                                          <div class="col-xs-2">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-multiple="0" id="programar_servicio">GUARDAR</button>
      </div>
    </div>
  </div>
</div>
