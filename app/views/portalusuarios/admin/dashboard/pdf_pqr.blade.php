...
<html>
  ...
  <div class="container">
      ...
      <table border="1" cellspacing="1" width="100%">
        <tr>
          <td rowspan="3" style="text-align: center" align="center">
            <img src="biblioteca_imagenes/logo_excel.png" width="120px" height="60px">
          </td>
        ...
        <tr>
          <td colspan="12"  style="text-align: center;" align="center"><b>Consecutivo N° {{$data}}</b></td>
        </tr>
    ...
    <!-- INICIO TABLA 1 -->
      ...
      <table border="1" cellspacing="1" width="100%">
        ...
        <tr>          
          ...
          <td colspan="2" style="text-align: center;">{{$tiposolicitud}}</td>          
        </tr>
    ...
    <table border="1" cellspacing="1" width="100%">
      ...
      <tr><td colspan="8" style="text-align: left" align="center"><b>NÚMERO DE REFERENCIA DEL SERVICIO / PRODUCTO (Si lo conoce):</b> {{$id_servicio}}</td></tr>
      ...
      @elseif($tipo_servicio==='CORPORATIVO')
        <tr>        
          <td colspan="1"><b>SERVICIO CORPORATIVO</b></td>
          <td colspan="1" style="text-align: center;">X</td>  
          <td colspan="1"><b>SERVICIO EJECUTIVO</b></td>
