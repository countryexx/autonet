  ...
  <div class="container-fluid">
    ...
    <div class="row hidden" style="margin-top: 60px">
      <div class="col-lg-4 col-lg-offset-4">
        ...
        <div class="panel-heading" style="text-align: center; background: #CAC5C5"><p style="font-size: 25px">OBTENER INFORMACIÓN DASHBOARD</p></div>
        <div class="panel-body" style="padding: 1%">    
            <p>Por favor, selecciona la FECHA INICIAL y FECHA FINAL de la información que desea consultar.</p> 
            <div class="row">
              <form id="form" action="{{url('dashboard/obtenerdatos')}}" method="post">
              <div class="col-xs-4">
              ...
              <div class="col-xs-2">
                <label class="obligatorio" for="subcentrodecosto_ex_excel"></label>
                <button type="submit" id="consultar" class="btn btn-success btn-icon">OBTENER DATOS<i class="fa fa-search icon-btn"></i></button>
              </div>
              </form>
            </div>                           
        </div>
