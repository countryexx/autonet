...
<html lang="en">
  <head>
    ...
    <title>Autonet | Servicios por Programar</title>
  ...
  <body>
    ...
    @include('portalusuarios.admin.modales.programar_servicio')
    ...
    <script src="{{url('jquery/servicios_administrador.js')}}"></script>
