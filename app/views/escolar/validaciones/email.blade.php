                  ...
                  <td style="padding: 0 20px;">
                    <!--<table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      ...
                      <tr>
                        ...
                        <td style="width: 35%;">
                          <p style="color: #929292; text-align:left">
                            <b style="color: #f47321;">Estado / Status:</b> <br> Programado
                          </p>
                        </td>
                    ...
                    <div style="margin-top: 30px; margin-bottom: 30px; border: white 6px solid; ">
                      ...
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:center;">
                            ...
                            @else
                              <b style="color: #f47321;">Conductor / Driver:</b> <br> {{$conductor->nombre_completo}} <br> <a style="color: #f47321;" href="tel:{{$conductor->celular}}">TEL: {{$conductor->celular}}</a>
                            @endif
                          </p>
                        ...
                        <td class="col" style="padding: 0 10px;">
                          @if($conductor->id===92 or $conductor->id===357 or $conductor->id===628)
                            <img style="background-color: white; height: 150px; margin-top: 15px; width: 170px; box-shadow: 1px 2px 2px 0px rgb(38, 113, 41); margin-bottom: 45px;" src="{{url('https://app.aotour.com.co/autonet/biblioteca_imagenes/working.png')}}">
                          @elseif($conductor->foto_app===null)
                            <img class="align-sm-left" style="background-color: white; height: 150px; margin-top: 15px; width: 170px; box-shadow: 0px 0px 0px 0px orange; margin-bottom: 45px;" src="{{url('https://app.aotour.com.co/autonet/biblioteca_imagenes/person.jpg')}}">
                          @else
                            <img class="align-sm-left" style="background-color: white; height: 150px; margin-top: 15px; width: 170px; box-shadow: 0px 0px 0px 0px orange; margin-bottom: 45px;" src="{{url('https://app.aotour.com.co/autonet/biblioteca_imagenes/proveedores/conductores/'.$conductor->foto_app.'')}}">
                          @endif
                        </td>
                      </tr>
