                      ...
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          ...
                          <img class="align-sm-left" style="width: 150px; margin-top: 15px; margin-bottom: 15px" src="{{url('img/logo_aotour.png')}}"><br><br><br>
                            ...
                            <h3 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Terminación de Contrato </h3><br><br><br>
                          </td>
                        </tr>
                          <tr>
                            <td class="col" style="padding: 0 10px;">
                            <p style="color: #929292; text-align:left">
                              Lamentamos los inconvenientes presentados durante la prestación del servicio de ruta Escolar.
                              <br><br>
                              Adjuntamos carta.
                            </p>
                          </td>
                          ...
                          <tr>
                            <td class="col" style="padding: 0 10px;">
                              ...
                              <p style="color: #929292; text-align:left">
                              © Copyright 2022 Aotour, SAS. Todos los derechos reservados.
                            </p>
                          </td>
                          </tr>
                    </table>
