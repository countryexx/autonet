            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <!-- -->
                @if(isset($permisos->portalusuarios->gestiondocumental->ver))
                  @if($permisos->portalusuarios->gestiondocumental->ver==='on' and (Sentry::getUser()->centrodecosto_id!=329 and Sentry::getUser()->centrodecosto_id!=343))
                    <!--<li class="dropdown">
              ...
              @if(isset($permisos->portalusuarios->admin->ver))
                @if($permisos->portalusuarios->admin->ver==='on' and (Sentry::getUser()->centrodecosto_id!=329 and Sentry::getUser()->centrodecosto_id!=343))
                  <!--<li class="dropdown">
              ...
              <!-- -->
                ...
                @if(isset($permisos->portalusuarios->admin->ver))
                  @if($permisos->portalusuarios->admin->ver==='on' and (Sentry::getUser()->centrodecosto_id!=329 and Sentry::getUser()->centrodecosto_id!=343 and Sentry::getUser()->centrodecosto_id!=489 and Sentry::getUser()->centrodecosto_id!=97))
                    <li class="dropdown">
                ...
                <!-- IGT -->
                @if(isset($permisos->portalusuarios->admin->ver))
                  @if($permisos->portalusuarios->admin->ver==='on' and Sentry::getUser()->centrodecosto_id==489 )
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Novedades <i class="fa fa-exclamation-triangle"></i><span class="caret"></span></a>
                      <ul class="dropdown-menu">
                        <li>
                          <a class="dropdown-toggle" href="{{url('reportes/listanovs')}}" >Novedades de Rutas <i class="fa fa-users" aria-hidden="true"></i></a>
                        </li>
                        <li>
                          <a class="dropdown-toggle" href="{{url('reportes/dashboard')}}" >Dashboard <i class="fa fa-bar-chart" aria-hidden="true"></i></a>
                        </li>
                      </ul>
                    </li>
                  @endif
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        @if(isset($permisos->portalusuarios->ejecutivo->ver))
                          @if($permisos->portalusuarios->ejecutivo->ver==='on' and (Sentry::getUser()->centrodecosto_id===329 || Sentry::getUser()->centrodecosto_id===343 || Sentry::getUser()->centrodecosto_id===489 || Sentry::getUser()->centrodecosto_id===287 || Sentry::getUser()->centrodecosto_id===19 || Sentry::getUser()->centrodecosto_id===97))
                              <li>
                        ...
                        @endif
                          ...
                          @if( Sentry::getUser()->centrodecosto_id = 489 )
                              ...
                              <li >
                                <a class="dropdown-toggle" href="{{url('reportes/subidaderutas')}}" >Subida de Rutas <i class="fa fa-tasks" aria-hidden="true"></i></a>
                              </li>
                            
                          @endif

                            @if( ($permisos->portalusuarios->admin->ver==='on' or $permisos->portalusuarios->bancos->ver==='on') and (Sentry::getUser()->centrodecosto_id!=329 and Sentry::getUser()->centrodecosto_id!=343 and Sentry::getUser()->centrodecosto_id!=489 and Sentry::getUser()->centrodecosto_id!=287 and Sentry::getUser()->centrodecosto_id!=19 and Sentry::getUser()->centrodecosto_id!=97))
                              <li >
                                <a class="dropdown-toggle" href="{{url('serviciosadmin')}}" >Servicios Ejecutivos <i class="fa fa-car" aria-hidden="true"></i></a>
                              </li>
                            @endif

                          @if($permisos->portalusuarios->admin->ver==='on' and (Sentry::getUser()->centrodecosto_id!=329 and Sentry::getUser()->centrodecosto_id!=343 and Sentry::getUser()->centrodecosto_id!=489 and Sentry::getUser()->centrodecosto_id!=287 and Sentry::getUser()->centrodecosto_id!=19 and Sentry::getUser()->centrodecosto_id!=97))
                            <li>
              ...
              @if(isset($permisos->barranquilla->transportesbq->ver) or isset($permisos->bogota->transportes->ver) or isset($permisos->otrostransporte->otrostransportes->ver))
                  <li class="dropdown">
                    ...
                    @if(isset($permisos->barranquilla->ejecutivosbq->ver) or isset($permisos->bogota->ejecutivos->ver))
                      <!-- INCLUIR ROL -->
                      @include('servicios.servicios_ejecutivos.pusher_solicitud_servicios')
                      ...
                      @if(isset($permisos->bogota->ejecutivos->ver))
                        @if($permisos->bogota->ejecutivos->ver==='on')
                          ...
                          <?php
                            ...
                            $sin_programar_bog = ServicioA::whereNull('estado_programado')->where('localidad','bogota')->count();
                        ...
                        @if(isset($permisos->barranquilla->transportesbq->ver))
                          ...
                          <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{url('reportes/disponibilidadbarranquilla')}}">Col Disponibles <i class="fa fa-list-alt" aria-hidden="true"></i></a></li>

                                <li><a href="{{url('reportes/disponibilidadvehiculosbarranquilla')}}">Veh Disponibles <i class="fa fa-list-alt" aria-hidden="true"></i></a></li>
                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown-submenu">
                                      ...
                                      <ul class="dropdown-menu">
                                        ...
                                        <li style="background-color: #E1DDDC"><a href="{{url('reportes/rutasporprogramar')}}">Rutas Nuevo <i class="fa fa-bus" aria-hidden="true"></i></a></li>
                                        ...
                                        <li><a href="{{url('reportes/disponibilidadbogota')}}">Col Disponibles <i class="fa fa-list-alt" aria-hidden="true"></i></a></li>

                                        <li><a href="{{url('reportes/disponibilidadvehiculosbogota')}}">Veh Disponibles <i class="fa fa-list-alt" aria-hidden="true"></i></a></li>
              ...
              @if(isset($permisos->contabilidad->pago_proveedores->ver) or isset($permisos->contabilidad->comisiones->ver))
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Contabilidad <i class="fa fa-usd"></i>
                  @if(Sentry::getUser()->id===2 or Sentry::getUser()->id===37 or Sentry::getUser()->id===170)
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                                ...
                                @if($permisos->administrativo->proveedores->ver==='on')
                                    <li class="dropdown-submenu">
                                      ...
                                      <ul class="dropdown-menu">
                                          ...
                                          @if(Sentry::getUser()->id===2 or Sentry::getUser()->id===4086 or Sentry::getUser()->id===508 or Sentry::getUser()->id===3801)
                            ...
                            @if(isset($permisos->administrativo->ciudades->ver))
                                @if($permisos->administrativo->ciudades->ver==='on' or Sentry::getUser()->id_rol==28)
                            ...
                            @if(isset($permisos->administrativo->ciudades->ver))
                                @if($permisos->administrativo->ciudades->ver==='on' or Sentry::getUser()->id_rol==17)
              ...
              @if(isset($permisos->administracion->usuarios->ver) or isset($permisos->administracion->clientes_particulares->ver) or isset($permisos->administracion->clientes_empresariales->ver) or isset($permisos->administracion->importar_pasajeros->ver) or isset($permisos->administracion->listado_pasajeros->ver) or Sentry::getUser()->id_empleado!=null)
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <!-- new tareas -->
                      @if( Sentry::getUser()->id_empleado!=null )
                      <li class="dropdown-submenu">
                        <a class="dropdown-toggle" data-toggle="dropdown">Tareas Usuarios <span style='font-size:15px;'>&#128240;</span></a>
                        <ul class="dropdown-menu">

                            <li><a target="_blank" href="https://www.upnetweb.com/main/tareas/gestion">Tareas UPNET <i class="fa fa-sign-out" aria-hidden="true"></i></a></li>

                            <li><a href="{{url('tareas')}}">Mis Tareas <i class="fa fa-tasks" aria-hidden="true"></i></a></li>

                            <li><a href="{{url('tareas/asignadas')}}">Tareas Asignadas <i class="fa fa-share-square-o"></i></a></li>

                            @if(Sentry::getUser()->id == 12 or Sentry::getUser()->id == 3801 or Sentry::getUser()->id == 2)
              ...
              @if(isset($permisos->mobile->servicios_programados_sintarifa->ver) or isset($permisos->mobile->servicios_programados_tarifado->ver) or
                ...
                <?php
                  ...
                  $empresarial = Servicioaplicacion::whereRaw('(empresarial = 1)')
