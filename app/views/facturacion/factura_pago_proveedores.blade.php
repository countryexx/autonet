...
<body>
	...
	<div class="col-lg-12">
		<h3 class="h_titulo">FACTURA PROVEEDORES - {{$lote->nombre. ' - ' .$lote->fecha}}</h3>
		<div class="col-lg-12">
    <div class="row">
        ...
        <a style="margin-top: 10px; margin-bottom:10px" class="btn btn-primary btn-icon input-font" onclick="goBack()">Volver<i class="fa fa-reply icon-btn"></i></a>
				<a class="btn btn-danger btn-icon input-font" href="{{url('facturacion/facturapagoproveedoresold/'.$lote->id)}}">Ver Pagos <i class="fa fa-eye icon-btn"></i></a>
		        ...
		        <div class="col-lg-12" style="margin-bottom: 5px">
		            <div class="row">
		                ...
		                <button type="submit" title="Exportar información de pago a Proveedores" class="btn btn-success btn-icon input-font" @if($lote->valor<1){{'disabled'}}@endif>EXCEL<i class="fa fa-file-excel-o icon-btn"></i></button>
		            </div>
		        </div>
		    </form>
	                ...
	                <div class="form-group">
	                    <div class="input-group" id="datetime_fecha">
	                        <div class='input-group date' id='datetimepicker10'>
	                            <input id="fecha_pago" name="fecha_pago" style="width: 100px;" type='text' class="form-control input-font" placeholder="FECHA DE PAGO" value="{{$lote->fecha}}">
							...
							<tr class="guardar_pago">
						    	...
						    	<td>
									@if($permisos->contabilidad->factura_proveedores->cerrar_pago==='on')
									    <a id="guardar_pago" data-lote="{{$lote->id}}" class="btn btn-default btn-icon">GUARDAR<i class="icon-btn fa fa-save"></i></a>
									@else
