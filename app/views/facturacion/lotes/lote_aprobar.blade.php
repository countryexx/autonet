...
<head>
	...
	<title>Autonet | Lote Pagos por Aprobar</title>
...
<body>
	...
	<div class="col-lg-12">
		<h3 class="h_titulo">Lotes por Aprobar</h3>
        ...
        <tbody>
          @foreach($lotes as $lote)
            <tr>
              ...
              <td>
                <a href="{{url('facturacion/listadopagosporaprobar/'.$lote->id)}}" style="padding: 6px 8px 6px 8px; display: inline-block" type="button" class="btn btn-primary btn-list-table" aria-haspopup="true" title="Ver el Lote" aria-expanded="true"><i class="fa fa-share" aria-hidden="true" style="font-size: 16px;"></i></a>
