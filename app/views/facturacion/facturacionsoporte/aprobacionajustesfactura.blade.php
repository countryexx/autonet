...
<head>
    ...
    <title>Autonet | Aprobacion ajuste Facturacion</title>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-12">
      <h3>Aprobacion de ajustes facturacion</h3>
            ...
            <tbody>
                ...
                @foreach ($facturacion as $factura)
                  <tr data-pago-id="{{$factura->id}}" onClick="selODessel(this)">
                    ...
                    <td>
                      <button aprobar-pago-id="{{$factura->id}}" class="btn btn-success buscar_servicio">Aprobar</button> 

                      <button rechazar-pago-id="{{$factura->id}}" class="btn btn-warning buscar_servicio">Rechazar</button>
                    </td>
                  </tr>
                  <?php $i++; ?>
                @endforeach
