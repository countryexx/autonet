...
<div class="col-xs-12">
    ...
    @if(isset($permisos->administrativo->proveedores->crear))
        @if($permisos->administrativo->proveedores->crear==='on')
            <button type="button" disabled class="btn btn-default btn-icon disabled" data-toggle="modal" data-target=".mymodal">Agregar<i class="fa fa-plus icon-btn"></i></button>
        @else
