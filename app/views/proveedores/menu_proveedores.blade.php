<ol style="margin-bottom: 10px" class="breadcrumb">
    ...
    @if(isset($permisos->administrativo->seguridad_social->ver))
        ...
        @endif
    @endif
    @if(Sentry::getUser()->id_rol==2 or Sentry::getUser()->id_rol==1 or Sentry::getUser()->id_rol==25 or Sentry::getUser()->id_rol==46 or Sentry::getUser()->id_rol==5 or Sentry::getUser()->id_rol==52)
