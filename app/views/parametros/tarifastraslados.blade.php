<html>
<head>
	<title>Autonet | Tarifas Traslados</title>
...
<h3 class="h_titulo">TARIFAS TRASLADOS GENERALES</h3>
        ...
        <table id="example" class="table table-striped table-bordered hover" cellspacing="0" width="100%">
            ...
            @foreach($ruta_general as $ruta)
                <tr>
                    ...
                    <td>{{$ruta->tarifa_ciudad}}</td>
					<td>{{$ruta->tarifa_nombre}}</td>
        ...
        <form id="formulario">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-6">
                            <label class="obligatorio" for="nuevo_departamento">Tipo de Servicio</label>
                            <input class="form-control" type="text" id="nombre">
                        </div>
						<div class="col-xs-2">
                            <label class="obligatorio" for="ciudad_new">Ciudad</label>
                        ...
                        <div class="col-xs-12">
                            ...
                            <fieldset style="margin-top: 10px; margin-bottom: 5px;"><legend>Tarifas Aviatur</legend>
                               <div class="row">
                                    <div class="col-xs-2">
                                        <label class="obligatorio" for="automovil_cliente">Automovil cliente</label>
                                        <input class="form-control" type="text" id="automovil_cliente_aviatur">
                                    </div>
									<div class="col-xs-2">
                                        <label class="obligatorio" for="minivan_cliente">Minivan cliente</label>
                                        <input class="form-control" type="text" id="minivan_cliente_aviatur">
                                    </div>
									<div class="col-xs-2">
                                        <label class="obligatorio" for="van_cliente">Van cliente</label>
                                        <input class="form-control" type="text" id="van_cliente_aviatur">
                                    </div>
                                    
                                     <div class="col-xs-2">
                                        <label class="obligatorio" for="bus_cliente">Bus cliente</label>
                                        <input class="form-control" type="text" id="bus_cliente_aviatur">
                                    </div>
									<div class="col-xs-2">
                                        <label class="obligatorio" for="buseta_cliente">Buseta cliente</label>
                                        <input class="form-control" type="text" id="buseta_cliente_aviatur">
                                    </div>
								</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
						...
						<div class="col-xs-2">
                            <label class="obligatorio" for="ciudad_editar">Ciudad</label>
                            
							<select class="form-control input-font" id="ciudad_editar">
								@foreach($ciudades as $ciudad)
									<option>{{$ciudad->ciudad}}</option>
								@endforeach
							</select>
                        ...
                        <div class="col-xs-12">
                            ...
                            <fieldset style="margin-top: 10px; margin-bottom: 5px;"><legend>Tarifas Aviatur</legend>
                                <div class="row">
                                    <div class="col-xs-2">
                                        <label class="obligatorio" for="automovil_cliente_editar">Automovil cliente</label>
                                        <input class="form-control" type="text" id="automovil_cliente_editar_aviatur">
                                    </div>
									<div class="col-xs-2">
                                        <label class="obligatorio" for="minivan_cliente_editar">Minivan cliente</label>
                                        <input class="form-control" type="text" id="minivan_cliente_editar_aviatur">
                                    </div>
									<div class="col-xs-2">
                                        <label class="obligatorio" for="van_cliente_editar">Van cliente</label>
                                        <input class="form-control" type="text" id="van_cliente_editar_aviatur">
                                    </div>
                                    <div class="col-xs-2">
                                        <label class="obligatorio" for="bus_cliente_editar">Bus cliente</label>
                                        <input class="form-control" type="text" id="bus_cliente_editar_aviatur">
                                    </div>
                                    <div class="col-xs-2">
                                        <label class="obligatorio" for="buseta_cliente_editar">Buseta cliente</label>
                                        <input class="form-control" type="text" id="buseta_cliente_editar_aviatur">
                                    </div>
