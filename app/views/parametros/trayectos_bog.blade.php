<html>
<head>
	<title>Autonet | Traslados Bogotá</title>
...
<h3 class="h_titulo">LISTADO DE TRAYECTOS - CLIENTES BOG</h3>
                    ...
                    <th style="text-align: center;">
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" style="width: 400px;">
                            ...
                            @endforeach
                                <li class="dropdown-item" type="button"><a href="{{url('tarifastraslados/trayectosaotourbog')}}">Ver Listado <i class="fa fa-share" aria-hidden="true"></i></a></li>
                          </div>
                        </div>
                        TARIFA AOTOUR
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        @else
                            ...
                            N/A<a title="Actualizar Tarifa - Cliente" id="" style="padding: 2px 3px; float: right;" data-nombre="{{$ruta->nombre}}" data-trayecto="{{$ruta->id}}" data-centro="292" data-razonsocial="AUTO OCASIONAL TOUR" class="btn btn-info añadir_tarifas"><i class="fa fa-plus"></i></a>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <fieldset style="margin-top: 10px; margin-bottom: 5px;"><legend class="title_tarifa">Tarifa</legend>
                            <div class="row">
                                <div class="col-xs-2">
                                    <label class="obligatorio" for="automovil_cliente_editar">Tarifa Cliente <b>AUTO</b></label>
                                    <input class="form-control" type="number" id="cliente_auto3">
                                </div>
                                <div class="col-xs-2">
                                    <label class="obligatorio" for="automovil_cliente_editar">Tarifa Cliente <b>VAN</b></label>
                                    <input class="form-control" type="number" id="cliente_van">
                                </div>
                                <div class="col-xs-3">
                                    <label class="obligatorio" for="automovil_cliente_editar">Tarifa Proveedor <b>AUTO</b></label>
                                    <input class="form-control" type="number" id="proveedor_auto3">
                                    <p style="color: red" class="subtitle">Valor tarifa</p>
                                </div>
                                <div class="col-xs-3">
                                    <label class="obligatorio" for="automovil_cliente_editar">Tarifa Proveedor <b>VAN</b></label>
...
<script type="text/javascript">
        ...
        if( $('#cliente_auto2').val() < $(this).attr('data-actual') ){
            ...
            if(sw==1){
                ...
                $.ajax({
                  url: '../tarifastraslados/actualizartarifaindividual',
                  method: 'post',
                  data: {id: id, valor: values, valuev: valuev}
                }).done(function(data){
    ...
    $('#añadir_tarifas').click(function(e) {
        ...
        if(centro==292) {
            ...
            $.ajax({
              url: '../tarifastraslados/anadirtarifaindividualaotourbog',
              method: 'post',
              data: {id_trayecto: id_trayecto, centro: centro, valor: valor, valor_proveedor: valor_proveedor, cliente_van: cliente_van, proveedor_van: proveedor_van, localidad: 1}
            }).done(function(data){
    ...
    $('#guardar_ruta_individual').click(function() {
        ...
        $.ajax({
          ...
          method: 'post',
          data: {nombre: nombre, tarifa_cliente: tarifa_cliente, tarifa_cliente_van: tarifa_cliente_van, tarifa_proveedor: tarifa_proveedor, tarifa_proveedor_van: tarifa_proveedor_van, cliente: cliente, localidad: 1}
        }).done(function(data){
