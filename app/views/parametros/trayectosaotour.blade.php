...
<h3 class="h_titulo">LISTADO DE TRAYECTOS CON TARIFA AOTOUR</h3>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php 
                            ...
                            ->select('tarifas.id', 'tarifas.trayecto_id', 'tarifas.cliente_auto', 'tarifas.centrodecosto_id', 'centrosdecosto.razonsocial', 'centrosdecosto.id as id_centro')
...
<script type="text/javascript">
    ...
    $('#unificar_tarifa').click(function(e){
        ...
        $.ajax({
          url: '../tarifastraslados/unircliente',
          method: 'post',
