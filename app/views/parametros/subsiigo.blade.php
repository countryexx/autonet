...
<div class="col-lg-12">
    ...
    <table id="examplesiigo" class="table table-striped table-bordered hover" cellspacing="0" width="100%">
        ...
        <tr>
            <td>
                @if(intval(strlen($subcentrodecosto->id))===1)
                {{'CL00'.$subcentrodecosto->id}}
                @elseif(intval(strlen($subcentrodecosto->id))===2)
                {{'CL0'.$subcentrodecosto->id}}
                @elseif(intval(strlen($subcentrodecosto->id))===3)
                {{'CL'.$subcentrodecosto->id}}
                @endif
            </td>
            <td><?php echo strtoupper($subcentrodecosto->ciudad); ?></td>
            <td>{{$subcentrodecosto->identificacion}}</td>
            <td>{{$subcentrodecosto->nombres_contacto}}</td>
            <td>{{$subcentrodecosto->apellidos_contacto}}</td>
            <td>{{$subcentrodecosto->correo_contacto}}</td>
            <td>
                <!--<a data-id="{{$subcentrodecosto->id}}" data-razon="{{$subcentrodecosto->nombresubcentro}}" data-nit="{{$subcentrodecosto->identificacion}}" data-digit="{{$subcentrodecosto->id}}" data-tipo="{{$subcentrodecosto->id}}" data-direccion="{{$subcentrodecosto->direccion}}" data-city="{{$subcentrodecosto->id}}" data-tel="{{$subcentrodecosto->telefono}}" data-emails="{{$subcentrodecosto->correo_contacto}}" data-names="{{$subcentrodecosto->nombres_contacto}}" data-apellidos="{{$subcentrodecosto->apellidos_contacto}}" data-mail="{{$subcentrodecosto->correo_contacto}}" data-url="{{$subcentrodecosto->id}}" data-toggle="modal" data-target=".mymodal1" class="ver_rut btn btn-list-table btn-warning">Ver RUT</a>-->

                <a data-id="{{$subcentrodecosto->id}}" data-razonsocial="{{$subcentrodecosto->nombresubcentro}}" class="generar_cliente btn btn-list-table btn-info  ">Generar en Siigo</a>
            </td>
        </tr>
        @endforeach
        </tbody>
