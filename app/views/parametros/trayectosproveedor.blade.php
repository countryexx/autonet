<html>
<head>
	<title>Autonet | Trayectos Proveedores Barranquilla</title>
...
<h3 class="h_titulo">LISTADO DE TRAYECTOS - PROVEEDORES BAQ</h3>
                    ...
                    <th style="text-align: center;">TARIFA AOTOUR
                        ...
                        <div class="btn-group" style="width: 100%">
                          ...
                          <div class="dropdown-menu" style="width: 400px;">
                            ...
                            @endforeach
                                <li class="dropdown-item" type="button"><a href="{{url('tarifastraslados/trayectosaotourproveedor')}}">Ver Listado <i class="fa fa-share" aria-hidden="true"></i></a></li>
                          </div>
                        </div></th>
