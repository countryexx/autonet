...
<div class="col-lg-12">
    ...
    <h3 class="h_titulo">TARIFAS | {{$centrosdecosto->razonsocial}}</h3>
            ...
            @foreach($rutas as $ruta)
                <tr>
                    ...
                    <td style="text-align: center">
                        <a id="{{$ruta->id}}" data-toggle="modal" href="#shortModal2" style="padding: 5px 6px; margin-bottom: 3px;" class="btn btn-primary editar_rutas"><i class="fa fa-pencil"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
    ...
    @endif
     ...
     <button data-id="{{$centrosdecosto->id}}" id="exportar_tarifa" class="btn btn-default btn-icon">EXPORTAR TARIFAS GENERALES<i class="fa fa-archive icon-btn"></i></button>
        ...
        <form id="formulario">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button data-id="{{$centrosdecosto->id}}" id="guardar_rutas" class="btn btn-primary btn-icon">
        ...
        <form id="formulario">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                         <div class="col-xs-3">
                            <label class="obligatorio" for="codigo_editar">Codigo</label>
                            <input class="form-control" type="text" id="codigo_editar">
                        </div>
                        <div class="col-xs-3">
                ...
                <div class="modal-footer">
                    <button type="submit" id="actualizar_rutas" class="btn btn-primary btn-icon">
                        Guardar<i class="fa fa-floppy-o icon-btn"></i>
                    </button>
                    <a data-dismiss="modal" id="limpiar" class="btn btn-danger btn-icon">Cerrar<i class="fa fa-close icon-btn"></i></a>
                </div>
...
@else
<div class="col-lg-12">
    <span class="text-danger">No hay un registo con este id</span>
</div>    
