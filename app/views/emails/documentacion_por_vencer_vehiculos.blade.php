                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;">En los próximos 7 días se vencerá la documentación de <b>{{$cantidad_vehiculos}} VEHÍCULOS. </b></span>
                                ...
                                <br>
                                <br>
                                <a href="{{url('proveedores/listadovencimientovehiculos')}}">Ver Vehículos</a>
                             </div>
                         </div>
                        </td>
