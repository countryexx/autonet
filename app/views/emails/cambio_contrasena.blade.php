        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          ...
                          <h3 class="align-sm-left" style="font-weight: 3600; color: #5f6062;">No te preocupes, a todos se nos olvida algo alguna vez.</h3>
                          <br>
					  ...
					  <tr>
					  	...
					  	<td class="col" style="padding: 0 10px;">
							  ...
							  Hola {{$nombre}}.<br><br>Has solicitado la generación de una nueva clave para tu cuenta de AUTONET.
							</p>
							<p style="color: #929292; text-align:left">
								Te informamos la clave creada...
							</p>
              <p style="color: #f47321; text-align:left">
								{{$clave}}
							</p>
						</td>
					  </tr>
              ...
              <center><img class="align-sm-left" style="width: 150px; margin-top: 15px; margin-bottom: 15px" src="{{url('img/logo_aotour.png')}}"></center>
						</td>
					  </tr>
                    </table>
                  </td>
