...
<div style="padding: 10px 0px 0px 0px; font-size: 10px;">
  Auto Ocasional Tour SAS se encuentra complacido de indicarle a usted que su ruta es la {{$ruta}}, para el día {{$fecha}} a las {{$hora}} horas.
 <br>
  No olvide llevar su código de referencia para el ingreso al vehículo.
  </div>
  <br>
  <br>
  <h1 style="color: orange; font-family: arial">#AOTOURTEMUEVE</h1>
</body>
