                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          ...
                          <h2 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Estamos listos para moverte seguro</h2><br>            
                        </td>
                      ...
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:left">
                            Tu conductor está en camino hacia <b>{{$servicio->recoger_en}}</b> para recogerte y llevarte a <b>{{$servicio->dejar_en}}</b>.
                          </p>
                        </td>
                      </tr>
                      <tr>
