                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;">Te informamos que tu asignación del vehículo de placas <b>{{$placa}}</b> al conductor <b>{{$nombreConductor}}</b> fue APROBADO!</span>
