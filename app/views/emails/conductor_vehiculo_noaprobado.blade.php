                ...
                <tr>
                  <td style="padding: 0 20px;">
                    ...
                    <div style="margin-top: 10px; margin-bottom: 30px; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px orange; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">
                      <span><b>Sobre tu Asignación de Vehículo...</b></span>
                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;">Te informamos que tu asignación del vehículo de placas <b>{{$placa}}</b> al conductor <b>{{$nombreConductor}}</b> NO fue APROBADO!</span>
