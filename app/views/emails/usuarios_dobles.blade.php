            ...
            <td>
              ...
              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 20px;">
                    ...
                    <div style="margin-top: 10px; margin-bottom: 18px; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px orange; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">
                      ...
                      <span style="text-align: center; font-size: 14px;">Estos usuarios del {{$fecha}} están repetidos.<br><br></span>
                      <table>
                        <?php
                        for ($i = 0; $i < count($idArray); $i++) {
                          ...
                          <tr>
                            ...
                            <?php                              
                            //for ($u = 0; $u < count($arrayServicios[$i]); $u++) {
                            ?>

                            <td> {{$arrayServicios[$i]['uno']}}</td>
                            <td> {{$arrayServicios[$i]['dos']}}</td>
                ...
                <tr>
                  <td style="padding: 0 20px;">
                    <center>
                      <p style="font-size: 11px; text-decoration: underline;">Recuerda que de la buena gestión de esta actividad dependen procesos de la empresa.</p>
                    </center>
                  </td>
                </tr>
              </table>
