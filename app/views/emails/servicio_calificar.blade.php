                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          ...
                          <h2 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Tu servicio ha finalizado</h2><br>            
                        </td>
                      ...
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:left">
                            ¡Gracias por utilizar nuestros servicios!</b>
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:left">
                            Por favor, tómate un momento para calificar nuestro servicio.<br>
                            Tu opinión es muy valiosa para nosotros.<br>
                            ¡Esperarnos moverte de nuevo pronto!
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px; width: 40%; background-color: #f47321;">
                          ...
                          <a target="_blank" href="{{url('maps/rate/'.$servicio->id)}}" style="background-color: #f47321; float: left; border: 0 solid #f47321; color: white; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">Calificar <i class="fa fa-times" aria-hidden="true"></i></a>
