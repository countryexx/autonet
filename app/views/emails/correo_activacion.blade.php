                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          ...
                          <p style="color: #929292; text-align:center">Gracias por descargar nuestra aplicacion y registrarte con nosotros, tu cuenta de usuario ha sido activada, ya puedes solicitar servicios desde nuestra aplicacion.</p>
                        </td>
                      </tr>
                    </table>
                  </td>
