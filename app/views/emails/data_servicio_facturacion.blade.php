...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <tr>
    <td style="background-color: #ecf0f1" align="center">
      <div style="color: #34495e; margin: 14% 10% 2%; text-align: justify;font-family: sans-serif">
        <p class="sans-serif" style="font-size: 18px">Estimado(a) <b>{{$nombre_usuario}},</b> <br><br>
                              El día de hoy se ha realizado un servicio a su nombre, el cual generó los siguientes datos: <br></p>
            ...
            <table cellspacing="0" id="table_detalle_solicitud" style="width: 100%;" border="1">
              <thead>
                <tr bgcolor="green">
                  ...
                  <th class="sans-serif p-general" style="color: white; font-size: 12px; padding: 10px">DISTANCIA RECORRIDA</th>
                  <th class="sans-serif p-general" style="color: white; font-size: 12px; padding: 10px">DURACIÓN</th>
                  <th class="sans-serif p-general" style="color: white; font-size: 12px; padding: 10px">VALOR DEL SERVICIO</th>
                </tr>
              </thead>
              <tbody>
                  <!-- inicio foreach-->
                    <tr bgcolor="#EFEFEF">
                      ...
                      <td class="sans-serif p-general" style="color: #353535; font-size: 12px; padding: 10px; text-align: center;">
                        <b><?php echo '$ '.number_format($valor_tarifa) ?></b>
                      </td>
                    </tr>
                    @if($extra!=null)
                    <tr bgcolor="#EFEFEF">
                      <td colspan="5" class="sans-serif p-general" style="color: #353535; font-size: 12px; padding: 10px; text-align: center;">
                        Se aplicó un recargo al valor total del servicio por la suma de: <?php echo '$ '.number_format($extra) ?>
                      </td>
                    </tr>
                    @endif
                  <!-- fin foreach-->
            ...
            <table cellspacing="0" id="table_detalle_solicitud" style="width: 100%;" border="1">
              ...
              <tbody>
                  <!-- inicio foreach-->
                    <tr bgcolor="#EFEFEF">                
                      <td class="sans-serif p-general" style="color: #353535; font-size: 12px; padding: 10px; text-align: center;">
                        <b>{{$nombre_conductor}} / {{$celular}}</b>
                      </td>
                      <td class="sans-serif p-general" style="color: #353535; font-size: 12px; padding: 10px; text-align: center;">
                       <b>{{$clase}} / {{$placa}} / {{$marca}} / {{$modelo}}</b>
                      </td>                                      
                    </tr>
                  <!-- fin foreach-->
              </tbody>
  ...
  <div style="width: 100%; text-align: left; margin:20px 0; display: inline-block;">
    <span style="color: black; font-size: 18px;">Cualquier consulta puede contactarse con nuestra área de operaciones 24horas al correo <a href="mailto:transportebarranquilla@aotour.com.co">transportebarranquilla@aotour.com.co</a></span>  
  </div>

  <div style="width: 100%; text-align: right; margin:20px 0; display: inline-block;">
    <a style="text-decoration: none; border-radius: 5px; padding: 11px 23px; color: white; background-color: green; margin-right: 70px" href="https://www.aotour.com.co">Visítanos</a>
    <img width="220px" src="{{url('img/logo_aotour.png')}}">
  </div>

  <p style="color: #b3b3b3; font-size: 12px; text-align: center;margin: 30px 0 0"> Todos los derechos reservados</p>
    </div>
    </td>
  </tr>
</table>
