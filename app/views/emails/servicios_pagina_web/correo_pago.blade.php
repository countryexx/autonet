                ...
                <tr>
                  <td style="padding: 0 20px;">
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      ...
                      <img class="align-sm-left" style="width: 150px; margin-top: 15px; margin-bottom: 15px" src="{{url('img/logo_aotour.png')}}">
                      <br><br>

                      

                    <div style="margin-top: 30px; margin-bottom: 30px; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px orange; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">
                      <span><b>Confirmación de Pago</b></span>
                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;">Su pago se ha procesado exitosamente!</span>

                                <!-- Desde Hasta -->

                                <br><br>
                                <span style="font-size: 18px; float: right;" slot="start"><b id="valor">COP $ 27,900</b></span>

                                <div class="input-group margin_input mensaje" style="float: right; margin-top: 15PX;">
                                    <center>
                                        <div class="estado_servicio_app" style="float: right; background: #f47321; color: white; margin: 2px 0px; font-size: 14px; padding: 6px 10px; width: 100%; border-radius: 2px;"><span class="mensaje">PAGO PROCESADO POR WOMPI  <i class="fa fa-check" aria-hidden="true"></i></span>
                                        </div>
                                ...
                                <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                  <tr>
                                    <td class="col" align="center" width="640">
                                      <p style="text-align: left; color: white"><strong>Solicitud #: 12345</strong></p>
                                      <p style="text-align: left; color: white"><strong>Usuario: SAMUEL DAVID GONZÁLEZ MENDOZA</strong></p>
                                      <table style="border: 1px solid white;" class="servicio">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td style="color: white; padding: 5px; text-align: center; border: 1px solid white;">AOTOUR BARRANQUILLA, CRA 53, BARRANQUILLA ATLÁNTICO, COLOMBIA</td>
                                            <td style="color: white; padding: 5px; text-align: center; border: 1px solid white;">AEROPUERTO INTERNACIONAL ERNESTO CORTIZOS, SOLEDAD ATLÁNTICO</td>
                                          </tr>
                                        </tbody>
                                      </table>
                                      
                                        <div>
                                          <p style="text-align: left; color: white; margin-bottom: 10px;"><strong>Notas:</strong></p>
                                          <p style="color: white; text-align: justify; margin-bottom: 0; margin-top: 0px;">Recoger al pasajero con Hablador</p>
                                        </div>
