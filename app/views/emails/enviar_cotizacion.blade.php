              ...
              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 20px;">
                    ...
                    <div style="margin-top: 10px; margin-bottom: 18px; border: white 6px solid; -webkit-box-shadow: 1px 1px 1px 1px; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">

                      <span><b>Cotización N° {{$consecutivo}}</b></span><br><br>

                      <span style="text-align: center; font-size: 14px;">Gracias por tu ineterés en usar nuestros servicios. <br><br>Encontrarás adjunto la cotización solicitada el día <b>{{$fecha}}</b> . <br></span>

                      <br>
                      <center><span style="text-align: center; font-size: 14px;"><b>¿Qué quieres hacer?</b> <br><br></span>

                      <a target="_blank" href="{{url('cotizaciones/aceptarcotizacion/'.$consecutivo)}}" style="float: left; border: 0 solid green; color: green; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">Aceptar Cotización <i class="fa fa-check" aria-hidden="true"></i></a>

                      <a target="_blank" href="{{url('cotizaciones/rechazarcotizacion/'.$consecutivo)}}" style="float: right; border: 0 solid red; color: red; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">Rechazar Cotización <i class="fa fa-times" aria-hidden="true"></i></a></center>
                ...
                <tr>
                  <td style="padding: 0 20px;">
                    <center>
                      <p style="font-size: 10px">Derechos Reservados</p>
                    </center>
                  </td>
                </tr>
              </table>
