      ...
      <td>
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
                ...
                <tr>
                  <td style="padding: 0 20px;">
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          
                          <img class="align-sm-left" style="width: 150px; margin-top: 15px; margin-bottom: 15px" src="{{url('img/logo_aotour.png')}}"><br><br><br>
                          
                          <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Confirmación de Servicio</h1><br>            
                        </td>
                      ...
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:left">
                            Su servicio a <b>{{$servicio->recoger_en}}</b> iniciará a las <b>{{$servicio->hora_servicio}}</b> horas.
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" style="padding: 0 10px; width: 40%; background-color: #f47321;">

                          <a target="_blank" href="{{url('maps/trackingservice/'.$servicio->id)}}" style="background-color: #f47321; float: left; border: 0 solid #f47321; color: white; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">Tracking GPS <i class="fa fa-times" aria-hidden="true"></i></a>

                        </td>
                        <td class="col" style="padding: 0 10px; width: 10%">

                        </td>
                        <td class="col" style="padding: 0 10px; width: 40%; background-color: gray;">
                          
                          <a target="_blank" href="{{url('maps/trackingservice/'.$servicio->id)}}" style="background-color: gray; float: left; border: 0 solid gray; color: white; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">Driver <i class="fa fa-times" aria-hidden="true"></i></a>
                      ...
                      <tr>
                        ...
                        <td class="col" colspan="3" style="padding: 0 10px; width: 10%">
                          <p style="color: #929292; text-align:left">
                            El tracking estará disponible cuando tu conductor vaya en camino
                          </p>
                        </td>
            ...
            <tr>
              <td class="col" colspan="3" style="padding: 0 10px;">
                <!--<hr style="margin-bottom: 4px; border-top: 1px solid #B9B8B8;">-->
                <p style="color: #929292; text-align:left">© Copyright 2023 Aotour, SAS.</p>
              </td>
            </tr>
                    </table>
                  </td>
