              ...
              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 20px;">
                    ...
                    <div style="margin-top: 10px; margin-bottom: 18px; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px orange; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">

                      <span><b>¡Atención!</b></span><br><br>

                      <span style="text-align: center; font-size: 14px;">Las siguientes facturas presentan vencimiento.<br><br></span>
                      <div>
                        <table id="example_table" class="table table-bordered hover tabla" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                              ...
                              <td style="text-align: center;" class="h4 text-center mt-3 mb-4 pb-3">Factura</td>
                              <td style="text-align: center;" class="h4 text-center mt-3 mb-4 pb-3">Cliente</td>
                              <td style="text-align: center;" class="h4 text-center mt-3 mb-4 pb-3">Venció</td>
                              <td style="text-align: center;" class="h4 text-center mt-3 mb-4 pb-3">Días Vencidos</td>
                            </tr>
                          </thead>
                          <tbody>
                            <?php $o = 1; ?>
                            ...
                            ?>
                              <tr>
                                ...
                                <th style="text-align: center; font-size: 10px">
                                  <a href="{{url('facturacion/verorden/'.$orden->id)}}">{{$orden->numero_factura}}</a>
                                </th>
                                <th style="text-align: center; font-size: 10px">
                                  {{$orden->razonsocial}}
                                </th>
                ...
                <tr>
                  <td style="padding: 0 20px;">
                    <center>
                      <p style="font-size: 11px; text-decoration: underline;">Recuerda realizar la gestión de cobro con los clientes.</p>
                    </center>
                  </td>
                </tr>
              </table>
