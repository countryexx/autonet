                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;">{{$texts}}</span>

                                <br><br>

                                <span style="font-size: 15px; float: left;" slot="start">
                                Ingresa al portal de proveedores AUTONET y adjunta el documento para que no tengas novedad de programación.
                                </span>

                                <br>
                                <br>
                                <a href="{{url('portalproveedores/documentacionvehiculos')}}">Ir a AUTONET</a>
                             </div>
                         </div>
                        </td>
