                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;">Se ha habilitado la plataforma AUTONET para la generación de cuenta de cobro, en el corte del <b>{{$fecha_inicial}}</b> al <b>{{$fecha_final}}. </b></span>

                                <br>
                                <br>
                                <a href="{{url('portalproveedores/clientes')}}">Ir a AUTONET</a>
                             </div>
                         </div>
                        </td>
