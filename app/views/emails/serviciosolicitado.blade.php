                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
						  ...
						  <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Verifica tu Email</h1><br>						
                        </td>
                      </tr>
					  <tr>
					  	<td class="col" style="padding: 0 10px;">
						  	<p style="color: #929292; text-align:left">
							  Bienvenido al portal de usuarios Aotour, {{$nombres}}.<br>El siguiente paso será confirmar tu Email.
							</p>
							<p style="color: #929292; text-align:left">							
								Realizamos esto como una precaución de seguridad para verificar tus credenciales.
							</p>
						</td>
					  </tr>
					  <tr>
					  	<td class="col" style="padding: 0 10px;">
							<a href="https://app.aotour.com.co/autonet/singin/confirmarcelular/{{$codigo}}" class="button">Verificar Email</a><br><br>
						</td>
					  </tr>
					  <tr>
					  	<td class="col" style="padding: 0 10px;">
