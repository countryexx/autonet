              ...
              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 20px;">
                    ...
                    <div style="margin-top: 10px; margin-bottom: 10px; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px orange; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">
                      <span><b></b></span>
                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;">En los próximos 7 días se vencerá la documentación de <b>{{$cantidad_conductores}} CONDUCTORES. </b></span>

                                <br><br>

                                <span style="font-size: 15px; float: left;" slot="start">
                                Presiona click en el siguiente enlace para ver los detalles y fechas de vencimiento.
                                </span>

                                <br>
                                <br>
                                <a href="{{url('proveedores/listadovencimientoconductores')}}">Ver Conductores</a>
                             </div>
                         </div>
                        </td>
