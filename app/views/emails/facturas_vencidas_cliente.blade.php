          ...
          <tr>
            <td>
              ...
              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 20px;">
                    ...
                    <div style="margin-top: 10px; margin-bottom: 18px; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px orange; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">
                      ...
                      <img src="{{url('biblioteca_imagenes/plantilla_cobro.png')}}" width="90%" >
                ...
                <tr>
                  <td>
                    <p style="font-size: 11px; text-decoration: underline;">Facturas vencidas a la fecha:</p>
                ...
                <tr>
                  <td style="padding: 0 20px;">
                    <center>
                      <p style="font-size: 11px; text-decoration: underline;">No responder a este correo, ya que fue enviado automáticamente desde nuestra plataforma.</p>
                    </center>
                  </td>
                </tr>
              </table>
