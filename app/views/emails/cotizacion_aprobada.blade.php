                ...
                <tr>
                  <td style="padding: 0 20px;">
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      ...
                      <span style="font-size:80px; float: right">&#x2705;</span>
                      <br><br>
                    ...
                    <div style="margin-top: 10px; margin-bottom: 30px; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px orange; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">
                      <span><b>Respuesta de Cotización</b></span>
                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;"> La cotización N° <b>{{$consecutivo}}</b> ha sido ACEPTADA por <b>{{$cliente}}</b>. </span>

                                <!-- Desde Hasta -->

                                <br><br>
                                <center><a target="_blank" href="{{url('cotizaciones/listado')}}" style="float: left; border: 1 solid green; color: green; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">Ver Cotizaciones <i class="fa fa-check" aria-hidden="true"></i></a></center>
                             </div>
                         </div>
                        </td>
