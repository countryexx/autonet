...
<body style="box-sizing:border-box;margin:0;padding:0;width:100%;-webkit-font-smoothing:antialiased;word-break:break-word;">
  ...
  <table class="wrapper" bgcolor="#EEEEEE" cellpadding="15" cellspacing="0" role="presentation" width="100%">
    <tr>
      <td>
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="640">
          <tr>
            <td>
                ...
                <tr>
                  <td style="padding: 0 20px;">
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td align="justify" class="col" style="padding: 0 10px;">
                          <img src="{{url('biblioteca_imagenes/logo_excel.png')}}" width="280px" height="90px" align="left">
                          <p style="color: #929292; text-align:center">Adjunto encontrara el enlace a la descarga de los fuecs para el vehiculo de placas {{$placa_vehiculo}}</p><br>
                            <table border="1" style="border-color: #929292;">
                                <thead>
                                    <tr>
                                        <th align="center" width="45">#</th>
                                        <th align="center" width="155">Contratante</th>
                                        <th align="center" width="125">Origen</th>
                                        <th align="center" width="125">Destino</th>
                                        <th align="center" width="125">Vigencia</th>
                                        <th align="center" width="70">Enlace</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($fuecs as $fuec)
                                    <tr>
                                        <td align="center" style="vertical-align: middle">{{$fuec->consecutivo}}</td>
                                        <td align="center" style="vertical-align: middle">{{ucwords(strtolower($fuec->contratante))}}</td>
                                        <td align="center" style="vertical-align: middle">{{ucwords(strtolower($fuec->origen))}}</td>
                                        <td align="center" style="vertical-align: middle">{{ucwords(strtolower($fuec->destino))}}</td>
                                        <td align="center" style="vertical-align: middle">{{$fuec->fecha_inicial.'<br>'.$fuec->fecha_final}}</td>
                                        <td align="center" style="vertical-align: middle">
                                            <a href="{{url('descargar/fuec_link/numero/'.$fuec->fuec_id)}}" style="color: #34BF49; font-size: 12px;">DESCARGA</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
