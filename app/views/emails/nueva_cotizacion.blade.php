    ...
    <tr>
      <td>
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:center; font-size: 16px">Cotización N° {{$consecutivo}}</p>
                          <p style="color: black; text-align:center"><b>-{{$asunto}}-</b></p>

                          <div style="text-align: center; margin-bottom: 30px;">
                            <img class="align-sm-center" width="220" style="width: 220px; margin-bottom: 20px;" src="{{url('img/logo_aotour.png')}}">
                          </div>
                        </td>
                      </tr>
                    </table>
              ...
              <table style="background: gray; margin-top: 35px" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 15px; padding-bottom: 15px;">
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" align="center" width="640">
                          <p style="text-align: left; color: white; font-size: 14px; font-family: sans-serif; margin-top: 18px; margin-bottom:25px ;text-align: justify">
                            Cordial Saludo, Sr(a) {{$contacto}}<br><br>
                            En representación de {{$cliente}}<br><br>
                            Reciban un cordial saludo de parte del equipo <span style="color: orange">AOTOUR SAS.</span><br>
                            En esta oportunidad nos permitimos enviar la cotización solicitada para nuestros servicios de transporte.<br>
                            En <span style="color: orange">AOTOUR SAS</span>, queremos ser sus aliados estratégicos para su movilidad.
                            Quedamos atentos a su confirmación del servicio para su gestión y programación.<br>
                            “En <span style="color: orange">AOTOUR SAS.</span> No vendemos un servicio, transportamos personas valiosas”.

                            <!--Agradecemos tu interés en utilizar nuestros servicios.<br>Adjunto encontrarás la cotización solicitada el {{$fecha}}.-->
                          </p>
                          <table style="width: 100%" >
                            <thead>
                              <tr>
                                <th style="color: white; background-color: green; padding: 5px; width: 45%; text-align: center;">
                                  <a target="_blank" href="{{url('cotizaciones/aceptarcotizacion/'.$consecutivo)}}" style="float: left; border: 0 solid #green; color: white; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">Aceptar Cotización <i class="fa fa-check" aria-hidden="true"></i></a>
                                </th>
                                <th style="color: white; padding: 5px; text-align: center; vertical-align: middle;"></th>
                                <th style="color: white; background-color: red; padding: 5px; width: 45%; text-align: center;">
                                  <a target="_blank" href="{{url('cotizaciones/rechazarcotizacion/'.$consecutivo)}}" style="background-color: red; float: right; border: 0 solid red; color: white; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">Rechazar Cotización <i class="fa fa-times" aria-hidden="true"></i></a>
                                </th>
                              </tr>
                            </thead>
                          ...
                          @if (1>2)
                            <div>
                              <p style="text-align: left; color: white; margin-bottom: 10px;"><strong>Detalles</strong></p>
                              <p style="color: white; text-align: justify; margin-bottom: 0; margin-top: 0px;">detalles</p>
                            </div>
                          @endif
                        </td>
                      </tr>
        ...
        <table class="container" align="center" bgcolor="#eeeee" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              <p style="color: gray; text-decoration: underline; text-align: center; margin-bottom: 10px;">Selecciona cualquiera de las opciones anteriores para aceptar o rechazar la cotización</p>
            </td>
          </tr>
        </table>
      </td>
