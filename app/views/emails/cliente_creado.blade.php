                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;"><b>{{$usuario}}</b> ah creado a {{$cliente}} como cliente en AUTONET. </span>

                                <!-- Desde Hasta -->

                                <br><br>
                                <span style="font-size: 15px; float: left;" slot="start"><b id="valor">Creación en Siigo: </b>PENDIENTE</span>

                                <br><br>

                                <a href="{{url('centrodecosto/'.$link.'')}}">Pulsa aquí para Crear en Siigo</a>
