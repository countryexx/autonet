              ...
              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 20px;">
                    ...
                    <div style="margin-top: 10px; margin-bottom: 30px; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px orange; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">
                      <span><b>Novedad Registrada</b></span>
                        ...
                        <td class="col" style="padding: 0 10px;">
                          <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                                ...
                                <span style="text-align: center; font-size: 14px;">El conductor {{$conductor}} ha registrado una novedad en el servicio del {{$fecha}} hacia {{$dejar_en}}. </span>

                                <!-- Desde Hasta -->

                                <br><br>
                                <span style="font-size: 18px; float: left;" slot="start"><b id="valor">Novedad: {{$novedad}}</b></span>

                                <br><br>

                                <a href="{{url('transportesbaq/reconfirmacion/'. $servicio )}}">Ver la novedad en AUTONET</a>

                                <!--<a style="float: right;" target="_blank" href="{{url('transportesbaq/reconfirmacion/467564')}}">Ver la novedad en AUTONET</a>-->
