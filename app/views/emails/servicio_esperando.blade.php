                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          ...
                          <h2 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Tu conductor te está esperando</h2><br>            
                        </td>
                      ...
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:left">
                            {{$nombre}} te está esperando en <b>{{$servicio->recoger_en}}</b>.
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:left">
                            Si necesitas contactarlo lo puedes llamar al número <a href="tel:{{$numero}}">{{$numero}}</a>
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px; width: 40%; background-color: #f47321;">
                      ...
                      <tr>
                        ...
                        <td class="col" colspan="3" style="padding: 0 10px; width: 10%">
                          <p style="color: #929292; text-align:left">
                            Pulsa en el enlace <b>Tracking GPS</b> para conocer la ubicación de tu conductor.
                          </p>
                        </td>
