                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          ...
                          <h2 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Desvinculación de Conductor</h2><br>
                        </td>
                      ...
                      <tr>
                        <td class="col" colspan="3" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:left">
                            <b>{{$nombre_proveedor}}</b> ha removido a su conductor <b>{{$nombre_conductor}}.</b>
                          </p>
                        </td>
                      </tr>
