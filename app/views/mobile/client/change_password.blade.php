            ...
            <td>
              ...
              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 20px;">
                    ...
                    <div style="margin-top: 10px; margin-bottom: 18px; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px orange; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">
                      ...
                      <span style="text-align: center; font-size: 13px;">Hola, {{$name}}.<br><br>
                      Recibimos una solicitud para restablecer tu contraseña de UP.<br>
                      Ingresa el código <b>{{$code}}</b> para restablecer tu contraseña.
                      </span>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 0 20px;">
                    <center>
                      <p style="font-size: 11px; text-decoration: underline;">Si no fuiste tu, avísanos al <a href="tel:+573147806060">+57 314 780 6060</a>.</p>
                    </center>
                  </td>
                </tr>
              </table>
