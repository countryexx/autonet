                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          <h1 class="align-sm-center" style="font-weight: 400; color: #5f6062;">Bienvenido a</h1>
                          <img class="align-sm-center" style="width: 220px;" src="{{asset('img/mobile/logo_aotour_mobile_login.png')}}">
                          <p style="color: #929292; text-align:center">Gracias por registrarte, el siguiente paso es activar tu cuenta para validar tu correo electrónico</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          ...
                          <p style="color: white; text-align: center">Activa tu cuenta presionando el siguiente boton</p>
                          <table style="margin-bottom: 15px;" class="align-sm-center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" style="border-radius: 3px;">
                            <tr>
                              <th>
                                <a href="{{'https://app.aotour.com.co/autonet_3/public/activacioncuenta/'.$activation_code}}"  style="border: 0 solid #34BF49; color: #f47321; display: inline-block; font-size: 13px; padding: 8px 50px; text-decoration: none;">ACTIVAR CUENTA</a>
                              </th>
                            </tr>
                          </table>
                          <small style="color: #ffffff; font-size: 12px;">
                              Si tiene problemas para hacer clic en el botón "Activar Cuenta", copia y pega la siguiente url en su navegador web: <a style="color: white" href="{{'https://app.aotour.com.co/autonet_3/public/activacioncuenta/'.$activation_code}}">{{'https://app.aotour.com.co/autonet_3/public/activacioncuenta/'.$activation_code}}</a>
                          </small>
                        </td>
                      </tr>
                    </table>
