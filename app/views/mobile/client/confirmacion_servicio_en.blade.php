    ...
    <tr>
      <td>
                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          <p style="color: #929292; text-align:center">A service has been requested from the application</p>
                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" align="center" width="640">
                          <p style="text-align: left; color: white"><strong>Request #: </strong>{{ucwords(strtolower($servicio_aplicacion->id))}}</p>
                          <p style="text-align: left; color: white"><strong>Client: </strong>{{ucwords(strtolower($client))}}</p>
                          <p style="text-align: left; color: white"><strong>User:</strong> {{ucwords(strtolower($first_name))}} {{ucwords(strtolower($last_name))}}</p>
                          <table style="border: 1px solid white;" class="servicio">
                            <thead style="border: 1px solid white;">
                              <tr>
                                <th style="color: white; padding: 5px; width: 82px; text-align: center; border: 1px solid white;">Date<hr style="border: 1px dashed white;">Time</th>
                                <th style="color: white; padding: 5px; text-align: center; border: 1px solid white; vertical-align: middle;">Pickup</th>
                                <th style="color: white; padding: 5px; text-align: center; border: 1px solid white; vertical-align: middle;">Carry</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr>
                          ...
                          @if ($servicio_aplicacion->nota!=null)
                            <div>
                              <p style="text-align: left; color: white; margin-bottom: 10px;"><strong>Details</strong></p>
        ...
        <table class="container" align="center" bgcolor="#eeeee" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              <p style="color: #f47321; text-decoration: underline; text-align: center; margin-bottom: 10px;">Please answer this email to authorize the service</p>
            </td>
          </tr>
        </table>
      </td>
