...
<head>
    ...
    <title>Autonet | Rutas QR BOG</title>
...
<div class="col-lg-12">
    <h3 class="h_titulo">PROGRAMACION DE RUTAS QR BOGOTÁ</h3>
        ...
        <tbody>
            ...
            @foreach($servicios as $servicio)
                ...
                <tr id="{{$servicio->id}}" class="@if(intval($servicio->resaltar)===1){{'resaltar'}}@endif">
                    <td>{{$o++}}</td>
                    <td><?php if(intval($servicio->localidad)===1){ echo'<h6 style="color: green">BAQ</h6>'?> {{$servicio->id}} <?php }else{ echo'<h6 style="color: blue">BOG</h6>'?>{{$servicio->id}} <?php }  ?></td>
                    ...
                    <td>
                      ...
                      <?php
                         ...
                         //   if(intval($servicio->ruta_qr)===1){
                           //   echo '<i style="size:50" class="fa fa-qrcode" ></i><br>';
                           // }
    ...
    <div class="modal-dialog modal-rutas" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">DATOS DE PASAJEROS QR</h4>
            </div>
...
<script src="{{url('jquery/rutas_transporteqrbog.js')}}"></script>
