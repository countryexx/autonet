    ...
    <script type="text/javascript">
      ...
      function initMap() {
        map = new google.maps.Map(document.getElementById('map'), {
          zoom: 14,
          //bog center: {lat: 4.699686, lng: -74.0812367}
        ...
        var marker_oficina = new google.maps.Marker({
          position: positionao,
          map: map,
          title: 'OFICINA AOTOUR BARRANQUILLA',
        ...
        '<h4>OFICINA AOTOUR BARRANQUILLA</h4>'
        '</div>';
                ...
                if (data.respuesta===true) {                    
                     ...
                     for (var i in data.servicio) {                      
                        ...
                        marcador_conductor.addListener('click', function() {
                          infowindow.open(map, marcador_conductor);
                        });
                        // 
