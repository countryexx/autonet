  ...
  @foreach ($servicio as $servicios)
    ...
    @else
      <!--<h4 style="text-align: center;">GPS TRACKING <i class="fa fa-map-marker" aria-hidden="true"></i></h4>-->
        ...
        <button class="kc_fab_main_btn mostrarModal"><i class="fa fa-commenting-o" aria-hidden="true" data-toggle="modal" data-target=".mymodal3"></i></button>
              ...
              <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                      <div class="panel panel-default">
                          <div class="panel-heading"><p style="text-align: left; color: #FF7433"><b>DRIVER INFORMATION</b></p> <!--<button class="kc_fab_main_btn"><i class="fa fa-commenting-o" aria-hidden="true"></i></button>--></div>
...
-->
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-color: #918984; color: white">Close</button>
                    </div>
                  </div>
                </div>
              </div>

              <div class="modal fade" tabindex="-1" id="modaMensajes" role="dialog">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header" style="background-color: #FF7433">
                      <div class="row">
                        <div class="col-md-12">
                          <h5 class="modal-title" style="text-align: center; font-size: 20px">Messages</h5>
                        </div>
                      </div>
                    ...
                    <div class="modal-body">
                      ...
                      <!--<div class="col-lg-12" style="background: #f47321; height:  100px">
                        <span style="margin-top: 4px; color: white; float: right;">2022-09-22 18:00</span>
                        <span style="color:  white; font-family: Bahnschrift; font-size: 15px; float: left; margin-top: 10px;">Hola. Soy tu conductor. Te estaré esperando en la terminal 1, puerta 48.</span>
                      </div>-->
  ...
  <script type="text/javascript">
      ...
      $('.mostrarModal').click(function(e){
        ...
        $.ajax({
            url: '../../serviciosejecutivos/consultarmensajes',
            data: {
                'id': id,
                //'json': json
            },
            ...
            if(data.respuesta==true){
              ...
              for(i in $json){
                ...
                /*htmlJson += '<div style="border: 1px solid"><span style="float: '+flo+'; margin-top: 6px; color: orange">'+nombre+'</span>'+
                            
                              '<span style="font-family: Bahnschrift; font-size: 15px; float: left">'+$json[i].mensaje+'</span>';
                              //'<span style="font-family: Bahnschrift; font-size: 15px"> VALOR ENVIADO: $ '+$json[i].valor+'</span>'+
                            '</div>';*/
                  cont++;
