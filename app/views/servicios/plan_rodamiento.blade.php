                ...
                <tr class="content_cell">
                  ...
                  @foreach ($fechas as $fecha)
                    <?php
                      ...
                      ->whereIn('proveedor_id',[6,217,49,33,125,212,171,175,227,106,266,22,241])
                      ->where('hora_servicio', $servicio->hora_servicio)
                      ->where('vehiculo_id',$servicio->vehiculo_id)
                      ->where('ruta_nombre_id', $servicio->ruta_nombre_id)
                      ->first();

                      //echo $servicio->razonsocial.'/<br>';
                      //echo $ser->vehiculo_id.'/';
                    ?>
                    @if (count($ser))
