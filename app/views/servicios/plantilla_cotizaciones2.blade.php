...
<html><head>
    ...
    <title>Cotizacion_{{$cotizaciones->consecutivo}}</title>
    ...
    <div class="content-header">
      <img width="150px" style="margin-bottom: 0px" src="biblioteca_imagenes/logos_cotizacion.png">
      <img width="50px" style="margin-bottom: 0px;" src="biblioteca_imagenes/icontec_imagen.png">
    ...
    <table class="table-titles" style="border-top: 0px !important; width: 100%;">
      <tr>
        <td style="width: 50px !important; padding: 5px !important; border: 1px solid black">Fecha:</td>
    ...
    <table class="table-titles" style="border-top: 0px !important; width: 100%;">
      <tr>
        ...
        <td style="width: 50px !important; padding: 5px !important; border: 1px solid black">Nit o CC:</td>
    ...
    <table class="table-titles" style="margin-bottom: 0px; border-top: 0px !important; width: 100%;">
      <tr>
        ...
        <td style="width: 50px !important; padding: 5px !important; border: 1px solid black">Telefono:</td>
        <td style="width: 50px !important; padding: 5px !important; border: 1px solid black">{{$cotizaciones->celular}}</td>
        @endif
        @if($cotizaciones->mail!=null or $cotizaciones->mail!='')
        <td style="width: 40px !important; padding: 5px !important; border: 1px solid black">Email:</td>
        <td style="width: 90px !important; padding: 5px !important; border: 1px solid black">{{$cotizaciones->mail}}</td>
        @endif
    ...
    <div class="table-content"><br>
		<table class="table-titles" style="font-size: 10px !important; margin-bottom: 0px; border-top: 0px !important; width: 100%;">
			<tr align="center" style="background-color: #F47321; border-color: #ffffff;" data-mce-style="background-color: #F47321; border-color: #000000;">
      ...
      <?php $total = 0; ?>
		 @foreach($cotizacion_det as $cot_det)
			<tr>
				<td align="center">{{$cot_det->fecha_servicio}}</td>

				<td >{{$cot_det->descripcion}}</td>
				<td align="center">{{$cot_det->ciudad}}</td>
				<td align="center">{{$cot_det->tipo_vehiculo}}</td>
				<td align="center">{{$cot_det->pax}}</td>
				<td align="center">{{$cot_det->vehiculos}}</td>
				<td align="center">$ {{number_format($cot_det->valorxvehiculo)}}</td>
				<td align="right">$ {{number_format($cot_det->valortotal)}}</td>
			</tr>
      <?php $total = floatval($cot_det->valortotal) + $total; ?>
		 @endforeach
     <tr>
       <td colspan="7">
         <label style="color: black; font-size: 15px;margin-left: 645px;margin-bottom: 0" id="total_general">Total:</label>
       </td>

       <td align="right">
         <label style="color: black; font-size: 15px; margin-bottom: 0" id="total_general">{{number_format($total)}}</label>
       </td>
     </tr>
		</table>
    </div>
        ...
        <div style="font-size: 10px !important; padding-left: 10px !important;">
          <div style="display: inline-block; width: 45% !important; float: left !important;">
            ...
            <ul style="padding: 5px 10px 0 5px; margin-bottom: 5px">
              <li>Atencion al cliente 24 horas.</li>
          ...
          <div style="display: inline-block; width: 55% !important; float: right !important;"><br/>
            <ul style="padding: 5px 10px 0 5px; margin-bottom: 5px">
              ...
              <li>Vigencia de tarifas: 31 de Diciembre de {{number_format(date('Y'))}}.</li>
              <li>Adicionalmente contamos con una politica de objetos perdidos que puede ser consultada mediante el siguiente link: <a href="www.aotour.com.co/politicas-objetos-perdidos">www.aotour.com.co/politicas-objetos-perdidos</a></li>
            </ul>
          </div>
        </div>
    </div>
