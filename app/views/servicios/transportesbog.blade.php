...
<html>
  <head>
    ...
    <title>Autonet | Servicios BOG</title>
  ...
  <body>
                ...
                @foreach($servicios as $servicio)
                    ...
                    <tr id="{{$servicio->id}}" class="@if(intval($servicio->resaltar)===1){{'resaltar'}}@elseif($servicio->programado_app==1) {{'success'}} @endif">
                              ...
                              if (intval($servicio->facturado)===1) {
                                  ...
                                  if (intval($servicio->estado_servicio_app)===1) {
                                      ...
                                      if (intval($servicio->aceptado_app)===0) {
                                          ...
                                          echo '<div class="estado_servicio_app" style="background: #5B5B5B; color: white; margin: 2px 0px; font-size: 9px; padding: 3px 5px; width: 67px; border-radius: 2px;">RECHAZADO <br>'.$st.'</div>';
                        ...
                        <td class="opciones text-center">
                          @include('otros.servicios.botones_listado_serviciobog')
                        </td>
                        <td>
    ...
    @include('modales.nuevo_serviciobog')

    @include('modales.editar_serviciobog')
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="export_exce_ruta">
                            <div class="row" style="margin-top: 15px">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <div class="row">
                                            <form id="form" action="{{url('transportesbog/exportarrutasfechas')}}" method="post">
                                              <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="row">
                                            <form id="form" action="{{url('transportesbog/exportarlistadodia')}}" method="post">
                                                <div class="col-xs-12">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="export_exce_ruta2">
                            <div class="row" style="margin-top: 15px">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <div class="row">
                                            <form id="form" action="{{url('transportesbog/exportarrutasdia')}}" method="post">
                                                <div class="col-xs-12">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background-color: white">
                    ...
                    <center><div class="hidden" id="estado_servicio_modal" style="background: #4CAF50; color: white; margin: 2px 0px; font-size: 20px; padding: 3px 5px; width: 140px; border-radius: 2px"></div>
                        ...
                        <br>
                        <div class="estado_servicio_app codes hidden" style="background: #f47321; color: white; margin: 2px 0px; font-size: 25px; padding: 3px 5px; width: 15%; border-radius: 6px;"><a class="notify"><b class="codigos"></b></a></div>
    ...
    <script
      src="https://maps.googleapis.com/maps/api/js?key={{$_ENV['API_KEY_GOOGLE_MAPS']}}&callback=initMap&libraries=places&v=weekly"
      defer
    ></script>
    ...
    <script src="{{url('jquery/serviciosbog.js')}}"></script>
    ...
    <script type="text/javascript">
      ...
      var correos = [
        ...
        "anamelissa.montenegro@sutherlandGlobal.com", "odalis.orozcoalvarez@sutherlandglobal.com", "carolina.orrego@averydennison.com"
      ];
      ...
      function initMap() {
        ...
        const map = new google.maps.Map(document.getElementById("map"), {
          center: { lat: 4.6271526, lng: -74.0739239 },
          zoom: 13,
        });
        ...
        const markerss = new google.maps.Marker({
          ...
          position: new google.maps.LatLng(4.6271526,-74.0739239),
      ...
      $('.notify').click(function() {
        ...
        $.ajax({
          url: 'transportesbog/notificarcodigo',
          method: 'post',
          data: {id: id}
        }).done(function(data){
