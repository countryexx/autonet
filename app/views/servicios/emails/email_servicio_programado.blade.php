                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      ...
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          ...
                          <a target="_blank" style="margin-top: 25px; float: right; width: 140px;" href="{{url('maps/trackingservice/'.$servicio->id)}}" class="button">Tracking</a>
                        </td>
                      </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin-top: 25px;">
                      ...
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          ...
                          <a target="_blank" style="margin-top: 45px; float: right;" href="https://app.aotour.com.co/autonet/transporteescolar/servicio/{{$servicio->id}}" class="button">Foto / Photo</a>
