                      ...
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          ...
                          <img class="align-sm-left" style="width: 150px; margin-top: 15px; margin-bottom: 15px" src="{{url('img/logo_aotour.png')}}"><br><br><br>
                            ...
                            <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Código QR </h1><br><br><br><img width="100px" src="{{url('biblioteca_imagenes/codigosqr/'.$cedula.'.png')}}" />
                          </td>
                        </tr>
                          <tr>
                            <td class="col" style="padding: 0 10px;">
                              <p style="color: #929292; text-align:left">
                              Bienvenido al portal de usuarios Aotour, {{$nombres}}.<br>¡Has completado tu registro exitosamente!
                            </p>
                          ...
                          <tr>
                            <td class="col">
                              <a href="{{ url('listadousuariosqr/descargarcodigoqrmail/' . $cedula) }}" class="button">Descargar Código (PDF) </a>
                            </td>
                          </tr>
                          <tr>
                            <td class="col" style="padding: 0 10px;">
                            <p style="color: #929292; text-align:left">
                              En caso de perder éste correo, puedes volver a descargar el código iniciando sesión en el portal de usuarios con tu email y el número de cédula como contraseña, Pestaña 'CÓDIGO QR'.
                            </p>
                          </td>
                          </tr>
                          <tr>
                            <td class="col">
                              <a href="https://aotour.com.co/portalusuarios/" class="button">Ir al Portal de Usuarios</a>
                            </td>
                          </tr>
                          <tr>
                            <td class="col" style="padding: 0 10px;">
                              <hr style="margin-bottom: 4px; margin-top: 35px; border-top: 1px solid #B9B8B8;">
                              <p style="color: #929292; text-align:left">
                              © Copyright 2021 Aotour, SAS. Todos los derechos reservados.
                            </p>
                          </td>
                          </tr>
                    </table>
