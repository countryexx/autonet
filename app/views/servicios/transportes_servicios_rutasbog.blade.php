...
<head>
    <meta charset="UTF-8">
    <title>Autonet | Servicios y Rutas BOG</title>
...
<body onload="nobackbutton();">
                        ...
                        <?php
                            ...
                            if (intval($servicio->estado_servicio_app)===1) {
                                ...
                                if (intval($servicio->aceptado_app)===0) {
                                  ...
                                  echo '<div class="estado_servicio_app" style="background: #de0000; color: white; margin: 2px 0px; font-size: 9px; padding: 3px 5px; width: 67px; border-radius: 2px;">RECHAZADO <br>'.$st.'</div>';
  ...
  @if (isset($permisos->transportes->plan_rodamiento->ver) or isset($permisos->transportes->servicios->ver))
    @if($permisos->transportes->plan_rodamiento->ver="on")
      @include('modales.transportes.plan_de_rodamientobog')
    @endif

  @endif
  @include('modales.transportes.modal_cronogramabog')
