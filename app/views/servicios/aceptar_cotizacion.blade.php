...
<div class="app-container">
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      <center>
        <img style="height: 100px; width: 130px; margin-top: 50px; margin-left: 20px" src="{{url('img/check.jpg')}}" alt="">
      </center>
    </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jumbotron" style="padding-left: 48px; padding-right: 48px">
                  <center>
                    ...
                    @if($sw=='rechazada')
                      <h1>¡Esta cotización fue rechazada!</h1><br>
                    @else
                      <h1>Cotización N° {{$consecutivo}}</h1><br>
                      <p>Gracias por aceptar viajar con nosotros.</p>
                      <p>¡Estamos seguros que disfrutarás las experiencia <b style="color: #f47321">AOTOUR</b>!</p><br>
                      <p>¡En instantes te estaremos notificando la programación de tu servicio!</p>
                    @endif
