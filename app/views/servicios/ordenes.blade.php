...
<html>
  ...
  <body>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id='modal_reconfirmacion' data-backdrop="static" style="margin-top: 100px;">
    ...
    $( document ).ready(function() {
      ...
      //Validación permanente de docs START
      var request = setInterval(function(){

        $.ajax({
          url: url+'/transportesbog/documentacionemail',
          method: 'post',
          data: {foto_id: 123}
        }).done(function(data){
      ...
      //Validación permanente de docs END
        ...
        $table2.clear().draw();
          ...
          $table.clear().draw();
            ...
            $table3.clear().draw();
              ...
              $.ajax({
                  type: 'post',
                  url: url+'/transportesbog/buscarordenesprogramadas',
                  processData: false,
                  contentType: false,
                  success: function(data) {
