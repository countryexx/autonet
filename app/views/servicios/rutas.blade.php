...
<div class="col-lg-12">
    ...
    @if($permisos->barranquilla->serviciosbq->creacion==='on')
        ...
        <a style="margin-bottom: 7px" class="btn btn-default btn-icon" data-toggle="modal" data-target=".mymodal2">
            RUTA<i class="fa fa-plus icon-btn"></i>
        </a>
         <a style="margin-bottom: 7px; background-color: #FF8000; color: white" class="btn btn-default btn-icon" data-toggle="modal" data-target=".mymodal22">
                      ...
                      <?php
                          ...
                          if (intval($servicio->facturado)===1) {
                              ...
                              if (intval($servicio->estado_servicio_app)===1) {
                                  ...
                                  echo '<div class="estado_servicio_app" id="'.$servicio->id.$servicio->id.'" style="background: #de0000; color: white; margin: 2px 0px; font-size: 10px; padding: 3px 5px; width: 69px; border-radius: 2px;">NO INICIADO</div>';
                                  if (intval($servicio->aceptado_app)===0) {
                                    ...
                                    if(intval($servicio->estado_rechazo)===1){
                                      ...
                                      echo '<div class="estado_servicio_app acepted'.$servicio->id.'" style="background: #0ACEFE; color: white; margin: 2px 0px; font-size: 9px; padding: 3px 5px; width: 70px; border-radius: 2px;">ACEPTADO</div>';
                                  }
                              }
                          }

                          if ($servicio->id_pivote!=null) {
                              echo '<br><small class="text-primary" style="margin: 0 0 0 15px">EDITADO</small>';
                          }
