...
<head>
    <meta charset="UTF-8">
    <title>Autonet | Transportes AO</title>
...
<body onload="nobackbutton();">
  ...
  <div class="col-lg-12">
      <h3 class="h_titulo">SERVICIOS Y RUTAS AOTOUR</h3>
          ...
          <tbody>
              ...
              @foreach($servicios as $servicio)
                  ...
                  <tr id="{{$servicio->id}}" class="@if(intval($servicio->resaltar)===1){{'resaltar'}}@elseif($servicio->programado_app==1) {{'success'}} @endif">
                      <td>{{$o++}}</td>
                      <td> @if(intval($servicio->localidad!=1)){{'<h6 style="color: green">BAQ</h6>'}} @else {{'<h6 style="color: blue">BOG</h6>'}}@endif
                        {{$servicio->id}}</td>
                      ...
                      <td>
                        <?php
                            ...
                            if (intval($servicio->estado_servicio_app)===1) {
                                echo '<div class="estado_servicio_app" id="'.$servicio->id.$servicio->id.'" style="background: #409641; color: white; margin: 2px 0px; font-size: 9px; padding: 3px 5px; width: 67px; border-radius: 2px;">EN SERVICIO</div>';
                                ...
                                echo '<div class="estado_servicio_app" id="'.$servicio->id.$servicio->id.'" style="background: gray; color: white; margin: 2px 0px; font-size: 9px; padding: 3px 5px; width: 67px; border-radius: 2px;">NO INICIADO</div>';
