...
<html>
  <head>
    ...
    <title>Autonet | Solicitud de Servicios 2</title>
  ...
  <body>
          ...
          <table id="example_solicitados" class="table table-bordered hover tabla" cellspacing="0" width="100%">
            <thead>
              <tr>
                  ...
                  <th>Hasta</th>
                  <th>Detalle</th>
                  <th>Centro de Costo / Sucursal </th>
                  <th>Pax</th>
                  <th>Horario</th>
              </tr>
            </thead>
              ...
              <?php $st=0; ?>
                @foreach($servicios as $servicio)
                    ...
                    <tr id="{{$servicio->id}}" class="danger">
                        ...
                        <td><span class="bolder">{{$servicio->centrodecosto}} <br> <hr> {{$servicio->sucursal}}</span></td>
                        <td>
                          <?php
                                if($st===0){
                                  $st=1;
    ...
    @include('servicios.servicios_ejecutivos.cliente.modal_nuevoservicio2')
