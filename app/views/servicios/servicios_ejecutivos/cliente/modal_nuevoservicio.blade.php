            ...
            <div role="tabpanel" class="tab-pane fade in active" id="programacion_tab">
                <div class="row" style="margin-top: 15px">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-3">
                            <label class="obligatorio" for="celular">Centro de Costo / Expediente</label>
                            <input type="text" class="form-control input-font expediente" id="expediente" autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
