...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="box-sizing:border-box;margin:0;padding:0;width:100%;word-break:break-word;-webkit-font-smoothing:antialiased;">
    ...
    <div style="display:none;font-size:0;line-height:0;">Confirmación</div>
  ...
  <tr>
    <td style="background-color: #ecf0f1" align="center">
      <div style="color: #34495e; margin: 4% 10% 2%; text-align: justify;font-family: sans-serif">
        <p class="sans-serif" style="font-size: 18px">Mr. / Srta. {{$servicio->solicitado_por}} <br><br>
                            Basado en su solicitud, nos complace confirmarle los detalles del servicio.<br><br></p>
    <!--Row-->
                        ...
                        <tr>
                          <td class="col" width="850" style="padding: 0;">
                            <table>
                              <tbody>
                                <tr>
                                  <td><span style="color: #f37320">Pasajero(s):</span></td>
                                ...
                                <tr>
                                  <td><span style="color: #f37320">Fecha de Solicitud</span></td>
                                  <td style="padding: 0 10px;">{{ucwords(strtolower($servicio->fecha_solicitud))}}</td>
                                </tr>
                                <tr>
                                  <td><span style="color: #f37320">Empresa Solicitante: </span></td>
  ...
  <tr>
            ...
            <table cellspacing="0" id="table_detalle_solicitud" style="width: 100%;" border="1">
              <thead>
                <tr bgcolor="#f98006">
                  ...
                  <th class="sans-serif p-general" style="color: white; font-size: 12px; padding: 10px">OBSERVACIONES</th>
                </tr>
              </thead>
              <tbody>
                  <!-- inicio foreach-->
    ...
    <div style="width: 100%; text-align: center; margin:20px 0; display: inline-block;">
      <a style="font-size:12px; border-radius:70px; width:450px; background:#f98006; color: white; padding:5px 0; box-shadow:0px 6px 5px gray; text-align:center; text-decoration:none; display:inline-block; font-size:1.15em;" href="{{url('serviciosejecutivos/tracking/'.$encrypt_id.'')}}"> Detalles de la Orden</a>
    </div>    

  

  <div style="width: 100%; text-align: center; margin:20px 0; display: inline-block;">
    <span style="background: yellow; color: black; font-size: 14px;">Por favor, no responder a este correo ya que fue enviado de forma automática desde nuestra plataforma. Si tiene alguna duda o inquietud, no dude en contactarnos a transportebarranquilla@aotour.com.co</span>
  </div>
  ...
  <div style="width: 100%; text-align: center; margin:20px 0; display: inline-block;">
    <a style="text-decoration: none; border-radius: 5px; padding: 11px 23px; color: white; background-color: #3498db" href="https://www.aotour.com.co">Visítanos</a>
  </div>
