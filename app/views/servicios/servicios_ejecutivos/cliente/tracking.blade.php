...
<body style="background: gray">
      ...
      <h4 style="text-align: center; color: white">GPS TRACKING <i class="fa fa-map-marker" aria-hidden="true"></i></h4>
    	<hr>
        ...
        <div class="col-lg-12">    
            <div class="row">                         
                        ...
                        <div class="panel-body">
                            ...
                            <center>
                                @if($servicios->foto!='FALSE' and $servicios->foto!='NULL')
                                    <img src="{{url('https://app.aotour.com.co/autonet/biblioteca_imagenes/proveedores/conductores/'.$servicios->foto.'')}}" alt="" style="width: 150px; height: 200px; border-radius: 50%; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41); -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41); box-shadow: 1px 2px 2px 0px rgb(38, 113, 41); margin-bottom: 10px;">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <h5 style="color: #DC4405"><b>{{$servicios->cc}}</b></h5>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="panel panel-default" style="height: 530px">
                        <div class="panel-heading" style="background: #DC4405"><p style="text-align: left; color: white"><b>MAPA</b></p>
                          <div class="row">
                        ...
                        $trackingGps = setInterval(function(){
                            ...
                            $.ajax({
                                ...
                                if(disposicion===0){
                                    ...
                                    if(data.estado === 1){
                                    document.getElementById('estatus').innerHTML = '<span class="parpadea text" style="background: #409641; color: white; font-size: 10px; padding: 6px 5px; width: 67px; border-radius: 2px;">EN SERVICIO</span>';
