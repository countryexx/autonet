            ...
            <div class="col-lg-12" style="margin-bottom: 5px">
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <select name="ciudad" id="ciudad" class="form-control input-font">
                          <option value="19">BARRANQUILLA</option>
                          <option value="287">BOGOTA</option>
                        </select>
                      </div>
            ...
            <tbody>
                @foreach($servicios as $servicio)
                    ...
                    <tr id="{{$servicio->id}}" class="@if(intval($servicio->resaltar)===1){{'resaltar'}}@elseif($servicio->programado_app==1) {{'success'}} @endif">
                        ...
                        <td>{{$servicio->fecha_solicitud.' / '.$servicio->fecha_servicio}}</td>
                        ...
                        <td style="text-aling: center"><?php
                          ...
                          @if($servicio->calificacion_app_cliente_calidad!=null)
                            <div title="Calificacion realizada por el usuario" class="calificacion_listado_servicios_conductor">
                              <span>
                                <?php $stars = $servicio->calificacion_app_cliente_calidad; ?>
                                @if($stars === 1)
