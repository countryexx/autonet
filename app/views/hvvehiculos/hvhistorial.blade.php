...
<div id="historialtable" style="margin-bottom: 10px;">
  ...
  <table id="tbhistorial" class="table table-bordered hover tabla" cellspacing="0" width="100%">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr >
        ...
        <td>{{$mnto_vehiculo->numero_factura}} <br/><a href="../../biblioteca_imagenes/mantenimiento_fact/{{$mnto_vehiculo->factura_pdf}}" class="btn-danger" target="_blank" title="Descargar: {{$mnto_vehiculo->factura_pdf}}">PDF <i class="glyphicon glyphicon-file" aria-hidden="true"></i></a></td>
        ...
        <form id="formulario_mnto">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-xs-12" style="border-bottom: 1px dashed #CCCCCC;">
                    ...
                    <div class="col-xs-12">    
                        ...
                        <div class="col-xs-4">
                            <label  for="nombre_tecnico">Nombre t&eacute;cnico</label>
					...
					<div class="col-xs-12">
                        <div class="col-xs-4">
							...
							<textarea id="detalle_servicio" rows="4" class="form-control input-font" type="text"></textarea>
                        </div>
						...
						<div class="col-xs-2">
                            <label for="numero_accion">Adjuntar Factura:</label>
                            <input type="file" class="form-control" name="fact_mnt_pdf" id="fact_mnt_pdf" accept="application/pdf" data-filename-placement="inside">
                        </div>
                    </div>
                </div>
