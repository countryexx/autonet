      ...
      <div class="app-content" style="margin-bottom: 80px">
                ...
                <div class="col-lg-12">
                  ...
                  <div class="inline">
                    <button class="action-button apply" style="width: 100%">
                      <span style="margin-left: 6px"> <p style="margin-top: 10px"> Buscar <span style="border-right: 3px solid gray; padding: 5px 4px 6px 0; margin-right: 5px"></span> <i style="margin-left: 6px;" class="fa fa-search" aria-hidden="true"></i></p> </span>
                    </button>
                  </div>
                </div>
        ...
        <div class="products-area-wrapper tableView" style="margin-top: 20px">
          <div class="products-header">
            ...
            <div class="product-cell price">Nombre Cliente</div>
            <div class="product-cell category">Tipo de Servicio</div>
            ...
            <div class="product-cell price">Descripción</div>
            <div class="product-cell price">Novedad</div>
            <div class="product-cell category">Estado</div>
                ...
                <div class="products-row" style="border: 1px solid #DAD9D9">
                  <button class="cell-more-button">
                    ...
                    <div class="product-cell category"><span style="color: black">
                      @if($pq->razonsocial=='SGS COLOMBIA HOLDING BARRANQUILLA' or $pq->razonsocial=='SGS COLOMBIA HOLDING BOGOTA')
                  ...
                  <div class=" product-cell price form-inline">
                    ...
                    @if($pq->estado==2)
                      <a style="margin-right: 10px" target="_blank" href="{{url('biblioteca_imagenes/reportes/pqr/cierre/'.$pq->soporte_cierre)}}" class="btn btn-list-table btn-warning">Cierre <i class="fa fa-file-o" aria-hidden="true"></i></i></a>
                    @else
