    ...
    <tr>
      <td>
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          <p style="color: gray; font-size: 17px; text-align:center"><b>PQR N° {{$consecutivo}}</b></p>
              ...
              <table style="background: #DADBDB; margin-top: 35px" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 15px; padding-bottom: 15px;">
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" align="center" width="640">
                          <p style="text-align: left; color: #4F5858; font-size: 14px; font-family: sans-serif; margin-top: 18px; margin-bottom:25px ;text-align: justify">
                            ...
                            Lamentamos sinceramente la novedad presentada y las molestias ocasionadas. Nuestro equipo se encuentra trabajando diligentemente para corregir la situación presentada y garantizar que no se repita en el futuro.<br>
                            En esta oportunidad nos permitimos dar respuesta a la PQR recibida por parte de usted. Ingresando al portal AUTONET puede ver el documento respuesta.
                            <!--Reciban un cordial saludo de parte del equipo <span style="color: orange">AOTOUR SAS.</span><br>
                            En esta oportunidad nos permitimos dar respuesta a la pqr recibida por parte de usted.<br>

                            Ingresando al portal AUTONET puede ver el documento de respuesta.-->
                          </p>
              ...
              <br>
              <a target="_blank" href="https://app.aotour.com.co/autonet/reportes/listapqr">Ir AUTONET</a>
            </td>
          </tr>
        </table>
        <table class="container" align="center" bgcolor="#eeeee" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              <p style="color: gray; text-decoration: underline; text-align: center; margin-bottom: 10px;">No responder a este correo, ya que es netamente informativo.</p>
            </td>
          </tr>
        </table>
      </td>
