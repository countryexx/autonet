...
<body style="box-sizing:border-box;margin:0;padding:0;width:100%;-webkit-font-smoothing:antialiased;word-break:break-word;">
  ...
  <table class="wrapper" bgcolor="#EEEEEE" cellpadding="15" cellspacing="0" role="presentation" width="90%">
    <tr>
      <td>
            ...
            <td>
              ...
              <table align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                <tr>
                  <td style="padding: 0 20px;">
                    ...
                    <div style="margin-top: 10px; margin-bottom: 18px; border: white 6px solid; -webkit-box-shadow: 1px 2px 2px 0px orange; -moz-box-shadow: 1px 2px 2px 0px rgb(38, 113, 41);">
                      ...
                      <center><img src="{{url('biblioteca_imagenes/plantilla_portafolios.png')}}" width="90%"></center>
                ...
                <tr>
                  <td>
                    <center>
                      <p style="font-size: 12px; text-decoration: underline; color: #f47321"><b>AGENDA TU REUNIÓN</b></p>
                      <a href="https://wa.me/573046075207?text=¡Hola%20Aotour!%20Estoy%20interesado%20programar%20una%20reunión%20con%20ustedes." style="font-size: 12px; text-decoration: underline; color: black; margin-right: 15px"><b>Presiona aquí para agendar una reunión con nosotros.</b></a><br>
                    </center>
                  </td>
                </tr>
              </table>
