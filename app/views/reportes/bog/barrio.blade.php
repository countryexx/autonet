...
<html>
  <head>
    ...
    <title>Autonet | Control de Barrios</title>
  ...
  <body>
    @include('admin.menu')
    <div class="col-lg-12">
        <h3 class="h_titulo">CONTROL DE BARRIOS</h3>
            ...
            <tbody>
              ...
              @foreach($consulta as $documento)
                <tr>
                  ...
                  <td>
                    {{$documento->neighborhood}}
                  </td>
                  <td>
                    <?php
                    $servicios = "SELECT distinct qr_rutas.servicio_id FROM qr_rutas LEFT JOIN servicios ON servicios.id = qr_rutas.servicio_id WHERE qr_rutas.neighborhood = '".$documento->neighborhood."' AND servicios.fecha_servicio = '".$documento->fecha_servicio."' AND servicios.pendiente_autori_eliminacion IS NULL AND servicios.ruta AND servicios.centrodecosto_id = 287";
