            ...
            <tbody>
              ...
              @foreach($consulta as $documento)
                <tr>
                  ...
                  <td>
                    <?php
                    $servicios = "SELECT distinct qr_rutas.servicio_id FROM qr_rutas LEFT JOIN servicios ON servicios.id = qr_rutas.servicio_id WHERE qr_rutas.neighborhood = '".$documento->neighborhood."' AND servicios.fecha_servicio = '".$documento->fecha_servicio."' AND servicios.pendiente_autori_eliminacion IS NULL AND servicios.ruta AND servicios.centrodecosto_id = 19";
