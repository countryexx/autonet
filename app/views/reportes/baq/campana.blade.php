  ...
  <body>
    ...
    <div class="col-lg-12">
        ...
        <!--<div class="form-group">
          <select style="width: 135px;" class="form-control input-font" name="servicios">
            <option value="Seleccionar Mes">Seleccionar Año</option>
        ...
        <div class="form-group">
          <select style="width: 135px;" class="form-control input-font" name="servicios">
            <option value="Seleccionar Mes">Seleccionar Día</option>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    if($documento->employ!=null){
                      $servicios = "SELECT distinct qr_rutas.servicio_id FROM qr_rutas LEFT JOIN servicios ON servicios.id = qr_rutas.servicio_id WHERE qr_rutas.employ = '".$documento->employ."' AND servicios.fecha_servicio = '".$documento->fecha_servicio."' AND servicios.pendiente_autori_eliminacion IS NULL AND servicios.ruta AND servicios.centrodecosto_id = 19";
                      $search = DB::select($servicios);
                    }else{
                      $servicios = "SELECT distinct qr_rutas.servicio_id FROM qr_rutas LEFT JOIN servicios ON servicios.id = qr_rutas.servicio_id WHERE qr_rutas.employ is null AND servicios.fecha_servicio = '".$documento->fecha_servicio."' AND servicios.pendiente_autori_eliminacion IS NULL AND servicios.ruta AND servicios.centrodecosto_id = 19";
                      $search = DB::select($servicios);
                    }
