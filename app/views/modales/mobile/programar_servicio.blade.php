  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
                  ...
                  <div class="row" style="margin-top: 15px">
                      <div class="col-xs-12">
                          <div class="col-xs-3" id="centro_alerta">
                              ...
                              <select class="form-control input-font disabled" id="centro_de_costo" name="centrodecosto" disabled>
                          ...
                          <div class="subcentros">
                              <div class="col-xs-2">
                                  ...
                                  <select class="form-control input-font" name="subcentrodecosto">
                                      <option>-</option>
                          ...
                          <div class="col-xs-3" style="min-height: 67px;">
                              ...
                              <select class="form-control input-font" name="departamento">
                  ...
                  <div class="row" style="margin-top: 15px">
                      <div class="col-xs-12">
                          <div class="col-lg-12">
                              <div class="row">
                                  <div class="col-xs-4" style="z-index: 11">
                                      ...
                                      <select class="form-control input-font" name="ruta" data-live-search="true" data-size="10" data-header="Selecciona una ruta">
                          ...
                          <div class="col-xs-3 proveedor_content">
                              ...
                              <div class="input-group">
                                  <select data-option="1" type="text" class="form-control input-font" name="proveedor" data-live-search="true" data-size="10" data-header="Selecciona un proveedor">
                          ...
                          <div class="col-xs-3">
                              ...
                              <select class="form-control input-font" name="conductor" estado="false">
                                  <option>-</option>
                              </select>
                          </div>
                          <div class="col-xs-4">
                              ...
                              <select class="form-control input-font" name="vehiculo" estado="false">
                                  <option>-</option>
                              </select>
                          </div>
                          <div class="col-xs-12 unico">
                              <div class="row">
                                  ...
                                  <div class="col-xs-2">
                                      <label class="obligatorio" for="notificacion">Notificacion Cliente</label>
                                      <select class="form-control input-font" id="notificacion_cliente">
                                          <option>-</option>
                                          <option value="1">SI</option>
                                          <option value="0">NO</option>
                                      </select>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-multiple="0" id="programar_servicio_movil">GUARDAR</button>
      </div>
    </div>
  </div>
</div>
