        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body tabbable">
                ...
                <div class="tab-content">
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="ex_programar" style="padding-top: 0; overflow-y: auto; height: 500px;">
                        ...
                        <table id="documentos" class="table table-bordered table-hover hidden">
                            <thead>
                                <tr style="background: #f47321">
                                    <td>#</td>
                                    <td>RUTA</td>
                                    <td>VEHÍCULO</td>
                                    <td>ADMIN</td>
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="export_exce_ruta">
                        <div class="row" style="margin-top: 15px">
                            <div class="col-xs-12">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <form id="form" action="{{url('transportes/exportarrutasfechasb')}}" method="post">
                                          <div class="col-xs-12">
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        <form id="form" action="{{url('transportes/exportarrutasdia')}}" method="post">
                                            ...
                                            <div class="col-xs-1">
                                                <label class="obligatorio" for="horainicial_ex_excel">Hora I</label>
                                                <select name="md_hinicial" id="horainicial_ex_excel" type="text" class="form-control input-font horainicial_ex_excel">
                                                    <option>-</option>
                                            ...
                                            <div class="col-xs-1">
                                                <label class="obligatorio" for="horafinal_ex_excel">Hora F</label>
                                                <select name="md_hfinal" id="horafinal_ex_excel" type="text" class="form-control input-font horafinal_ex_excel">
                                                    <option>-</option>
                                                        <option value="20:00">20:00</option>
                                                        <option value="20:30">20:30</option>
                                                        <option value="21:00">21:00</option>
            ...
            <div class="modal-footer">
                <a id="habilitarlo" class="btn btn-warning btn-icon hidden" style="float: left">INTENTARLO DE NUEVO <i class="fa fa-repeat icon-btn"></i></a>
                <a id="continuar_ruta" class="btn btn-success btn-icon">CONTINUAR <i class="fa fa-arrow-right icon-btn"></i></a>
                <a id="ordenar_rutas" class="btn btn-info btn-icon disabled">ASIGNAR RUTAS<i class="fa fa-bars icon-btn" aria-hidden="true"></i></a>
                ...
                <a id="guardando" class="btn btn-primary btn-icon hidden">GUARDANDO... <i class="fa fa-spinner fa-spin icon-btn" aria-hidden="true"></i></a>
                <a id="guardado" class="btn btn-primary btn-icon hidden">GUARDADO <i class="fa fa-check icon-btn" aria-hidden="true"></i></a>
            </div>
        </div>
    </div>
</div>
