          ...
          <div class="modal-header">
            ...
            <div class="modal-body tabbable">
                ...
                <div class="tab-content">
                            ...
                            <div class="col-xs-12">
                              <div class="row">
                                ...
                                <div class="col-xs-2">
                                    ...
                                    <input id="ruta_email_solicitanteqr" type="text" class="form-control input-font">
                                </div>
                                <div class="col-xs-2">
                                ...
                                <div class="col-xs-2">
                                  <label class="mensajes" for="ciudad">Enviar Mensajes</label>
                                  <select class="form-control input-font" id="mensajesqr">
                                    <option>-</option>
                                    <option value="1">SI</option>
                                    <option value="2">NO</option>
                                  </select>
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="ex_rutaqr" style="padding-top: 0; overflow-y: auto; height: 400px;">
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="ex_programarqr" style="padding-top: 0; overflow-y: auto; height: 400px;">
