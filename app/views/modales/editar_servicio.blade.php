<div class="modal mymodal1" id="myModal1" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-servicios" role="document">
    ...
    <div class="modal-footer">
        @if(Sentry::getUser()->id_rol==16 or Sentry::getUser()->id_rol==1 or Sentry::getUser()->id_rol==2 or
            Sentry::getUser()->id_rol==8 or Sentry::getUser()->id_rol==10 or Sentry::getUser()->id_rol==11 or Sentry::getUser()->id_rol==42 or Sentry::getUser()->id_rol==3)
