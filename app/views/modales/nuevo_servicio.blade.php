            ...
            <div role="tabpanel" class="edicion tab-pane fade in active" id="programacion_tab">
                <div class="row" style="margin-top: 15px">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-2">
                            <label class="obligatorio" for="numero_pax">Cantidad de Pasajeros</label>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-xs-4">
                                    ...
                                    <input style="z-index: 10000 !important; display: block !important;" data-sw="0" type="text" placeholder="Lugar de recogida" class="form-control input-font" id="recoger_en" autocomplete="off">
                                    <div id="mapa" style="overflow-y: auto; height: 300px; margin-top: 38px; border: 4px solid gray"></div>
                                </div>
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    <textarea class="form-control input-font" placeholder="Detalles del traslado" id="detalle_recorrido"></textarea>
                        ...
                        <div class="col-xs-12 unico">
                            <div class="row">
                                ...
                                <div class="col-xs-1 hidden">
                                    <label class="obligatorio" for="kilometraje">Kilometraje</label>
                                    <select class="form-control input-font kilometraje" id="kilometraje">
                                        <option>-</option>
                                        <option value="1">SI</option>
                                        <option value="0">NO</option>
                                    </select>
                                ...
                                <div class="col-xs-2 hidden">
                                    <label class="obligatorio" for="kilometraje">Tipo Servicio</label>
                                    <select class="form-control input-font tipo_s" id="tipo_s">
                                        <option value="1">LOCAL</option>
                                        <option value="0">MUNICPAL</option>
                                        <option value="0">DEPARTAMENTAL</option>
                                    </select>
                                </div>
                                <div class="col-xs-12">
