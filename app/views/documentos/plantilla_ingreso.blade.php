...
<html><head>
    ...
    <style>
      ...
      <table id="header" style="width:100%;table-layout:auto;empty-cells:show; border: 1px solid #5a5a5a; border-collapse: collapse;">
          <tr>
            <td width="20" style="padding: 20px; border-right: 1px solid #5a5a5a; border-left: 1px solid #5a5a5a;"><img width="120" src="biblioteca_imagenes/logos.png"></td>
      ...
      <div class="div_info">
        <table style="width:100%; margin-top: 6px; margin-bottom: 10px">
          <tr>
           ...
           <td style="border-top: 1px solid #5a5a5a; border-right: 1px solid #5a5a5a; border-left: 1px solid #5a5a5a; border-bottom: 1px solid #5a5a5a; padding: 2px; font-size: 10px" align="center">
             <?php 
    ...
    ?>
           ...
           <td style="border-top: 1px solid #5a5a5a; border-right: 1px solid #5a5a5a; border-left: 1px solid #5a5a5a; border-bottom: 1px solid #5a5a5a; padding: 2px; font-size: 10px" align="center">Recursos Humanos</td>
          </tr>               
        </table>

        <table id="servicios" style="width:96%;">
            <tr>
