...
<html>
  <head>
    ...
    <title>Autonet | Verificación de Fotos BOG</title>
        ...
        <form class="form-inline" id="form_buscar" action="{{url('gestiondocumental/downloadpdf')}}" method="post">
            ...
            <div class="col-lg-12" style="margin-bottom: 5px">
                <div class="row">
                  ...
                  <button data-option="2" id="buscar" class="btn btn-default btn-icon">Buscar<i class="fa fa-search icon-btn"></i></button>
