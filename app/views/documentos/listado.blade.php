...
<html>
  ...
  <body>
    ...
    <div class="col-lg-12">
        <h3 class="h_titulo">GESTIÓN DE DOCUMENTOS</h3>       
        <form class="form-inline" id="form_buscar" action="{{url('gestiondocumental/downloadpdf')}}" method="post">
            ...
            <div class="col-lg-12" style="margin-bottom: 5px">
                <div class="row">
                    ...
                    <div class="form-group">
                    	<select data-option="1" name="ciudad" style="width: 160px;" class="form-control input-font" id="ciudad_search">
	                ...
	                <div class="form-group">
	                    <select disabled id="conductor_search" style="width: 120px;" class="form-control input-font" name="conductores">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-lg-12" style="margin: 30px 0 30px 0;">
				        <h3 class="h_titulo">SELECCIONAR LA FECHA Y EL CLIENTE A EXPORTAR</h3>       
				        <form class="form-inline" action="gestiondocumental/pdf" method="get">
                            ...
                            @else
                              <button disabled="" type="submit" style="margin-left: 20px" class="btn btn-warning btn-icon input-font">DESCARGAR PDF DE RUTAS<i class="fa fa-file-pdf-o icon-btn" aria-hidden="true"></i></button>
                            @endif
				                </div>
				            </div>
				        </form>
