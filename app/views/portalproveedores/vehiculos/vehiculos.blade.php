...
<div class="col-lg-12">
    ...
    <h3 class="h_titulo">VEHICULOS DE {{$vehiculos->razonsocial}}</h3>
    <?php $sw = 0; ?>
    <!-- -->
      ...
      <div class="panel-heading" style="background: #f98006"><span style="font-size: 40px">DOCUMENTACIÓN PDF</span></div>
        <div class="panel-body" style="height: 200%; background: white">
          <div class="row">
            ...
            <div class="col-md-12">
              <span style="font-family: monospace; font-size: 25px">@if($vehiculos->autorizado_tecnomecanica===1){{ '<i class="fa fa-check icon_tecno" aria-hidden="true" style="font-size: 30px; color: green"></i>' }}@elseif($vehiculos->autorizado_tecnomecanica===2){{ '<i class="fa fa-times" aria-hidden="true" style="font-size: 30px; color: red"></i>' }}@else{{ '<i class="fa fa-clock-o icon_tecno" aria-hidden="true" style="font-size: 30px; color: orange"></i>' }}@endif TECNOMECÁNICA
                <a title="GUARDAR COMO DOCUMENTO INCORRECTO" id="documento_incorrecto_tecno" data-option="tecnomecanica" data-id="{{$vehiculos->id}}" class="btn btn-danger documento_incorrectoc @if($vehiculos->autorizado_tecnomecanica!=null){{'disabled'}}@endif"><i class="fa fa-trash" aria-hidden="true"></i></a>

                <a title="APROBAR DOCUMENTO" id="documento_correcto_tecno" data-option="tecnomecanica" data-id="{{$vehiculos->id}}" class="btn btn-primary documento_correctoc @if($vehiculos->autorizado_tecnomecanica!=null){{'disabled'}}@endif"><i class="fa fa-check" aria-hidden="true"></i></a>
              </span>
            ...
            <div class="col-md-12" style="margin-top: 40px">
              <span style="font-family: monospace; font-size: 25px">@if($vehiculos->autorizado_soat===1){{ '<i class="fa fa-check icon_soat" aria-hidden="true" style="font-size: 30px; color: green"></i>' }}@elseif($vehiculos->autorizado_soat===2){{ '<i class="fa fa-times" aria-hidden="true" style="font-size: 30px; color: red"></i>' }}@else{{ '<i class="fa fa-clock-o icon_soat" aria-hidden="true" style="font-size: 30px; color: orange"></i>' }}@endif SOAT
                <a title="GUARDAR COMO DOCUMENTO INCORRECTO" id="documento_incorrecto_soat" data-option="soat" data-id="{{$vehiculos->id}}" class="btn btn-danger documento_incorrectoc @if($vehiculos->autorizado_soat!=null){{'disabled'}}@endif"><i class="fa fa-trash" aria-hidden="true"></i></a>

                <a title="APROBAR DOCUMENTO" id="documento_correcto_soat" data-option="soat" data-id="{{$vehiculos->id}}" class="btn btn-primary documento_correctoc @if($vehiculos->autorizado_soat!=null){{'disabled'}}@endif"><i class="fa fa-check" aria-hidden="true"></i></a>
              </span>
          ...
          <div class="row" style="margin-top: 40px">
            <div class="col-md-12">
              <span style="font-family: monospace; font-size: 25px">@if($vehiculos->autorizado_tp===1){{ '<i class="fa fa-check icon_tp" aria-hidden="true" style="font-size: 30px; color: green"></i>' }}@elseif($vehiculos->autorizado_tp===2){{ '<i class="fa fa-times" aria-hidden="true" style="font-size: 30px; color: red"></i>' }}@else{{ '<i class="fa fa-clock-o icon_tp" aria-hidden="true" style="font-size: 30px; color: orange"></i>' }}@endif TARJETA DE PROPIEDAD
                <a title="GUARDAR COMO DOCUMENTO INCORRECTO" id="documento_incorrecto_tp" data-option="tp" data-id="{{$vehiculos->id}}" class="btn btn-danger documento_incorrectoc @if($vehiculos->autorizado_tp!=null){{'disabled'}}@endif"><i class="fa fa-trash" aria-hidden="true"></i></a>

                <a title="APROBAR DOCUMENTO" id="documento_correcto_tp" data-option="tp" data-id="{{$vehiculos->id}}" class="btn btn-primary documento_correctoc @if($vehiculos->autorizado_tp!=null){{'disabled'}}@endif"><i class="fa fa-check" aria-hidden="true"></i></a>
              </span>
            ...
            <div class="col-md-12" style="margin-top: 40px">
              <span style="font-family: monospace; font-size: 25px">@if($vehiculos->autorizado_to===1){{ '<i class="fa fa-check icon_to" aria-hidden="true" style="font-size: 30px; color: green"></i>' }}@elseif($vehiculos->autorizado_to===2){{ '<i class="fa fa-times" aria-hidden="true" style="font-size: 30px; color: red"></i>' }}@else{{ '<i class="fa fa-clock-o icon_to" aria-hidden="true" style="font-size: 30px; color: orange"></i>' }}@endif TARJETA DE OPERACIÓN
                <a title="GUARDAR COMO DOCUMENTO INCORRECTO" id="documento_incorrecto_to" data-option="to" data-id="{{$vehiculos->id}}" class="btn btn-danger documento_incorrectoc @if($vehiculos->autorizado_to!=null){{'disabled'}}@endif"><i class="fa fa-trash" aria-hidden="true"></i></a>

                <a title="APROBAR DOCUMENTO" id="documento_correcto_to" data-option="to" data-id="{{$vehiculos->id}}" class="btn btn-primary documento_correctoc @if($vehiculos->autorizado_to!=null){{'disabled'}}@endif"><i class="fa fa-check" aria-hidden="true"></i></a>
              </span>
            ...
            <div class="col-md-12" style="margin-top: 40px">
              <span style="font-family: monospace; font-size: 25px">@if($vehiculos->autorizado_pc===1){{ '<i class="fa fa-check icon_pc" aria-hidden="true" style="font-size: 30px; color: green"></i>' }}@elseif($vehiculos->autorizado_pc===2){{ '<i class="fa fa-times" aria-hidden="true" style="font-size: 30px; color: red"></i>' }}@else{{ '<i class="fa fa-clock-o icon_pc" aria-hidden="true" style="font-size: 30px; color: orange"></i>' }}@endif PÓLIZA CONTRACTUAL
                <a title="GUARDAR COMO DOCUMENTO INCORRECTO" id="documento_incorrecto_pc" data-option="pc" data-id="{{$vehiculos->id}}" class="btn btn-danger documento_incorrectoc @if($vehiculos->autorizado_pc!=null){{'disabled'}}@endif"><i class="fa fa-trash" aria-hidden="true"></i></a>

                <a title="APROBAR DOCUMENTO" id="documento_correcto_pc" data-option="pc" data-id="{{$vehiculos->id}}" class="btn btn-primary documento_correctoc @if($vehiculos->autorizado_pc!=null){{'disabled'}}@endif"><i class="fa fa-check" aria-hidden="true"></i></a>
              </span>
              <iframe src="{{url('biblioteca_imagenes/prov_nuevos/documentacion/vehiculos/'.$vehiculos->poliza_contractual_pdf)}}" width="100%" height="40%"></iframe>
            </div>

            <div class="col-md-12" style="margin-top: 40px">
              <span style="font-family: monospace; font-size: 25px">@if($vehiculos->autorizado_pec===1){{ '<i class="fa fa-check icon_pec" aria-hidden="true" style="font-size: 30px; color: green"></i>' }}@elseif($vehiculos->autorizado_pec===2){{ '<i class="fa fa-times" aria-hidden="true" style="font-size: 30px; color: red"></i>' }}@else{{ '<i class="fa fa-clock-o icon_pec" aria-hidden="true" style="font-size: 30px; color: orange"></i>' }}@endif POLIZA EXTRA CONTRACTUAL
                <a title="GUARDAR COMO DOCUMENTO INCORRECTO" id="documento_incorrecto_pec" data-option="pec" data-id="{{$vehiculos->id}}" class="btn btn-danger documento_incorrectoc @if($vehiculos->autorizado_pec!=null){{'disabled'}}@endif"><i class="fa fa-trash" aria-hidden="true"></i></a>

                <a title="APROBAR DOCUMENTO" id="documento_correcto_pec" data-option="pec" data-id="{{$vehiculos->id}}" class="btn btn-primary documento_correctoc @if($vehiculos->autorizado_pec!=null){{'disabled'}}@endif"><i class="fa fa-check" aria-hidden="true"></i></a>
              </span>
              <iframe src="{{url('biblioteca_imagenes/prov_nuevos/documentacion/vehiculos/'.$vehiculos->poliza_extra_contractual_pdf)}}" width="100%" height="40%"></iframe>
            </div>
