        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              ...
              <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Documentación Rechazada</h1><br>            
                        </td>
                      </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
                <p style="color: #929292; text-align:left">
                Se ha enviado un link al proveedor para la actualización de los documentos no aprobados.
              </p>
              <p style="color: #929292; text-align:left">             
                Una vez el proveedor envíe la documentación, se les notificará al correo para la validación.
              </p>
            </td>
            </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
              <a href="{{url('portalproveedores/vehiculosenrevision')}}">Ir a Autonet</a><br><br>
            </td>
            </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
