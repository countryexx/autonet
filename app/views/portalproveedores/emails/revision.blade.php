        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              ...
              <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Revisión Habilitada</h1><br>            
                        </td>
                      </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
                <p style="color: #929292; text-align:left">
                El proveedor {{$proveedor->razonsocial}} está listo para revisión por las áreas implicadas en el proceso.
              </p>
              <p style="color: #929292; text-align:left">             
