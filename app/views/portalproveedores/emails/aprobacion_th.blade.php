        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              ...
              <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">APROBACIÓN TALENTO HUMANO</h1><br>            
                        </td>
                      </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
                <p style="color: #929292; text-align:left">
                El área de Talento Humano aprobó los datos del proveedor {{$proveedor->razonsocial}}.
              </p>
            </td>
            </tr>
            <tr>
