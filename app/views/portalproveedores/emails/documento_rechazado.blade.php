        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              ...
              <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Documento rechazado</h1><br>            
                        </td>
                      </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
                <p style="color: #929292; text-align:left">
                Le informamos que no fue aceptado su documento <b>{{strtoupper($nombre)}}</b> por el siguiente motivo:
              </p>
              <p style="color: #929292; text-align:left">             
                <b>{{strtoupper($motivo)}}</b>
              </p>
            </td>
            </tr>
            <tr>
