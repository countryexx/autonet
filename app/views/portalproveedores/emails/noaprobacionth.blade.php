        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              ...
              <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">APROBACIÓN CONTABLE</h1><br>            
                        </td>
                      </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
                <p style="color: #929292; text-align:left">
                Talento Humano no ha aprobado la documentación del proveedor {{$proveedor->razonsocial}}.<br><br> Una vez las demás áreas terminen su revisión, se deberá enviar la correción de documentos al proveedor mediante la opción indicada en AUTONET (OPCIÓN AMARILLA).
              </p>
            </td>
            </tr>
            <tr>
