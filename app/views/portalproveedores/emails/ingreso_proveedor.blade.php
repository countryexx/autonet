        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              ...
              <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">PROVEEDOR VINCULADO</h1><br>            
                        </td>
                      </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
                <p style="color: #929292; text-align:left">
                El proveedor {{$proveedor->razonsocial}} ha sido aprobado y capacitado por todas las áreas.
              </p>
              <p style="color: #929292; text-align:left">
                Conductor: {{$conductor}}
              </p>
            ...
            <tr>
              <td class="col" style="padding: 0 10px;">
              <a href="https://app.aotour.com.co/autonet/proveedores">Ir a AUTONET</a><br><br>
            </td>
            </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
