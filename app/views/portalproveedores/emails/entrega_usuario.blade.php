                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          ...
                          <br><br><br><br>
                          <p style="text-align:left;">Le informamos que su cuenta en el Portal de Proveedores ha sido creada.
                            <hr>
                          Para ingresar necesita las siguientes credenciales:<br><br>
                          <b>ENLACE: </b> https://app.aotour.com.co/autonet/ <br>
                          <b>USUARIO:</b> {{strtoupper($email)}} <br>
                          <b>CONTRASEÑA:</b> {{$pass}}
