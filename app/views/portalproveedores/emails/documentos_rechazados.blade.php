        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              ...
              <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Documentos Rechazados</h1><br>            
                        </td>
                      </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
                <p style="color: #929292; text-align:left">
                Le informamos que algunos documentos no fueron aprobados.
              </p>
              <p style="color: #929292; text-align:left">             
                Por favor, valide la veracidad y exactitud de estos documentos y envíelos nuevamente.
              </p>
            </td>
            </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
              <a href="{{url('portalproveedores/revisarinformacion/'.$id)}}">Ir al Formulario</a><br><br>
            </td>
            </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
