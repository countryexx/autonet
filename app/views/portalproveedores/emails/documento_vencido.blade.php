                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          <img class="align-sm-left" style="width: 220px; margin-top: 20px" src="{{asset('img/logo_aotour.png')}}">
                          <br><br><br><br>

                          <p style="text-align:left;">Le informamos que tiene documentos vencidos* y* próximos a vencer.
                            
                          </p>
                            <span><b>VEHÍCULOS</b></span>
                            <li>Tarjeta de operación (2021-08-07) UUW126</li>
                            <li>Soat (2021-08-08) UUW126</li>
                          <br><br>
                          <span><b>CONDUCTORES</b></span>
                            <li>Seguridad Social (2021-08-07)</li>
                            <br>
                            <a href="https://app.aotour.com.co/autonet" style="float: right; margin-bottom: 20px" href="" title="Aceptar el nuevo valor." id="aceptar_correccion" data-id="" data-cuenta="" nombre="" class="btn btn-primary aceptar_correccion">Ir al portal</a>
                        </td>
                      </tr>
                    </table>
                  </td>
