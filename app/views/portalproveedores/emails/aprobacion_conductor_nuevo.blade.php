                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                            <center><h2 class="align-sm-left" style="font-weight: 400; color: #5f6062;">¡CONDUCTOR APROBADO!</h2><br></center>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                            <p style="color: #929292; text-align:left">Su conductor <b>{{$conductor}}</b> ha sido aprobado.</p>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                            <p style="color: #929292; text-align:left">Para continuar con el proceso de vinculación {{$conductor}} deberá descargar <b>UP DRIVER</b> y obtener su usuario en la opción Regístrate.</p>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                            <p style="color: #929292; text-align:left">Disponible en <a href="https://play.google.com/store/apps/details?id=com.aotour.driver">Android</a> y <a href="https://apps.apple.com/co/app/up-driver/id1436541569">iOS</a></p>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                            <hr style="margin-bottom: 4px; border-top: 1px solid #B9B8B8;">
                            <center><p style="color: #929292; text-align:left">© Copyright 2023 Aotour, SAS.</p></center>
                        </td>
                      </tr>
                    </table>
                  </td>
