        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              ...
              <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Datos Financieros</h1><br>            
                        </td>
                      </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
                <p style="color: #929292; text-align:left">
                Para continuar con su proceso de vinculación a AOTOUR, es necesario que nos envíe su información bancaria donde se le realizarían los pagos.<br><br>
              </p>
              <p style="color: #929292; text-align:left">             
                En el siguiente enlace puede hacer dicho proceso:
              </p>
            </td>
            </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
              <a href="https://app.aotour.com.co/autonet/portalproveedores/informacionfinanciera/{{$id}}">Ir al Formulario</a><br><br>
            </td>
            </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
