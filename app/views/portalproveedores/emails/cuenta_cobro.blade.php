                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                          ...
                          <br><br><br><br>
                          Le informamos que su cuenta de cobro fue aprobada y radicada con el N° xxxxx.
                          </p>

                            <br>
                            <hr>
                            <br><br>
                            Le informamos que su cuenta de cobro tiene correcciones de valores que debe revisar
                            <!--<a href="https://app.aotour.com.co/autonet" style="float: right; margin-bottom: 20px" href="" title="Aceptar el nuevo valor." id="aceptar_correccion" data-id="" data-cuenta="" nombre="" class="btn btn-primary aceptar_correccion">Ir</a>-->
                        </td>
                      </tr>
                    </table>
                  </td>
