        ...
        <table class="container" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="530">
          <tr>
            <td>
              ...
              <h1 class="align-sm-left" style="font-weight: 400; color: #5f6062;">Documentos Actualizados</h1><br>            
                        </td>
                      </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
                <p style="color: #929292; text-align:left">
                El proveedor {{$proveedor->razonsocial}} ha enviado nuevamente los documentos que no fueron autorizados.
              </p>
              <p style="color: #929292; text-align:left">             
                Recuerda ingresar a AUTONET o presiona click en el siguiente enlace para hacer la respectiva revisión.
              </p>
            </td>
            </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
              <a href="https://app.aotour.com.co/autonet/portalproveedores/nuevosproveedores">Ir a AUTONET</a><br><br>
            </td>
            </tr>
            <tr>
              <td class="col" style="padding: 0 10px;">
