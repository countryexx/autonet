                    ...
                    <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                            <center><h2 class="align-sm-left" style="font-weight: 400; color: #5f6062;">¡NUEVO CONDUCTOR!</h2><br></center>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                            <p style="color: #929292; text-align:left">El proveedor <b>{{$razonsocial}}</b> ha agregado a <b>{{$conductor}}</b> como conductor.</p>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                            <p style="color: #929292; text-align:left">Recuerda hacer la respectiva revisión.</p>
                        </td>
                      </tr>
                      <tr>
                        <td class="col" style="padding: 0 10px;">
                            <hr style="margin-bottom: 4px; border-top: 1px solid #B9B8B8;">
                            <center><p style="color: #929292;">© Copyright 2023 Aotour, SAS.</p></center>
                        </td>
                      </tr>
                    </table>
                  </td>
